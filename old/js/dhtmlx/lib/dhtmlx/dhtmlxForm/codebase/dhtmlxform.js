function dhtmlXForm(parentObj, data) {
    ...
    this.setSkin = function (skin) {
        ...
        this.forEachItem(function (id) {
            if (that.getItemType(id) == "calendar") {
    ...
    this._addItem = function (type, id, data, sId, lp) {
        ...
        if (({input:true, fieldset:true, block:true, password:true, calendar:true, colorpicker:true})[type] !== true) tr.onselectstart = function (e) {
            e = e || event;
            e.returnValue = false;
            return false;
        }
    ...
    this._ccDo = function () {
        ...
        if (this._ccActive) this._ccTm = window.setTimeout(function () {
            that._ccDo();
        }, 100);
...
dhtmlXForm.prototype.items.button = {
    ...
    render:function (item, data) {
        ...
        item.childNodes[0].onselectstart = function (e) {
            e = e || event;
            e.cancelBubble = true;
            e.returnValue = false;
            return false;
...
dhtmlXForm.prototype.items.template = {
    ...
    render:function (item, data) {
        ...
        if (!item.format) item.format = function (name, value) {
            return value;
        }
