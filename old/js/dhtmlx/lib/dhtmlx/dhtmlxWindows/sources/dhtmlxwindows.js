...
//#}	
    ...
    this._clearVPCss = function (css) {
        this.vp.className = String(this.vp.className).replace(/[a-z_]{1,}/gi, function (t) {
            return({"dhtmlx_skin_dhx_skyblue":1, "dhtmlx_skin_dhx_blue":1, "dhtmlx_skin_dhx_black":1, "dhtmlx_skin_dhx_web":1, "dhtmlx_skin_dhx_terrace":1}[t] == 1 ? "" : t);
        });
    }
...
//#wind_move:09062008{
    ...
    this._stopMove = function () {
        ...
        if (this.resizingWin != null) {
            ...
            // event in layout
            if (win.vs[win.av].layout) {
                win.vs[win.av].layout.callEvent("onResize", []);
            }
            // opera fix
            /*
             if (_isOpera) {
...
//#wind_buttons:09062008{
        ...
        btnMinMax1._doOnClick = function () {
            that._maximizeWindow(this.winId);
        }
        ...
        btnMinMax2._doOnClick = function () {
            that._restoreWindow(this.winId);
        }
