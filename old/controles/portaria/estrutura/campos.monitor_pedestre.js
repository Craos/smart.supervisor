...
var campos_monitor_pedestre = [
        ...
        { type: "block", list: [
            {type: "fieldset", name: "opcoes", label: "Informa&ccedil;&otilde;es gerais do morador", width: 800, list: [
                ...
                { type: "block", list: [
                    ...
                    {type: "newcolumn"},
                    {type: "input", name: "admunidade", label: "Unidade", inputWidth: 125, style: "font-weight:bold;", note: {text: "Numero do apartamento"}},
                    {type: "newcolumn"},
    ...
    { type: "block", list: [
        ...
        {type: "fieldset", name: "instrucoes", label: "Instru&ccedil;&otilde;es", width: 280, list: [
            { type: "block", list: [
                {type: "template", name: "texto_instrucoes1", value: 'Cadastre primeiro o morador respons�vel pela admunidade, desconsiderando o campo "Parentesco�, e feche esse cadastro clicando em "Salvar dados do morador�.', style: "color: #137da1; height: 80px;"},
                {type: "template", name: "texto_instrucoes2", value: 'Para todos os demais moradores, clique em "Cadastrar novo morador� e continue preenchendo e salvando, de modo que todos apare�am no bloco "Moradores cadastrados da admunidade�.', style: "color: #137da1; height: 100px;"},
                {type: "template", name: "texto_instrucoes3", value: 'Depois do cadastro de todos os moradores da admunidade, clique em "Finalizar este cadastro�, para passar para outra p�gina.', style: "color: #137da1; height: 70px;"}
            ]}
        ]}
    ]},
