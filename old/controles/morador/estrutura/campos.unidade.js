...
var campos_unidade = [
    ...
    {type: "template", name: "titulo", value: "Cadastro de informa&ccedil;&otilde;es gerais da admunidade", style: "font-weight:bold; color: #003366;"},
        {type: "fieldset", name: "opcoes", label: "Opera&ccedil;&otilde;es", width: 955, list: [
            {type: "button", name: "finalizar", value: "Atualizar"}
        ]},
    {type: "fieldset", name: "informacoes_unidade", label: "Informa&ccedil;&otilde;es da admunidade", inputWidth: 955, list: [
        {type: "block", offsetTop: "0", list: [
            ...
            {type: "newcolumn"},
            {type: "input", name: "admunidade", readonly:true,  label: "Unidade", inputWidth: 100, style: "font-weight:bold; color:red"}
        ]},
        {type: "block", offsetTop: "0", list: [
