        ...
        {type: "fieldset", name: "cadastro_morador", label: "Cadastro do Morador", width: 920, list: [
            {type: "template", name:"usuario", value: "<a style='text-decoration: none' href='#' onclick='cadastro();'>\
                    <div class='opcao'>\
                        ...
                        <span>Resgate de senha e altera&ccedil;&otilde;es de acesso do usu&aacute;rio respons&aacute;vel pela admunidade</span>\
                    </div>\
                </a>"
            },
            {type: "newcolumn"},
            ...
            {type: "template", name:"moradores", value: "<a style='text-decoration: none' href='#' onclick='moradores();'>\
                    <div class='opcao'>\
                        ...
                        <span>Cadastre as pessoas que moram nesta admunidade</span>\
                    </div>\
                </a>"
            },
            {type: "newcolumn"},
            {type: "template", name:"veiculos", value: "<a style='text-decoration: none' href='#' onclick='veiculos();'> \
                    <div class='opcao'>\
                        ...
                        <p>Ve&iacute;culos</p>\
                        <span>Cadastro de ve&iacute;culos da admunidade</span>\
                    </div>\
                </a>"
            },
/*	        {type: "newcolumn"},
	        {
		        type: "template", name: "empregados", value: "<a style='text-decoration: none' href='#' onclick='empregados();'> \
                    <div class='opcao'>\
                        ...
                        <span>Registro de pessoas que trabalham para sua admunidade</span>\
                    </div>\
                </a>"
	        },*/
            {type: "newcolumn"},
            ...
            {type: "template", name:"animais", value: "<a style='text-decoration: none' href='#' onclick='animais();'>\
                    <div class='opcao'>\
                        ...
                        <span>Informe os detalhes dos animais dom&eacute;sticos da admunidade</span>\
                    </div>\
                </a>"
            },
            {type: "newcolumn"},
