...
$bloco = $dados['bloco'];
$andar = $dados['andar'];
$unidade = $dados['admunidade'];
$pk_unidade = $dados['pk_unidade'];
$num = $dados['num'];
$email_usuario = $dados['email'];

fb::dump('informacoes', $dados);

// Unidade
$server_web->Execute("
  SELECT *
    FROM condominio.unidades
   WHERE condominio = $condominio and bloco = $bloco and andar = $andar and admunidade = $unidade
");
...
$server_web->Execute("SELECT moradores.nome, genero.descricao AS genero, moradores.cpf, moradores.rg, moradores.nascimento, parentesco.descricao AS parentesco, moradores.local_nascimento, moradores.proprietario
   ...
   WHERE moradores.condominio = $condominio and moradores.bloco = $bloco and moradores.andar = $andar and moradores.admunidade = $pk_unidade
...
$server_web->Execute("
  SELECT *
   ...
   WHERE condominio = $condominio and bloco = $bloco and andar = $andar and admunidade = $pk_unidade
");
