...
var campos_veiculos = [
    ...
    {type: "template", name: "titulo", value: "Cadastro de todos os ve&iacute;culos da unidade", style: "font-weight:bold;"},
    {type: "block", list: [
    ...
    {type: "block", list: [
        ...
        {type: "newcolumn"},
        {type: "fieldset", name: "transferencia", label: "Transfer&ecirc;ncia de unidade", width: 180, list: [
            {type: "block", list: [
            ...
            {type: "block", list: [
                {type: "input", name: "nova_unidade", label: "Unidade", inputWidth: 140, style: "font-weight:bold;",
                    tooltip: "Indique a nova unidade",
                    info: true, note: {text: "Indique a nova unidade"}
                }
            ]}
        ]}
    ]},
...
var campos_veiculos_excluidos = [
    {type: "settings", labelAlign: "left", inputHeight: "18", offsetLeft: "4", offsetTop: "2", position: "label-top"},
    {type: "template", name: "titulo", value: "Registro de ve&iacute;culos exclu&iacute;dos da unidade", style: "font-weight:bold;"},
    {type: "block", list: [
        {type: "fieldset", name: "informacoes_registro", label: "Registro do ve&iacute;culo", width: 955, list: [
            {type: "settings", labelAlign: "left", inputHeight: "18", offsetLeft: "2", offsetTop: "2", position: "label-top"},
            {type: "block", list: [
