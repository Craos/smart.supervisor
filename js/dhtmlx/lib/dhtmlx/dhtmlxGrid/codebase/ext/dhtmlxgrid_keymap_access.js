...
dhtmlXGridObject.prototype._select_ifpossible = function () {
    this.editor && this.editor.obj && this.editor.obj.select && this.editor.obj.select()
};
dhtmlXGridObject.prototype._key_events = {k13_1_0:function () {
    ...
    if (a)this.pagingOn && this.showRow(a.parentNode.idd), this.selectCell(a.parentNode, a._cellIndex, this.row != a.parentNode, !1, !0), this._still_active = !0;
    ...
    if (this.editor)return!1;
    this.selectCell(this.row, 0, !1, !1, !0);
    this._select_ifpossible()
}, k39_1_0:function () {
    if (this.editor)return!1;
    this.selectCell(this.row, this._cCount - 1, !1, !1, !0);
    this._select_ifpossible()
},
    k38_1_0:function () {
        this.selectCell(this.rowsCol[0], this.cell._cellIndex, !1, !1, !0);
        this._select_ifpossible()
    }, k40_1_0:function () {
        this.selectCell(this.rowsCol[this.rowsCol.length - 1], this.cell._cellIndex, !1, !1, !0);
        this._select_ifpossible()
    }, k38_0_1:function () {
        var a = this.getRowIndex(this.row.idd), b = this._nextRow(a, -1);
        if (!b || b._sRow || b._rLoad)return!1;
        this.selectCell(b, this.cell._cellIndex, !1, !1, !0);
        this._select_ifpossible()
    }, k40_0_1:function () {
        var a = this.getRowIndex(this.row.idd), b = this._nextRow(a, 1);
        if (!b || b._sRow || b._rLoad)return!1;
        ...
        for (var a = this.getRowIndex(this.row.idd), b = a; b >= 0; b--)this.selectCell(this.rowsCol[b], this.cell._cellIndex, !0, !1, !0)
    }, k40_1_1:function () {
        for (var a = this.getRowIndex(this.row.idd), b = a + 1; b < this.rowsCol.length; b++)this.selectCell(this.rowsCol[b], this.cell._cellIndex, !0, !1, !0)
    }, k40_0_0:function () {
        if (this.editor && this.editor.combo)this.editor.shiftNext(); else {
            ...
            if (this.rowsBuffer[a]) {
                ...
                this.pagingOn && b && this.showRow(b.idd);
                this._Opera_stop = 0;
                this.selectCell(b, this.cell._cellIndex, !1, !1, !0)
            } else {
        ...
        this.selectCell(this.rowsCol[0], 0, !1, !1, !0);
        this._select_ifpossible()
    }, k35_1_0:function () {
        if (this.editor || !this.rowsCol.length)return!1;
        this.selectCell(this.rowsCol[this.rowsCol.length - 1], this._cCount - 1, !1, !1, !0);
        this._select_ifpossible()
    }, k33_0_0:function () {
        this.pagingOn ? this.changePage(this.currentPage - 1) : this.scrollPage(-1)
    }, k34_0_0:function () {
