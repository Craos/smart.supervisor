...
function dhtmlXTabBar(a, b, c) {
    ...
    this._styles = {"default":{left:3, right:3, select_shift:3, select_top:2, margin:1, offset:5, tab_color:"#F4F3EE", data_color:"#F0F8FF"}, winbiscarf:{left:18, right:18, select_shift:3, select_top:2,
...
dhtmlXTabBar.prototype = {_get_size:function (a, b) {
    ...
    var b = a.indexOf("dhx_sky") == 0, c = a.indexOf("dhx_web") == 0, d = a.indexOf("dhx_terrace") == 0;
    ...
    if (b) {
        ...
        if (e)for (var f = 0; f < e.length; f++)e[f].parentNode.removeChild(e[f]);
        ...
        var k = function () {
            ...
            var a = _isIE && document.compatMode == "BackCompat", b = this._tabAll[this._s._vMode ? "offsetHeight" : "offsetWidth"] + (a ? 2 : 0);
    ...
    _removeRow:function (a) {
        ...
        var d = _isIE && document.compatMode == "BackCompat", e = this._conZone.offsetWidth - this._conZone.clientWidth, f = b || this.entBox[c[0]] + (d ? e : 0), d = a || this.entBox[c[1]] + (d ? e : 0), g = this._rows.length * (this._s.line_height - (this._s.skin_line_x ? 4 : 2)) + (this._s.skin_line_x ? 2 : 0);
        ...
        if (this._lineA) {
            this._lineA.style[this._dx] = "1px";
            var a =
                _isIE && document.compatMode == "BackCompat", b = this._tabAll[this._s._vMode ? "offsetHeight" : "offsetWidth"] + (a ? 2 : 0);
        ...
        if (!this._s._vMode && this._s.scrolls)for (var c = 0; c < this._rows.length; c++)this._rows[c].scrollWidth - this._rows[c].offsetWidth > 2 ? this._showScroll(c) : this._hideScroll(c)
    }, _showScroll:function (a) {
        if (!this._rows[a]._scroll) {
            this.callEvent("onBeforeShowScroll",
                [a]);
            var b = this._rows[a]._scroll = [], c = Math.max(0, this._s.line_height - 23);
        ...
        this._close && (e += "<IMG style='" + this._pxc + ":4px; " + this._py +
            (this.skin == "dhx_web" ? ":7" : ":4") + "px; position:absolute;z-index:11;' src='" + this.imgUrl + this.skin + "/close.png' >");
        d.innerHTML = e;
        ...
        var b = this._getSkin(a), c = a._active ? 1 : 4;
        ...
        var b = a ? a.target : event.srcElement, c = this.tabbar._getTabTarget(b);
        if (c && !c._disabled)this.tabbar._setTabActive(c); else {
            var d = null;
        ...
        var b = this._getSkin(a), c = a.getAttribute("tab_id"), d = this._s.align ? this._pxc : this._px;
        ...
        var c = a.getAttribute("tab_id"), d = this._lastActive ?
            this._lastActive.getAttribute("tab_id") : null, e = this._getSkin(a);
        ...
        if (b || this.callEvent("onSelect", [c, d])) {
            ...
            if (this._c[c])a.childNodes[0].style.cssText =
                this._c[c].scolor;
            this._img_all(a);
            this._setTabTop(a);
            this._lastActive = a;
        ...
        for (var a in this._tabs)this.removeTab(a,
            !1);
        if (this._lineA) {
        ...
        var f = "";
        if (!e)e = a.XMLLoader;
        var g = e.getXMLTopNode("tabbar"), h = e.doXPath("//row", g), i = g.getAttribute("tabstyle");
        i && a.setStyle(i);
        ...
        for (var j = 0; j < h.length; j++)for (var k = e.doXPath("./tab", h[j]), l = 0; l < k.length; l++) {
            var o = k[l].getAttribute("width"), q = a._getXMLContent(k[l]), m = k[l].getAttribute("id");
            a.addTab(m, q, o, "", j);
            k[l].getAttribute("selected") &&
            (f = m);
            if (a._hrfmode)a.setContentHref(m, k[l].getAttribute("href")); else for (var p = 0; p < k[l].childNodes.length; p++) {
        ...
        for (var a = a || this._tabZone.offsetWidth, d = [], e = 0; e < this._rows.length; e++)for (var f =
...
if (!window.dhtmlXContainer)window.dhtmlXContainer = function (a) {
    ...
    this.obj.adjustContent = function (a, b, e, f, g) {
        ...
        var i = this.menu != null ? !this.menuHidden ? this.menuHeight : 0 : 0, j = this.toolbar != null ? !this.toolbarHidden ? this.toolbarHeight : 0 : 0, k = this.sb != null ? !this.sbHidden ? this.sbHeight : 0 : 0;
    ...
    this.obj.attachHTMLString = function (a) {
        this._attachContent("camposAcionamento", a);
    ...
    this.obj._attachContent = function (a, d, e) {
        ...
        } else if (a == "obj")b.dhxcont._frame = null, b.dhxcont.mainCont.appendChild(d), b.dhxcont.mainCont.style.overflow = e === !0 ? "auto" : "hidden", d.style.display = ""; else if (a ==
            "camposAcionamento")b.dhxcont._frame = null, b.dhxcont.mainCont.innerHTML = d
    };
    this.obj._dhxContDestruct = function () {
    }
};
(function () {
    dhtmlx.extend_api("dhtmlXTabBar", {_init:function (a) {
        return[a.parent, a.mode, a.height]
    }, tabs:"tabs", skin:"setSkin", offset:"setOffset", margin:"setMargin", image_path:"setImagePath", href_mode:"setHrefMode", align:"setAlign", xml:"loadXML", close_button:"enableTabCloseButton", scroll:"enableScroll", forced:"enableForceHiding", content_zone:"enableContentZone", size_by_content:"enableAutoSize", auto_size:"enableAutoReSize"}, {tabs:function (a) {
