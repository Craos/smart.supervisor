    ...
    if (_isIE) {
        fr.onreadystatechange = function (a) {
            if (fr.readyState == "complete") {
                try {
                    this.contentWindow.document.body.attachEvent("onfocus", function (e) {
                        that._ev("focus", e);
                    });
                    this.contentWindow.document.body.attachEvent("onblur", function (e) {
                        that._ev("blur", e);
                    });
                    this.contentWindow.document.body.attachEvent("onkeydown", function (e) {
                        that._ev("keydown", e);
                    });
                    this.contentWindow.document.body.attachEvent("onkeyup", function (e) {
                        that._ev("keyup", e);
                    });
                    this.contentWindow.document.body.attachEvent("onkeypress", function (e) {
                        that._ev("keypress", e);
                    });
                    this.contentWindow.document.body.attachEvent("onmouseup", function (e) {
                        that._ev("mouseup", e);
                    });
                    this.contentWindow.document.body.attachEvent("onmousedown", function (e) {
                        that._ev("mousedown", e);
                    });
                    this.contentWindow.document.body.attachEvent("onclick", function (e) {
                        that._ev("click", e);
                    });
                } catch (e) {
                }
        ...
        fr.onload = function () {
            ...
            this.contentWindow.addEventListener("keypress", function (e) {
                that._ev("keypress", e);
            }, false);
        ...
        fr.onunload = function () {
            this.contentWindow.removeEventListener("focus", function (e) {
                that._ev("focus", e);
            }, false);
            this.contentWindow.removeEventListener("blur", function (e) {
                that._ev("blur", e);
            }, false);
            this.contentWindow.removeEventListener("keydown", function (e) {
                that._ev("keydown", e);
            }, false);
            this.contentWindow.removeEventListener("keyup", function (e) {
                that._ev("keyup", e);
            }, false);
            this.contentWindow.removeEventListener("keypress", function (e) {
                that._ev("keypress", e);
            }, false);
            this.contentWindow.removeEventListener("mouseup", function (e) {
                that._ev("mouseup", e);
            }, false);
            this.contentWindow.removeEventListener("mousedown", function (e) {
                that._ev("mousedown", e);
            }, false);
            this.contentWindow.removeEventListener("click", function (e) {
                that._ev("click", e);
            }, false);
        }
    }
