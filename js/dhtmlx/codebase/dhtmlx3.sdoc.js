/**
 *
 * dhtmlXLayoutObject object class.
 * @id dhtmlXLayoutObject
 ...
 * @class dhtmlXLayoutObject
 * @method attachAccordion
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachEditor
 * @class dhtmlXLayoutObject
 * @method attachEditor
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachDataView
 * @class dhtmlXLayoutObject
 * @method attachDataView
 * @memberOf dhtmlXLayoutObject
 * @example var config = {
 * 	type:{
...
/**
 *
 * @id dhtmlXLayoutObject.attachGoogleMaps
 * @class dhtmlXLayoutObject
 * @method attachGoogleMaps
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachGrid
 * @class dhtmlXLayoutObject
 * @method attachGrid
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachHTMLString
 * @class dhtmlXLayoutObject
 * @method attachHTMLString
 * @memberOf dhtmlXLayoutObject
 ...
 * @id dhtmlXLayoutObject.attachLayout
 * @class dhtmlXLayoutObject
 * @method attachLayout
 * @memberOf dhtmlXLayoutObject
 * @param {String} pattern pattern - layout&#039;s pattern (3L, 4U, ...)
 * @param {String} [skin] skin - optional, skin from parent component will applied automatically
...
/**
 *
 * @id dhtmlXLayoutObject.attachMenu
 * @class dhtmlXLayoutObject
 * @method attachMenu
 * @memberOf dhtmlXLayoutObject
 ...
 * @id dhtmlXLayoutObject.attachObject
 * @class dhtmlXLayoutObject
 * @method attachObject
 * @memberOf dhtmlXLayoutObject
 * @param {Object} obj obj - object/objectId
 * @example <script>
...
/**
 *
 * @id dhtmlXLayoutObject.attachStatusBar
 * @class dhtmlXLayoutObject
 * @method attachStatusBar
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachTabbar
 * @class dhtmlXLayoutObject
 * @method attachTabbar
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachToolbar
 * @class dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.attachTree
 * @class dhtmlXLayoutObject
 * @method attachTree
 * @memberOf dhtmlXLayoutObject
 ...
 * @id dhtmlXLayoutObject.attachURL
 * @class dhtmlXLayoutObject
 * @method attachURL
 * @memberOf dhtmlXLayoutObject
 * @param {String} url url - url (string)
...
/**
 *
 * @id dhtmlXLayoutObject.collapse
 * @class dhtmlXLayoutObject
 * @method collapse
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.detachMenu
 * @class dhtmlXLayoutObject
 * @method detachMenu
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.detachObject
 * @class dhtmlXLayoutObject
 * @method detachObject
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.detachStatusBar
 * @class dhtmlXLayoutObject
 * @method detachStatusBar
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.detachToolbar
 * @class dhtmlXLayoutObject
 ...
 * @id dhtmlXLayoutObject.fixSize
 * @class dhtmlXLayoutObject
 * @method fixSize
 * @memberOf dhtmlXLayoutObject
 * @param {Boolean} width width - true/false
 * @param {Boolean} height height - true/false
...
/**
 *
 * @id dhtmlXLayoutObject.getFrame
 * @class dhtmlXLayoutObject
 * @method getFrame
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.getHeight
 * @class dhtmlXLayoutObject
 * @method getHeight
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.getIndex
 * @class dhtmlXLayoutObject
 * @method getIndex
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.getWidth
 * @class dhtmlXLayoutObject
 * @method getWidth
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.hideHeader
 * @class dhtmlXLayoutObject
 * @method hideHeader
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.hideMenu
 * @class dhtmlXLayoutObject
 * @method hideMenu
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.hideStatusBar
 * @class dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.hideToolbar
 * @class dhtmlXLayoutObject
 * @method hideToolbar
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.isCollapsed
 * @class dhtmlXLayoutObject
 * @method isCollapsed
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.isHeaderVisible
 * @class dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.progressOff
 * @class dhtmlXLayoutObject
 * @method progressOff
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.progressOn
 * @class dhtmlXLayoutObject
 * @method progressOn
 * @memberOf dhtmlXLayoutObject
...
/**
 * sets cell&#039;s height
 * @id dhtmlXLayoutObject.setHeight
 * @class dhtmlXLayoutObject
 * @method setHeight
 * @memberOf dhtmlXLayoutObject
...
/**
 * set header&#039;s text
 * @id dhtmlXLayoutObject.setText
 * @class dhtmlXLayoutObject
 * @method setText
 * @memberOf dhtmlXLayoutObject
 * @param {String} text text - new header&#039;s text
...
/**
 * sets cell&#039;s width
 * @id dhtmlXLayoutObject.setWidth
 * @class dhtmlXLayoutObject
 * @method setWidth
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.showHeader
 * @class dhtmlXLayoutObject
 * @method showHeader
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.showMenu
 * @class dhtmlXLayoutObject
 * @method showMenu
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.showStatusBar
 * @class dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.showToolbar
 * @class dhtmlXLayoutObject
 * @method showToolbar
 * @memberOf dhtmlXLayoutObject
...
/**
 * create a view
 * @id dhtmlXLayoutObject.view
 * @class dhtmlXLayoutObject
 * @method view
 * @memberOf dhtmlXLayoutObject
 * @param {String} text text - a view&#039;s name
 ...
 * @id dhtmlXLayoutObject.attachEvent
 * @class dhtmlXLayoutObject
 * @method attachEvent
 * @memberOf dhtmlXLayoutObject
 * @param {String} original original - event&#039;s original name;
 * @param {String} catcher catcher - event handler;
 * @param {Object} CallObj CallObj - object that will call the event.
 ...
 * @id dhtmlXLayoutObject.cells
 * @class dhtmlXLayoutObject
 * @method cells
 * @memberOf dhtmlXLayoutObject
 * @param {String} id id - cell&#039;s id
 ...
 * @id dhtmlXLayoutObject.checkEvent
 * @class dhtmlXLayoutObject
 * @method checkEvent
 * @memberOf dhtmlXLayoutObject
 * @param {String} name name - event&#039;s name
 ...
 * @id dhtmlXLayoutObject.detachEvent
 * @class dhtmlXLayoutObject
 * @method detachEvent
 * @memberOf dhtmlXLayoutObject
 * @param {String} id id - event id
 ...
 * @id dhtmlXLayoutObject.forEachItem
 * @class dhtmlXLayoutObject
 * @method forEachItem
 * @memberOf dhtmlXLayoutObject
 * @param {Object} handler handler - user-defined function, passed cell&#039;s object as an argument
 ...
 * @id dhtmlXLayoutObject.getEffect
 * @class dhtmlXLayoutObject
 * @method getEffect
 * @memberOf dhtmlXLayoutObject
 * @param {String} efName efName - effect name
 ...
 * @id dhtmlXLayoutObject.getIdByIndex
 * @class dhtmlXLayoutObject
 * @method getIdByIndex
 * @memberOf dhtmlXLayoutObject
 * @param {Number} ind ind - cell&#039;s index (int)
 ...
 * @id dhtmlXLayoutObject.getIndexById
 * @class dhtmlXLayoutObject
 * @method getIndexById
 * @memberOf dhtmlXLayoutObject
 * @param {String} id id - cell&#039;s id (string)
...
/**
 *
 * @id dhtmlXLayoutObject.listAutoSizes
 * @class dhtmlXLayoutObject
 * @method listAutoSizes
 * @memberOf dhtmlXLayoutObject
...
/**
 *
 * @id dhtmlXLayoutObject.listViews
 * @class dhtmlXLayoutObject
 * @method listViews
 * @memberOf dhtmlXLayoutObject
 ...
 * @id dhtmlXLayoutObject.setAutoSize
 * @class dhtmlXLayoutObject
 * @method setAutoSize
 * @memberOf dhtmlXLayoutObject
 * @param {String} hor hor - cells that will be autosized horizontally
 * @param {String} ver ver - cells that will be autosized vertically
 ...
 * @id dhtmlXLayoutObject.setCollapsedText
 * @class dhtmlXLayoutObject
 * @method setCollapsedText
 * @memberOf dhtmlXLayoutObject
 * @param {String} text id - cell id
...
/**
 * sets effect
 * @id dhtmlXLayoutObject.setEffect
 * @class dhtmlXLayoutObject
 * @method setEffect
 * @memberOf dhtmlXLayoutObject
 * @param {String} efName efName - effect&#039;s name
 * @param {Boolean} efValue efValue - true/false
...
/**
 * sets path to images
 * @id dhtmlXLayoutObject.setImagePath
 * @class dhtmlXLayoutObject
 * @method setImagePath
 * @memberOf dhtmlXLayoutObject
 * @param {String} path path - path on hard disk
...
/**
 *
 * @id dhtmlXLayoutObject.setSizes
 * @class dhtmlXLayoutObject
 * @method setSizes
 * @memberOf dhtmlXLayoutObject
...
/**
 * sets layout&#039;s skin
 * @id dhtmlXLayoutObject.setSkin
 * @class dhtmlXLayoutObject
 * @method setSkin
 * @memberOf dhtmlXLayoutObject
 * @param {String} skin skin - skin name (string)
...
/**
 *
 * dhtmlXAccordion object class.
 * @id dhtmlXAccordion
 * @class dhtmlXAccordion
 * @constructor
...
/**
 *
 * @id dhtmlXAccordion.attachEditor
 * @class dhtmlXAccordion
 * @method attachEditor
 * @memberOf dhtmlXAccordion
 * @example var dhxEd = dhxLayout.cells("a").attachEditor(); // returns editor object
...
/**
 *
 * @id dhtmlXAccordion.attachFolders
 * @class dhtmlXAccordion
 * @method attachFolders
 * @memberOf dhtmlXAccordion
 ...
 * @id dhtmlXAccordion.attachLayout
 * @class dhtmlXAccordion
 * @method attachLayout
 * @memberOf dhtmlXAccordion
 * @param {String} pattern pattern - layout&#039;s pattern (3L, 4U, ...)
 * @param {String} [skin] skin - optional, the skin from the parent component will applied automatically
 * @example var dhxLayout2 = dhxLayout.cells("a").attachLayout("3L"); // returns layout object
 */
 ...
 * @id dhtmlXAccordion.attachObject
 * @class dhtmlXAccordion
 * @method attachObject
 * @memberOf dhtmlXAccordion
 * @param {Object} obj obj - object/objectId
...
/**
 *
 * @id dhtmlXAccordion.attachStatusBar
 * @class dhtmlXAccordion
 * @method attachStatusBar
 * @memberOf dhtmlXAccordion
 * @example var sb = dhxLayout.cells("a").attachStatusBar(); // returns status bar object
...
/**
 *
 * @id dhtmlXAccordion.attachTabbar
 * @class dhtmlXAccordion
 * @method attachTabbar
 * @memberOf dhtmlXAccordion
 * @example var dhxTabbar = dhxLayout.cells("a").attachTabbar(); // returns tabbar object
...
/**
 *
 * @id dhtmlXAccordion.attachToolbar
 * @class dhtmlXAccordion
 * @method attachToolbar
 * @memberOf dhtmlXAccordion
 * @example var dhxToolbar = dhxLayout.cells("a").attachToolbar(); // returns toolbar object
 ...
 * @id dhtmlXAccordion.setHeight
 * @class dhtmlXAccordion
 * @method setHeight
 * @memberOf dhtmlXAccordion
 * @param {String} height height - height for whole item (with header)
...
/**
 * sets item&#039;s text
 * @id dhtmlXAccordion.setText
 * @class dhtmlXAccordion
 * @method setText
 * @memberOf dhtmlXAccordion
 * @param {String} text text - new text
...
/**
 * adds a new item
 * @id dhtmlXAccordion.addItem
 * @class dhtmlXAccordion
 * @method addItem
 * @memberOf dhtmlXAccordion
 * @param {String} itemId itemId - item&#039;s id
 * @param {String} itemText itemText - item&#039;s text
 ...
 * @id dhtmlXAccordion.attachEvent
 * @class dhtmlXAccordion
 * @method attachEvent
 * @memberOf dhtmlXAccordion
 * @param {String} original original - event&#039;s original name;
 ...
 * @id dhtmlXAccordion.cells
 * @class dhtmlXAccordion
 * @method cells
 * @memberOf dhtmlXAccordion
 * @param {String} itemId itemId - id
...
/**
 * removes an event handler
 * @id dhtmlXAccordion.detachEvent
 * @class dhtmlXAccordion
 * @method detachEvent
 * @memberOf dhtmlXAccordion
 * @param {String} id id - event&#039;s id
...
/**
 *
 * @id dhtmlXAccordion.enableMultiMode
 * @class dhtmlXAccordion
 * @method enableMultiMode
 * @memberOf dhtmlXAccordion
...
/**
 * iterator, calls a user-defined function n-times
 * @id dhtmlXAccordion.forEachItem
 * @class dhtmlXAccordion
 * @method forEachItem
 * @memberOf dhtmlXAccordion
 * @param {Object} handler handler - user-defined function, item&#039;s object is passed as incoming argument
 * @example dhxAcc.forEachItem(function(item){
 *     // code here
 * });
 *     // or
 ...
 * @id dhtmlXAccordion.removeItem
 * @class dhtmlXAccordion
 * @method removeItem
 * @memberOf dhtmlXAccordion
 * @param {String} id id - item&#039;s id
...
/**
 * sets path to icons
 * @id dhtmlXAccordion.setIconsPath
 * @class dhtmlXAccordion
 * @method setIconsPath
 * @memberOf dhtmlXAccordion
 * @param {String} path path - path on the hard disk
 ...
 * @class dhtmlXTabBar
 * @method addTab
 * @memberOf dhtmlXTabBar
 * @param {String} id id - tab id
 * @param {String} text text - tab content
 * @param {String} size size - width(height) of tab
 * @param {Number} [position] position - tab index , optional
 * @param {Number} [row] row - index of row, optional  [only in PRO version]
 * @example
 */
 ...
 * @id dhtmlXTabBar.attachEvent
 * @class dhtmlXTabBar
 * @method attachEvent
 * @memberOf dhtmlXTabBar
 * @param {String} evName evName - name of the event;
 ...
 * @id dhtmlXTabBar.disableTab
 * @class dhtmlXTabBar
 * @method disableTab
 * @memberOf dhtmlXTabBar
 * @param {String} id tab - id of tab
 * @example
 */
 ...
 * @id dhtmlXTabBar.enableAutoReSize
 * @class dhtmlXTabBar
 ...
 * @id dhtmlXTabBar.enableAutoSize
 * @class dhtmlXTabBar
 * @method enableAutoSize
 * @memberOf dhtmlXTabBar
 * @param {String} autoWidth autoWidth - enable/disable auto adjusting width
 * @param {String} autoHeight autoHeight - enable/disable auto adjusting height
 * @example
 */
 ...
 * @id dhtmlXTabBar.enableContentZone
 * @class dhtmlXTabBar
 * @method enableContentZone
 * @memberOf dhtmlXTabBar
 * @param {Boolean} mode mode - true/false
 * @example
 */
...
/**
 *
 * @id dhtmlXTabBar.enableForceHiding
 * @class dhtmlXTabBar
 * @method enableForceHiding
 * @memberOf dhtmlXTabBar
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTabBar.enableTabCloseButton
 * @class dhtmlXTabBar
 * @method enableTabCloseButton
 * @memberOf dhtmlXTabBar
 * @param {Boolean} mode bool - false/true - enable/disable
 * @example
 */
 ...
 * @id dhtmlXTabBar.forceLoad
 * @class dhtmlXTabBar
 * @method forceLoad
 * @memberOf dhtmlXTabBar
 * @param {String} id tabId - id of tab in question
 * @param {String} [href] href - new href, optional
 * @example
 */
...
/**
 * get label of tab
 * @id dhtmlXTabBar.getLabel
 * @class dhtmlXTabBar
 * @method getLabel
 * @memberOf dhtmlXTabBar
 * @param {String} tab tab - id of tab
 * @example
 */
 ...
 * @id dhtmlXTabBar.loadXML
 * @class dhtmlXTabBar
 * @method loadXML
 * @memberOf dhtmlXTabBar
 * @param {String} url file - link too XML file
 * @param {String} call afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTabBar.loadXMLString
 * @class dhtmlXTabBar
 * @method loadXMLString
 * @memberOf dhtmlXTabBar
 * @param {String} xmlString xmlString - XML string
 * @param {String} call afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTabBar.normalize
 * @class dhtmlXTabBar
 * @method normalize
 * @memberOf dhtmlXTabBar
 * @param {String} [limit] limit - width of tabbar zone, optional
 * @param {Boolean} [full] full - true | false - force to change size of tabs to make rows of equal width
 * @example
 */
 ...
 * @id dhtmlXTabBar.removeTab
 * @class dhtmlXTabBar
 * @method removeTab
 * @memberOf dhtmlXTabBar
 * @param {String} id tab - id of tab
 * @param {String} mode mode - if set to true, selection jump from current tab to nearest one
 * @example
 */
 ...
 * @id dhtmlXTabBar.setAlign
 * @class dhtmlXTabBar
 * @method setAlign
 * @memberOf dhtmlXTabBar
 * @param {String} n align - left/right for gorizontal tabbar, top/bottom for vertical tabbar
 * @example
 */
...
/**
 * set content of tab
 * @id dhtmlXTabBar.setContent
 * @class dhtmlXTabBar
 * @method setContent
 * @memberOf dhtmlXTabBar
 * @param {String} id id - id of tab
 * @param {Object} value nodeId - id of container, or container object
 * @example
 */
...
/**
 *
 * @id dhtmlXTabBar.setContentHTML
 * @class dhtmlXTabBar
 * @method setContentHTML
 * @memberOf dhtmlXTabBar
 * @param {String} id id - id of tab
 * @param {String} value html - html string
 * @example
 */
 ...
 * @id dhtmlXTabBar.setContentHref
 * @class dhtmlXTabBar
 * @method setContentHref
 * @memberOf dhtmlXTabBar
 * @param {String} id href - link too external file
 * @example
 */
 ...
 * @id dhtmlXTabBar.setCustomStyle
 * @class dhtmlXTabBar
 * @method setCustomStyle
 * @memberOf dhtmlXTabBar
 * @param {String} id id - id of tab for which setting will be applied
 * @param {String} color color - tab color
 * @param {String} [scolor] color - scolor - color in selected state ( optional)
 * @param {String} [style] css - css class will be attached to text of tab in question
 * @example
 */
 ...
 * @id dhtmlXTabBar.setHrefMode
 * @class dhtmlXTabBar
 * @method setHrefMode
 * @memberOf dhtmlXTabBar
 * @param {String} mode mode - href mode - iframe/iframes/ajax
 * @example
 */
 ...
 * @id dhtmlXTabBar.setImagePath
 * @class dhtmlXTabBar
 * @method setImagePath
 * @memberOf dhtmlXTabBar
 * @param {String} url path - path to image folder
 * @example
 */
...
/**
 * set label of tab
 * @id dhtmlXTabBar.setLabel
 * @class dhtmlXTabBar
 * @method setLabel
 * @memberOf dhtmlXTabBar
 * @param {String} id tab - id of tab
 * @param {String} text value -  new label
 * @example
 */
 ...
 * @id dhtmlXTabBar.setMargin
 * @class dhtmlXTabBar
 * @method setMargin
 * @memberOf dhtmlXTabBar
 * @param {String} n margin - margin value
 * @example
 */
 ...
 * @id dhtmlXTabBar.setOffset
 * @class dhtmlXTabBar
 * @method setOffset
 * @memberOf dhtmlXTabBar
 * @param {String} n offset - offset value
 * @example
 */
...
/**
 * set control size
 * @id dhtmlXTabBar.setSize
 * @class dhtmlXTabBar
 * @method setSize
 * @memberOf dhtmlXTabBar
 * @param {String} x width - new width
 * @param {String} y height - new height
 * @example
 */
 ...
 * @id dhtmlXTabBar.setSkin
 * @class dhtmlXTabBar
 * @method setSkin
 * @memberOf dhtmlXTabBar
 * @param {String} name name - any valid style name
 * @example
 */
 ...
 * @id dhtmlXTabBar.setSkinColors
 * @class dhtmlXTabBar
 * @method setSkinColors
 * @memberOf dhtmlXTabBar
 * @param {String} a a_tab - color of activ tab
 * @param {String} b p_tab - color of passive tab
 * @example
 */
 ...
 * @id dhtmlXTabBar.setTabActive
 * @class dhtmlXTabBar
 * @method setTabActive
 * @memberOf dhtmlXTabBar
 * @param {String} id tabId - id of tab
 * @example
 */
 ...
 * @id dhtmlXTabBar.tabWindow
 * @class dhtmlXTabBar
 * @method tabWindow
 * @memberOf dhtmlXTabBar
 * @param {String} tab_id tab_id - tab id
 * @example
 */
...
/**
 *
 * @id dhtmlXTabBar.attachAccordion
 * @class dhtmlXTabBar
 * @method attachAccordion
 * @memberOf dhtmlXTabBar
 * @example var dhxAcc = dhxLayout.cells("a").attachAccordion(); // returns accordion object
...
/**
 *
 * @id dhtmlXTabBar.attachDataView
 * @class dhtmlXTabBar
 * @method attachDataView
 * @memberOf dhtmlXTabBar
 * @example var config = {
...
/**
 *
 * @id dhtmlXTabBar.attachStatusBar
 * @class dhtmlXTabBar
 * @method attachStatusBar
 * @memberOf dhtmlXTabBar
 * @example var sb = dhxLayout.cells("a").attachStatusBar(); // returns status bar object
 ...
 * @class dhtmlXWindows
 * @method addUserButton
 * @memberOf dhtmlXWindows
 * @param {String} id id - button&#039;s id
 * @param {String} pos pos - button&#039;s position
 * @param {String} title title - button&#039;s tooltip
 * @param {String} label label - button&#039;s name (according to css)
...
/**
 *
 * @id dhtmlXWindows.bringToBottom
 * @class dhtmlXWindows
 * @method bringToBottom
 * @memberOf dhtmlXWindows
...
/**
 *
 * @id dhtmlXWindows.centerOnScreen
 * @class dhtmlXWindows
...
/**
 *
 * @id dhtmlXWindows.getMaxDimension
 * @class dhtmlXWindows
...
/**
 *
 * @id dhtmlXWindows.getMinDimension
 * @class dhtmlXWindows
 ...
 * @id dhtmlXWindows.keepInViewport
 * @class dhtmlXWindows
 * @method keepInViewport
 * @memberOf dhtmlXWindows
 * @param {String} state state - if true - window is not allowed to be placed outside the viewport
 ...
 * @id dhtmlXWindows.removeUserButton
 * @class dhtmlXWindows
 * @method removeUserButton
 * @memberOf dhtmlXWindows
 * @param {String} id id - button&#039;s id
 ...
 * @id dhtmlXWindows.setIcon
 * @class dhtmlXWindows
 * @method setIcon
 * @memberOf dhtmlXWindows
 * @param {String} iconEnabled iconEnabled - url to the icon for the enabled state
 * @param {String} iconDisabled iconDisabled - url to the icon for the disabled state
 ...
 * @id dhtmlXWindows.setMaxDimension
 * @class dhtmlXWindows
 * @method setMaxDimension
 * @memberOf dhtmlXWindows
 ...
 * @id dhtmlXWindows.setMinDimension
 * @class dhtmlXWindows
 ...
 * @id dhtmlXWindows.setModal
 * @class dhtmlXWindows
 * @method setModal
 * @memberOf dhtmlXWindows
 * @param {Boolean} state state - true|false
 ...
 * @id dhtmlXWindows.setPosition
 * @class dhtmlXWindows
 * @method setPosition
 * @memberOf dhtmlXWindows
 * @param {String} x x - x coordinate
 * @param {String} y y - y coordinate
 ...
 * @id dhtmlXWindows.setToFullScreen
 * @class dhtmlXWindows
 ...
 * @id dhtmlXWindows.attachViewportTo
 * @class dhtmlXWindows
 * @method attachViewportTo
 * @memberOf dhtmlXWindows
 * @param {Object} objId objId - object id
 ...
 * @id dhtmlXWindows.createWindow
 * @class dhtmlXWindows
 * @method createWindow
 * @memberOf dhtmlXWindows
 * @param {String} id id - window&#039;s id
 * @param {String} x x - top-left window corner&#039;s X-coordinate
 * @param {String} y y - top-left window corner&#039;s Y-coordinate
 * @param {String} width width - window&#039;s width
 * @param {String} height height - window&#039;s height
 ...
 * @id dhtmlXWindows.enableAutoViewport
 * @class dhtmlXWindows
 * @method enableAutoViewport
 * @memberOf dhtmlXWindows
 * @param {Boolean} state state - true|false
 ...
 * @id dhtmlXWindows.forEachWindow
 * @class dhtmlXWindows
 * @method forEachWindow
 * @memberOf dhtmlXWindows
 * @param {String} handler hander (user function)
...
/**
 *
 * @id dhtmlXWindows.getBottommostWindow
 * @class dhtmlXWindows
 * @method getBottommostWindow
 * @memberOf dhtmlXWindows
 ...
 * @id dhtmlXWindows.getTopmostWindow
 * @class dhtmlXWindows
 * @method getTopmostWindow
 * @memberOf dhtmlXWindows
 * @param {String} visibleOnly visibleOnly - search only in set of visible windows
 ...
 * @id dhtmlXWindows.setEffect
 * @class dhtmlXWindows
 * @method setEffect
 * @memberOf dhtmlXWindows
 * @param {String} efName efName - effect&#039;s name
 * @param {Boolean} efValue efValue - true/false to enable/disable
 ...
 * @id dhtmlXWindows.setImagePath
 * @class dhtmlXWindows
 * @method setImagePath
 * @memberOf dhtmlXWindows
 * @param {String} path path - url to the directory where images are located
 ...
 * @id dhtmlXWindows.setSkin
 * @class dhtmlXWindows
 * @method setSkin
 * @memberOf dhtmlXWindows
 * @param {String} skin skin - skin&#039;s name
 ...
 * @id dhtmlXWindows.setViewport
 * @class dhtmlXWindows
 * @method setViewport
 * @memberOf dhtmlXWindows
 * @param {String} x x - top-left viewport corner&#039;s X-coordinate
 * @param {String} y y - top-left viewport corner&#039;s Y-coordinate
 * @param {String} width width - viewport&#039;s width
 * @param {String} height height - viewport&#039;s height
 * @param {Object} parentObj parentObj - create inside of parentObj object
 ...
 * @method attachEvent
 * @memberOf dhtmlXForm
 * @param {String} evName evName - the event name;
 * @param {Function} evHandler evHandler - a user-defined handler that will be called when event occurs.
 ...
 * @method bind
 * @memberOf dhtmlXForm
 * @param {Object} [target] target - (object) the object that method is assigned to (optional)
 * @param {String} [rule] rule - (function) sets the rule according which components will be bound (optional)
...
/**
 *
 * @id dhtmlXForm.checkItem
 * @class dhtmlXForm
 * @method checkItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value isItemChecked()
 * @example formData = [
...
/**
 *
 * @id dhtmlXForm.detachEvent
 * @class dhtmlXForm
 * @method detachEvent
 * @memberOf dhtmlXForm
 * @param {String} evId evId - the event id.
 * @example var myEvent = myForm.attachEvent("onChange", function (){
 *     //event handler code
 * })
 * ..
...
/**
 *
 * @id dhtmlXForm.disableItem
 * @class dhtmlXForm
 * @method disableItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value enableItem()
...
/**
 *
 * @id dhtmlXForm.enableItem
 * @class dhtmlXForm
 * @method enableItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value value - the value of a radio button ( the radio&#039;s parameter &#039;value&#039;). Required for &#039;radio&#039; items only
 * @example formData=[{type: "input", label: "Login"},
 *           {type: "input", label: "Password"},
 *           {type: "button", name:"loginButton", value: "Log in", command:"Login"},
...
/**
 *
 * @id dhtmlXForm.forEachItem
 * @class dhtmlXForm
 * @method forEachItem
 * @memberOf dhtmlXForm
 * @param {String} handler handler - a user-defined handler, gets the id of item (the item&#039;s parameter &#039;name&#039;) as argument.
...
/**
 *
 * @id dhtmlXForm.getColorPicker
 * @class dhtmlXForm
 * @method getColorPicker
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
...
/**
 *
 * @id dhtmlXForm.getItemLabel
 * @class dhtmlXForm
 * @method getItemLabel
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value setItemLabel()
...
/**
 *
 * @id dhtmlXForm.getUserData
 * @class dhtmlXForm
 * @method getUserData
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} udKey setUserData()
...
/**
 *
 * @id dhtmlXForm.hideItem
 * @class dhtmlXForm
 * @method hideItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value showItem()
 * @example formData=[{type: "input", label: "Login"},
 *           {type: "input", label: "Password"},
 *           {type: "button", name:"loginButton", value: "Log in", command:"Login"},
 *           {type: "button", name:"logoutButton", value: "Log out", command:"Logout"}];
 ...
 * @method load
 * @memberOf dhtmlXForm
 * @param {String} id id -the id of record , which need to be loaded
...
/**
 *
 * @id dhtmlXForm.loadStruct
 * @class dhtmlXForm
 * @method loadStruct
 * @memberOf dhtmlXForm
 * @param {String} data data - http path to XML file
 * @param {String} [onLoadFunction] onLoadFunction - (optional) a user defined handler which is called when loading has been done
...
/**
 *
 * @id dhtmlXForm.loadStructString
 * @class dhtmlXForm
 * @method loadStructString
 * @memberOf dhtmlXForm
 * @param {String} string string - XML string with data
 * @param {String} [onLoadFunction] onLoadFunction - (optional) a user defined handler which is called when loading has been done
...
/**
 *
 * @id dhtmlXForm.resetValidateCss
 * @class dhtmlXForm
 * @method resetValidateCss
 * @memberOf dhtmlXForm
 ...
 * @method send
 * @memberOf dhtmlXForm
 * @param {String} url url - the server-side script which will receive info
 * @param {String} [mode] mode -(optional) a sending mode, can be get or post. The default value - post
 * @param {Function} [callback] callback - (optional) the method which will be called after saving
...
/**
 *
 * @id dhtmlXForm.setFormData
 * @class dhtmlXForm
 * @method setFormData
 * @memberOf dhtmlXForm
 * @param {String} data data - the hash of properties
...
/**
 *
 * @id dhtmlXForm.setItemHeight
 * @class dhtmlXForm
 * @method setItemHeight
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} height height - the height you want to set for item
...
/**
 *
 * @id dhtmlXForm.setItemLabel
 * @class dhtmlXForm
 * @method setItemLabel
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} label label - a new label (empty string if you want to cancel label)
...
/**
 *
 * @id dhtmlXForm.setItemValue
 * @class dhtmlXForm
 * @method setItemValue
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value getItemValue()
...
/**
 *
 * @id dhtmlXForm.setItemWidth
 * @class dhtmlXForm
 * @method setItemWidth
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} width width - the width you want to set for item
...
/**
 *
 * @id dhtmlXForm.setReadonly
 * @class dhtmlXForm
 * @method setReadonly
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} state isReadonly()
...
/**
 *
 * @id dhtmlXForm.setUserData
 * @class dhtmlXForm
 * @method setUserData
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} udKey getUserData()
 * @example myForm.setUserData('myInput','Key',10)
 */
...
/**
 *
 * @id dhtmlXForm.showItem
 * @class dhtmlXForm
 * @method showItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value isItemHidden()
 * @example formData=[{type: "input", label: "Login"},
 *           {type: "input", label: "Password"},
 *           {type: "button", name:"loginButton", value: "Log in", command:"Login"},
 *           {type: "button", name:"logoutButton", value: "Log out", command:"Logout"}];
...
/**
 *
 * @id dhtmlXForm.uncheckItem
 * @class dhtmlXForm
 * @method uncheckItem
 * @memberOf dhtmlXForm
 * @param {String} name name - the id of item (the item&#039;s parameter &#039;name&#039;)
 * @param {String} value checkItem()
 * @example // for radio button
...
/**
 *
 * dhtmlXGridObject object class.
 * @id dhtmlXGridObject
 * @class dhtmlXGridObject
 * @constructor
 ...
 * @class dhtmlXGridObject
 * @method addRow
 * @memberOf dhtmlXGridObject
 * @param {String} new_id new_id - row ID, must be unique
 * @param {String} text text - row values, may be a comma separated list or an array
 * @param {Number} [ind] ind - index of new row, optional, row added to the last position by default
...
/**
 *
 * @id dhtmlXGridObject.addRowFromClipboard
 * @class dhtmlXGridObject
 * @method addRowFromClipboard
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.adjustColumnSize
 * @class dhtmlXGridObject
 * @method adjustColumnSize
 * @memberOf dhtmlXGridObject
 * @param {Number} cInd cInd - index of column
...
/**
 * adds any user-defined handler to available events
 * @id dhtmlXGridObject.attachEvent
 * @class dhtmlXGridObject
 * @method attachEvent
 * @memberOf dhtmlXGridObject
 * @param {String} evName evName - name of the event;
 * @param {Function} evHandler return &#039;true&#039;; -  confirm action
 * @example <script>
 ...
 * @id dhtmlXGridObject.attachFooter
 * @class dhtmlXGridObject
 * @method attachFooter
 * @memberOf dhtmlXGridObject
 * @param {String} values values - array of header titles
 * @param {String} [style] style - array of styles, optional
 * @example //plain usage
 ...
 * @id dhtmlXGridObject.attachHeader
 * @class dhtmlXGridObject
 * @method attachHeader
 * @memberOf dhtmlXGridObject
 * @param {String} values values - array of header titles
...
/**
 *
 * @id dhtmlXGridObject.attachToObject
 * @class dhtmlXGridObject
 * @method attachToObject
 * @memberOf dhtmlXGridObject
 * @param {Object} obj obj - object to attach to
 ...
 * @id dhtmlXGridObject.cellById
 * @class dhtmlXGridObject
 * @method cellById
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id -  row id
 * @param {Number} col col -  column index
 ...
 * @id dhtmlXGridObject.cellByIndex
 * @class dhtmlXGridObject
 * @method cellByIndex
 * @memberOf dhtmlXGridObject
 * @param {Number} row_index row_index -  row index
 * @param {Number} col col -  column index
 ...
 * @id dhtmlXGridObject.cellToClipboard
 * @class dhtmlXGridObject
 * @method cellToClipboard
 * @memberOf dhtmlXGridObject
 * @param {String} [rowId] rowId - id of row (optional, use selected row by default)
 * @param {Number} [cellInd] cellInd - column index(optional, use selected cell by default)
 ...
 * @id dhtmlXGridObject.changePage
 * @class dhtmlXGridObject
 * @method changePage
 * @memberOf dhtmlXGridObject
 * @param {String} pageNum pageNum -  new active page
...
/**
 * change current page in grid
 * @id dhtmlXGridObject.changePageRelative
 * @class dhtmlXGridObject
 * @method changePageRelative
 * @memberOf dhtmlXGridObject
 * @param {String} ind ind - correction ( -1,1,2  etc) to current active page
 ...
 * @id dhtmlXGridObject.changeRowId
 * @class dhtmlXGridObject
 * @method changeRowId
 * @memberOf dhtmlXGridObject
 * @param {String} oldRowId oldRowId - row id to change
 * @param {String} newRowId newRowId - row id to set
 ...
 * @id dhtmlXGridObject.checkAll
 * @class dhtmlXGridObject
 * @method checkAll
 * @memberOf dhtmlXGridObject
 * @param {Boolean} [mode] mode - {true|false} check\uncheck all checkboxes in grid (optional, true by default)
 ...
 * @id dhtmlXGridObject.clearAll
 * @class dhtmlXGridObject
 * @method clearAll
 * @memberOf dhtmlXGridObject
 * @param {String} header header - (boolean) enable/disable cleaning header
 ...
 * @id dhtmlXGridObject.clearAndLoad
 * @class dhtmlXGridObject
 * @method clearAndLoad
 * @memberOf dhtmlXGridObject
 * @param {String} url url - url to external file
 * @param {String} [call] call - after loading callback function, optional, can be ommited
 * @param {String} [type] type - type of data (xml,csv,json,jsarray) , optional, xml by default
...
/**
 *
 * @id dhtmlXGridObject.clearChangedState
 * @class dhtmlXGridObject
 * @method clearChangedState
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.clearConfigCookie
 * @class dhtmlXGridObject
 * @method clearConfigCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional,cookie name
...
/**
 *
 * @id dhtmlXGridObject.clearSelection
 * @class dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.collapseAllGroups
 * @class dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.collapseGroup
 * @class dhtmlXGridObject
 * @method collapseGroup
 * @memberOf dhtmlXGridObject
 * @param {String} val val - value to use to determine what group to collapse (in other words this should be value common for all of them)
 ...
 * @id dhtmlXGridObject.collectValues
 * @class dhtmlXGridObject
 * @method collectValues
 * @memberOf dhtmlXGridObject
 * @param {Number} column column - {number} zero based index of column
...
/**
 *
 * @id dhtmlXGridObject.copyBlockToClipboard
 * @class dhtmlXGridObject
 * @method copyBlockToClipboard
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.copyRowContent
 * @class dhtmlXGridObject
 * @method copyRowContent
 * @memberOf dhtmlXGridObject
 * @param {String} from_row_id from_row_id - id of the row to copy content from
 * @param {String} to_row_id to_row_id - id of the row to copy content to
...
/**
 * delete column
 * @id dhtmlXGridObject.deleteColumn
 * @class dhtmlXGridObject
 * @method deleteColumn
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - index of column
...
/**
 *
 * @id dhtmlXGridObject.deleteSelectedRows
 * @class dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.destructor
 * @class dhtmlXGridObject
 * @method destructor
 * @memberOf dhtmlXGridObject
...
/**
 * removes an event handler
 * @id dhtmlXGridObject.detachEvent
 * @class dhtmlXGridObject
 * @method detachEvent
 * @memberOf dhtmlXGridObject
 * @param {String} id id - event id
 ...
 * @id dhtmlXGridObject.detachFooter
 * @class dhtmlXGridObject
 * @method detachFooter
 * @memberOf dhtmlXGridObject
 * @param {Number} index index - index of a footer
 ...
 * @id dhtmlXGridObject.detachHeader
 * @class dhtmlXGridObject
 * @method detachHeader
 * @memberOf dhtmlXGridObject
 * @param {Number} index index - index of row to be removed ( zero based )
...
/**
 *
 * @id dhtmlXGridObject.disableUndoRedo
 * @class dhtmlXGridObject
 * @method disableUndoRedo
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.doesRowExist
 * @class dhtmlXGridObject
 * @method doesRowExist
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 ...
 * @id dhtmlXGridObject.editStop
 * @class dhtmlXGridObject
 * @method editStop
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode - if true - current edit value will be reverted to previous one
 ...
 * @id dhtmlXGridObject.enableAlterCss
 * @class dhtmlXGridObject
 * @method enableAlterCss
 * @memberOf dhtmlXGridObject
 * @param {String} cssE cssE - name of css class for even rows
 * @param {String} cssU cssU - name of css class for odd rows
 * @param {Boolean} [perLevel] perLevel - true/false - mark rows not by order, but by level in treegrid (optional, default value: true - treeGrid, false - Grid)
 * @param {Boolean} [levelUnique] levelUnique - true/false - creates additional unique css class based on row level (optional, false by default)
 * @example <style>
 * .even{
 ...
 * @id dhtmlXGridObject.enableAutoHeight
 * @class dhtmlXGridObject
 * @method enableAutoHeight
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 * @param {String} maxHeight maxHeight - maximum height before scrolling appears (no limit by default)
 * @param {Boolean} countFullHeight countFullHeight - control the usage of maxHeight parameter - when set to true all grid height included in max height calculation, if false then only data part (no header) of grid included in calcualation (false by default)
 ...
 * @id dhtmlXGridObject.enableAutoHiddenColumnsSaving
 * @class dhtmlXGridObject
 * @method enableAutoHiddenColumnsSaving
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - optional, additional parameters added to cookie
 * @example //minimal parameters set
...
/**
 *
 * @id dhtmlXGridObject.enableAutoSaving
 * @class dhtmlXGridObject
 * @method enableAutoSaving
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.enableAutoSizeSaving
 * @class dhtmlXGridObject
 * @method enableAutoSizeSaving
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.enableAutoWidth
 * @class dhtmlXGridObject
 * @method enableAutoWidth
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode  - truse/false - enable / disable
 * @param {String} max_limit max_limit  - max allowed width, not limited by default
 * @param {String} min_limit min_limit  - min allowed width, not limited by default
 ...
 * @id dhtmlXGridObject.enableBlockSelection
 * @class dhtmlXGridObject
 * @method enableBlockSelection
 * @memberOf dhtmlXGridObject
 * @param {Boolean} [mode] mode - {true|false} - enable/disable block selection (optional, true by default)
 ...
 * @id dhtmlXGridObject.enableCSVAutoID
 * @class dhtmlXGridObject
 * @method enableCSVAutoID
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXGridObject.enableCSVHeader
 * @class dhtmlXGridObject
 * @method enableCSVHeader
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXGridObject.enableCellIds
 * @class dhtmlXGridObject
 * @method enableCellIds
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false} - enable/disable unique id for cells
 ...
 * @id dhtmlXGridObject.enableColSpan
 * @class dhtmlXGridObject
 * @method enableColSpan
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false} enable/disable colspan support
 ...
 * @id dhtmlXGridObject.enableColumnMove
 * @class dhtmlXGridObject
 * @method enableColumnMove
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 * @param {Boolean} [columns] columns - list of true/false values, optional
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.enableContextMenu
 * @class dhtmlXGridObject
 * @method enableContextMenu
 * @memberOf dhtmlXGridObject
 * @param {Object} menu dhtmlxMenu object, if null - context menu will be disabled
 ...
 * @id dhtmlXGridObject.enableDistributedParsing
 * @class dhtmlXGridObject
 * @method enableDistributedParsing
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 * @param {String} [count] count - count of nodes parsed by one step (optional, 10 by default)
 * @param {String} [time] time - time between parsing counts in milli seconds (optional, 250 by default)
 ...
 * @id dhtmlXGridObject.enableDragAndDrop
 * @class dhtmlXGridObject
 * @method enableDragAndDrop
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - enabled/disabled [ can be true/false/temporary_disabled - last value mean that tree can be D-n-D can be switched to true later ]
 ...
 * @id dhtmlXGridObject.enableDragOrder
 * @class dhtmlXGridObject
 * @method enableDragOrder
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false to enable/disable mode
 ...
 * @id dhtmlXGridObject.enableEditEvents
 * @class dhtmlXGridObject
 * @method enableEditEvents
 * @memberOf dhtmlXGridObject
 * @param {Boolean} click click - {true|false} - enable/disable editing by single click
 * @param {Boolean} dblclick dblclick - {true|false} - enable/disable editing by double click
 * @param {Boolean} f2Key f2Key - {true|false} - enable/disable editing by pressing F2 key
 ...
 * @id dhtmlXGridObject.enableEditTabOnly
 * @class dhtmlXGridObject
 * @method enableEditTabOnly
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXGridObject.enableHeaderImages
 * @class dhtmlXGridObject
 * @method enableHeaderImages
 * @memberOf dhtmlXGridObject
 * @param {String} fl fl - true to treat column header values as image names
...
/**
 *
 * @id dhtmlXGridObject.enableHeaderMenu
 * @class dhtmlXGridObject
 * @method enableHeaderMenu
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.enableKeyboardSupport
 * @class dhtmlXGridObject
 * @method enableKeyboardSupport
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false (true by default)
 ...
 * @id dhtmlXGridObject.enableLightMouseNavigation
 * @class dhtmlXGridObject
 * @method enableLightMouseNavigation
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
...
/**
 *
 * @id dhtmlXGridObject.enableMarkedCells
 * @class dhtmlXGridObject
 * @method enableMarkedCells
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false} - enable/disable marked cells support
 ...
 * @id dhtmlXGridObject.enableMathEditing
 * @class dhtmlXGridObject
 * @method enableMathEditing
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false} - enable/disable editing of math cells
 ...
 * @id dhtmlXGridObject.enableMathSerialization
 * @class dhtmlXGridObject
 * @method enableMathSerialization
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false} enable/disable math formulas serialization
 ...
 * @id dhtmlXGridObject.enableMercyDrag
 * @class dhtmlXGridObject
 * @method enableMercyDrag
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true/false} enable/disable mode
 ...
 * @id dhtmlXGridObject.enableMultiline
 * @class dhtmlXGridObject
 * @method enableMultiline
 * @memberOf dhtmlXGridObject
 * @param {Boolean} state state - {true|false} enable/disable multi line mode.
 ...
 * @id dhtmlXGridObject.enableMultiselect
 * @class dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.enableOrderSaving
 * @class dhtmlXGridObject
 * @method enableOrderSaving
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.enablePaging
 * @class dhtmlXGridObject
 * @method enablePaging
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true|false - enable|disable mode
 * @param {String} pageSize pageSize - count of rows per page
 * @param {String} pagesInGrp pagesInGrp - count of visible page selectors
 * @param {String} pagingControlsContainer pagingControlsContainer - ID or container which will be used for showing paging controls
 * @param {Boolean} showRecInfo showRecInfo - true|false - enable|disable showing of additional info about paging state
 * @param {String} pagingStateContainer pagingStateContainer - ID or container which will be used for showing paging state
 ...
 * @id dhtmlXGridObject.enablePreRendering
 * @class dhtmlXGridObject
 * @method enablePreRendering
 * @memberOf dhtmlXGridObject
 * @param {String} buffer buffer - count of rows to pre-render
 ...
 * @id dhtmlXGridObject.enableResizing
 * @class dhtmlXGridObject
 * @method enableResizing
 * @memberOf dhtmlXGridObject
 * @param {Boolean} list list - list of true/false values separated with default delimiter (comma), resizing enabled for all columns by default
 ...
 * @id dhtmlXGridObject.enableRowsHover
 * @class dhtmlXGridObject
 * @method enableRowsHover
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 * @param {String} cssClass cssClass - css class for hovering row
 * @example <style>
 *     .hover {
...
/**
 *
 * @id dhtmlXGridObject.enableRowspan
 * @class dhtmlXGridObject
 * @method enableRowspan
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.enableSmartRendering
 * @class dhtmlXGridObject
 * @method enableSmartRendering
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true|false - enable|disable mode
 * @param {String} [buffer] buffer - has sense only in dynamic loading mode, count of rows requrested from server by single operation, optional
 ...
 * @id dhtmlXGridObject.enableSortingSaving
 * @class dhtmlXGridObject
 * @method enableSortingSaving
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.enableStableSorting
 * @class dhtmlXGridObject
 * @method enableStableSorting
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXGridObject.enableTooltips
 * @class dhtmlXGridObject
 * @method enableTooltips
 * @memberOf dhtmlXGridObject
 * @param {Boolean} list list - list of true/false values, tooltips enabled for all columns by default
...
/**
 *
 * @id dhtmlXGridObject.enableUndoRedo
 * @class dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.expandAllGroups
 * @class dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.expandGroup
 * @class dhtmlXGridObject
 * @method expandGroup
 * @memberOf dhtmlXGridObject
 * @param {String} val val - value to use to determine what group to expand (in other words this should be value common for all of them)
...
/**
 * filter grid by mask
 * @id dhtmlXGridObject.filterBy
 * @class dhtmlXGridObject
 * @method filterBy
 * @memberOf dhtmlXGridObject
 * @param {Number} column column - {number} zero based index of column.
 * @param {String} value value - {string} value by which the column will be filtered.
 * @param {Boolean} preserve preserve - {true|false} filter current or initial state (false by default)
...
/**
 *
 * @id dhtmlXGridObject.filterByAll
 * @class dhtmlXGridObject
 * @method filterByAll
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.findCell
 * @class dhtmlXGridObject
 * @method findCell
 * @memberOf dhtmlXGridObject
 * @param {String} value value - {string} search string
 * @param {Number} [c_ind] c_ind - {number} index of column to search in (optional, if not specified, then search everywhere)
 * @param {Boolean} [first] first - {true|fase} find only first occurence (optional, false by default)
 ...
 * @id dhtmlXGridObject.forEachCell
 * @class dhtmlXGridObject
 * @method forEachCell
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - id of row where cell must be itterated
 * @param {Object} custom_code custom_code - function which get eXcell object as incomming argument
 ...
 * @id dhtmlXGridObject.forEachRow
 * @class dhtmlXGridObject
 * @method forEachRow
 * @memberOf dhtmlXGridObject
 * @param {String} custom_code custom_code - function which get row id as incomming argument
 ...
 * @id dhtmlXGridObject.forceLabelSelection
 * @class dhtmlXGridObject
 * @method forceLabelSelection
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXGridObject.getAllRowIds
 * @class dhtmlXGridObject
 * @method getAllRowIds
 * @memberOf dhtmlXGridObject
 * @param {String} [separator] separator - delimiter to use in list (optional, comma by default)
 ...
 * @id dhtmlXGridObject.getChangedRows
 * @class dhtmlXGridObject
 * @method getChangedRows
 * @memberOf dhtmlXGridObject
 * @param {Boolean} and_added and_added - {true|false} if true- include ids of added rows
 ...
 * @id dhtmlXGridObject.getCheckedRows
 * @class dhtmlXGridObject
 * @method getCheckedRows
 * @memberOf dhtmlXGridObject
 * @param {Number} col_ind col_ind - column index
 ...
 * @id dhtmlXGridObject.getColIndexById
 * @class dhtmlXGridObject
 * @method getColIndexById
 * @memberOf dhtmlXGridObject
 * @param {String} id id - column id
 ...
 * @id dhtmlXGridObject.getColLabel
 * @class dhtmlXGridObject
 * @method getColLabel
 * @memberOf dhtmlXGridObject
 * @param {Number} cin cin - column index
 * @param {Number} [ind] ind -  header row index (optional, 0 by default, has sence only with multi line header)
 ...
 * @id dhtmlXGridObject.getColType
 * @class dhtmlXGridObject
 * @method getColType
 * @memberOf dhtmlXGridObject
 * @param {Number} cInd cInd - column index
 ...
 * @id dhtmlXGridObject.getColTypeById
 * @class dhtmlXGridObject
 * @method getColTypeById
 * @memberOf dhtmlXGridObject
 * @param {String} cID cID - column id
 ...
 * @id dhtmlXGridObject.getColWidth
 * @class dhtmlXGridObject
 * @method getColWidth
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - column index
 ...
 * @id dhtmlXGridObject.getColumnId
 * @class dhtmlXGridObject
 * @method getColumnId
 * @memberOf dhtmlXGridObject
 * @param {Number} cin cin - column index
...
/**
 *
 * @id dhtmlXGridObject.getColumnsNum
 * @class dhtmlXGridObject
 * @method getColumnsNum
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.getCombo
 * @class dhtmlXGridObject
 * @method getCombo
 * @memberOf dhtmlXGridObject
 * @param {Number} col_ind col_ind - index of the column to get combo object for. Note column must have &#039;co&#039;, &#039;coro&#039; or &#039;combo&#039; type
 ...
 * @id dhtmlXGridObject.getCustomCombo
 * @class dhtmlXGridObject
 * @method getCustomCombo
 * @memberOf dhtmlXGridObject
 * @param {String} id id - row id
 * @param {Number} ind ind  - column index. Note cell must have &#039;co&#039;, &#039;coro&#039; or &#039;combo&#039; type
 ...
 * @id dhtmlXGridObject.getFilterElement
 * @class dhtmlXGridObject
 * @method getFilterElement
 * @memberOf dhtmlXGridObject
 * @param {Number} index index - index of column
 ...
 * @id dhtmlXGridObject.getFooterLabel
 * @class dhtmlXGridObject
 * @method getFooterLabel
 * @memberOf dhtmlXGridObject
 * @param {Number} cin cin - column index
 * @param {Number} [ind] ind - footer row index (optional, 0 by default)
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.getRowAttribute
 * @class dhtmlXGridObject
 * @method getRowAttribute
 * @memberOf dhtmlXGridObject
 * @param {String} rId rId - row id
 * @param {String} name name - attribute name
 ...
 * @id dhtmlXGridObject.getRowId
 * @class dhtmlXGridObject
 * @method getRowId
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - row index
 ...
 * @id dhtmlXGridObject.getRowIndex
 * @class dhtmlXGridObject
 * @method getRowIndex
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
...
/**
 *
 * @id dhtmlXGridObject.getRowsNum
 * @class dhtmlXGridObject
 * @method getRowsNum
 * @memberOf dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.getSelectedCellIndex
 * @class dhtmlXGridObject
 * @method getSelectedCellIndex
 * @memberOf dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.getSelectedRowId
 * @class dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.getSortingState
 * @class dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.getStateOfView
 * @class dhtmlXGridObject
 * @method getStateOfView
 * @memberOf dhtmlXGridObject
...
/**
 * gets user Data
 * @id dhtmlXGridObject.getUserData
 * @class dhtmlXGridObject
 * @method getUserData
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id -  row id. if empty then user data is for grid (not row)
 * @param {String} name name -  name of user data
...
/**
 *
 * @id dhtmlXGridObject.gridFromClipboard
 * @class dhtmlXGridObject
 * @method gridFromClipboard
 * @memberOf dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.gridToClipboard
 * @class dhtmlXGridObject
 * @method gridToClipboard
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.gridToGrid
 * @class dhtmlXGridObject
 * @method gridToGrid
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - id of draged row
 * @param {Object} sgrid sgrid - source grid object
 * @param {Object} tgrid tgrid - target grid object
 ...
 * @id dhtmlXGridObject.gridToTreeElement
 * @class dhtmlXGridObject
 * @method gridToTreeElement
 * @memberOf dhtmlXGridObject
 * @param {Object} treeObj treeObj - object of tree
 * @param {String} treeNodeId treeNodeId - id of node created in tree
 * @param {String} gridRowId gridRowId - id of grid row
 ...
 * @id dhtmlXGridObject.groupBy
 * @class dhtmlXGridObject
 * @method groupBy
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - {number} column index to group by
 * @param {String} [mask] mask - {array} optional, array, each value of which is mapped to the related column. The possible values are:
 ...
 * @id dhtmlXGridObject.insertColumn
 * @class dhtmlXGridObject
 * @method insertColumn
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - index of column
 * @param {String} [header] header - header content of column (optional, blank by default)
 * @param {String} [type] type - type of column (optional, &#039;ed&#039; by default)
 * @param {String} [width] width - width of column (optional, &#039;100&#039; by default)
 * @param {String} [sort] sort - sort type of column (optional, &#039;na&#039; by default)
 * @param {String} [align] align - align of column (optional, &#039;left&#039; by default)
 * @param {String} [valign] valign - vertical align of column (optional)
 * @param {String} [reserved] reserved - not used for now
 * @param {String} [columnColor] columnColor - background color of column (optional)
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.isColumnHidden
 * @class dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.loadCSVFile
 * @class dhtmlXGridObject
 * @method loadCSVFile
 * @memberOf dhtmlXGridObject
 * @param {String} path path - path to file
 * @param {String} afterCall afterCall - function which will be called after xml loading
 ...
 * @id dhtmlXGridObject.loadCSVString
 * @class dhtmlXGridObject
 * @method loadCSVString
 * @memberOf dhtmlXGridObject
 * @param {String} str str - CSV  string
 ...
 * @id dhtmlXGridObject.loadHiddenColumnsFromCookie
 * @class dhtmlXGridObject
 * @method loadHiddenColumnsFromCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional,cookie name
 ...
 * @id dhtmlXGridObject.loadOpenStates
 * @class dhtmlXGridObject
 * @method loadOpenStates
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @example mygrid.load("grid.xml",function(){
 *       //minimal parameters set
...
/**
 * load sorting order from cookie
 * @id dhtmlXGridObject.loadOrderFromCookie
 * @class dhtmlXGridObject
 * @method loadOrderFromCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional,cookie name
 * @example mygrid.load("grid.xml",function(){
 *       //minimal parameters set
 ...
 * @id dhtmlXGridObject.loadSizeFromCookie
 * @class dhtmlXGridObject
 * @method loadSizeFromCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional,cookie name
 * @example mygrid.load("grid.xml",function(){
 *       //minimal parameters set
...
/**
 * load sorting order from cookie
 * @id dhtmlXGridObject.loadSortingFromCookie
 * @class dhtmlXGridObject
 * @method loadSortingFromCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional,cookie name
 * @example mygrid.load("grid.xml",function(){
 *       //minimal parameters set
 ...
 * @id dhtmlXGridObject.lockRow
 * @class dhtmlXGridObject
 * @method lockRow
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - id of row
 * @param {Boolean} mode mode - true/false - lock/unlock
 ...
 * @id dhtmlXGridObject.makeFilter
 * @class dhtmlXGridObject
 * @method makeFilter
 * @memberOf dhtmlXGridObject
 * @param {Object} id id - {string|object} input id or input html object
 * @param {Number} column column - {number} index of column
 * @param {Boolean} [preserve] preserve - {true|false} filter current state or initial one (optional, false by default)
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.makePivot
 * @class dhtmlXGridObject
 * @method makePivot
 * @memberOf dhtmlXGridObject
 * @param {String} [cont] cont - html container in which pivot rendered (optional, by default pivot will be rendered over existing grid)
 * @param {String} [details] details - collection of settings:
 * @example //minimal parameters set
 *    mygrid.makePivot();
 ...
 * @id dhtmlXGridObject.makeSearch
 * @class dhtmlXGridObject
 * @method makeSearch
 * @memberOf dhtmlXGridObject
 * @param {Object} id id - {string|object} input id or input html object
 ...
 * @id dhtmlXGridObject.mark
 * @class dhtmlXGridObject
 * @method mark
 * @memberOf dhtmlXGridObject
 * @param {Number} rid r - row object or row index
 * @param {Number} cindex cInd - cell index
 * @param {Boolean} fl state - true or false
 * @example //mark cell
 ...
 * @id dhtmlXGridObject.moveColumn
 * @class dhtmlXGridObject
 * @method moveColumn
 * @memberOf dhtmlXGridObject
 * @param {Number} oldInd oldInd - current index of column
 * @param {Number} newInd newInd - index of column, before each moved one will be inserted
...
/**
 * move row
 * @id dhtmlXGridObject.moveRow
 * @class dhtmlXGridObject
 * @method moveRow
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - source row Id
 * @param {String} mode mode - moving mode (up,down,row_sibling)
 * @param {String} [targetId] targetId - target row  in row_sibling mode (optional)
 * @param {String} [targetGrid] targetGrid - used for moving between grids (optional)
 * @example //move row up
 ...
 * @id dhtmlXGridObject.moveRowDown
 * @class dhtmlXGridObject
 * @method moveRowDown
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id -  row id
...
/**
 * move row
 * @id dhtmlXGridObject.moveRowTo
 * @class dhtmlXGridObject
 * @method moveRowTo
 * @memberOf dhtmlXGridObject
 * @param {String} srowId srowId - source row Id
 * @param {String} trowId trowId - target row Id
 * @param {String} mode mode - "move" or "copy"
 * @param {String} [dropmode] dropmode - "sibling" or "child" (optional, "sibling" by default)
 * @param {Object} [sourceGrid] sourceGrid - source grid object, used for moving between grids (optional, current grid by default)
 * @param {Object} [targetGrid] targetGrid - target grid object, used for moving between grids (optional, current grid by default)
 ...
 * @id dhtmlXGridObject.parse
 * @class dhtmlXGridObject
 * @method parse
 * @memberOf dhtmlXGridObject
 * @param {Object} data data - string or object
 * @param {String} [type] type - data type (xml,json,jsarray,csv), optional, data threated as xml by default
...
/**
 *
 * @id dhtmlXGridObject.pasteBlockFromClipboard
 * @class dhtmlXGridObject
 * @method pasteBlockFromClipboard
 * @memberOf dhtmlXGridObject
 * @example mygrid.attachEvent("onKeyPress",onKeyPressed);
 * ...
 * function onKeyPressed(code,ctrl,shift){
...
/**
 *
 * @id dhtmlXGridObject.preventIECaching
 * @class dhtmlXGridObject
 * @method preventIECaching
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode - enable/disable random values in URLs (disabled by default)
 ...
 * @id dhtmlXGridObject.printView
 * @class dhtmlXGridObject
 * @method printView
 * @memberOf dhtmlXGridObject
 * @param {String} before before - {string} html which will be placed before printed grid
 * @param {String} after after - {string} html which will be placed after printed grid
 * @example //minimal parameters set
 *    mygrid.printView();
 *    //maximal parameters set
...
/**
 *
 * @id dhtmlXGridObject.refreshFilters
 * @class dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.rowToClipboard
 * @class dhtmlXGridObject
 * @method rowToClipboard
 * @memberOf dhtmlXGridObject
 * @param {String} [rowId] rowId - id of row (optional, use selected row by default)
 ...
 * @id dhtmlXGridObject.rowToDragElement
 * @class dhtmlXGridObject
 * @method rowToDragElement
 * @memberOf dhtmlXGridObject
 * @param {String} id id - id of grid row
 ...
 * @id dhtmlXGridObject.saveHiddenColumnsToCookie
 * @class dhtmlXGridObject
 * @method saveHiddenColumnsToCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 ...
 * @id dhtmlXGridObject.saveOpenStates
 * @class dhtmlXGridObject
 * @method saveOpenStates
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 ...
 * @id dhtmlXGridObject.saveOrderToCookie
 * @class dhtmlXGridObject
 * @method saveOrderToCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 ...
 * @id dhtmlXGridObject.saveSizeToCookie
 * @class dhtmlXGridObject
 * @method saveSizeToCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 ...
 * @id dhtmlXGridObject.saveSortingToCookie
 * @class dhtmlXGridObject
 * @method saveSortingToCookie
 * @memberOf dhtmlXGridObject
 * @param {String} [name] name - optional, cookie name
 * @param {String} [cookie_param] cookie_param - additional parameters added to cookie
 ...
 * @id dhtmlXGridObject.selectCell
 * @class dhtmlXGridObject
 * @method selectCell
 * @memberOf dhtmlXGridObject
 * @param {Number} r r - row object or row index
 * @param {Number} cInd cInd - cell index
 * @param {Boolean} [fl] [fl] - true if to call onRowSelect function (optional, false by default)
 * @param {Boolean} [preserve] preserve - preserve previously selected rows true/false (optional, false by default). Multi select mode should be enabled.
 * @param {String} [edit] edit - switch selected cell to edit mode (optional, false by default)
 * @param {Boolean} [show] show - true/false - scroll row to view (optional, true by default)
 ...
 * @id dhtmlXGridObject.selectRow
 * @class dhtmlXGridObject
 * @method selectRow
 * @memberOf dhtmlXGridObject
 * @param {Number} rIndex rIndex - row index or row object
 * @param {Boolean} [fl] fl - if true, then call function on select (optional, false by default)
 * @param {Boolean} [preserve] preserve - preserve previously selected rows true/false (false by default). Multi select mode should be enabled.
 * @param {Boolean} [show] show - true/false - scroll row to view, true by defaul
...
/**
 * selects row by ID
 * @id dhtmlXGridObject.selectRowById
 * @class dhtmlXGridObject
 * @method selectRowById
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 * @param {Boolean} [preserve] preserve - {true|false} preserve previously selected (optional, false by default). Multi select mode should be enabled.
 * @param {Boolean} [show] show - true/false - scroll row to view (optional, true by default)
 * @param {Boolean} [call] call - true if to call onRowSelect function (optional, false by default)
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.serializeToCSV
 * @class dhtmlXGridObject
 * @method serializeToCSV
 * @memberOf dhtmlXGridObject
 * @param {Boolean} [textmode] text only - {true|false} optional, force serialization of text values (skip HTML elements), false by default
 ...
 * @id dhtmlXGridObject.setAwaitedRowHeight
 * @class dhtmlXGridObject
 * @method setAwaitedRowHeight
 * @memberOf dhtmlXGridObject
 * @param {String} height {int} height - awaited height of row
 ...
 * @id dhtmlXGridObject.setCSVDelimiter
 * @class dhtmlXGridObject
 * @method setCSVDelimiter
 * @memberOf dhtmlXGridObject
 * @param {String} str str - delimer used in CSV operations, comma by default (only single char delimeters allowed)
 ...
 * @id dhtmlXGridObject.setCellExcellType
 * @class dhtmlXGridObject
 * @method setCellExcellType
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - row ID
 * @param {Number} cellIndex cellIndex - cell index
 * @param {String} type type - type of excell (code like "ed", "txt", "ch" etc.)
...
/**
 * sets style to cell
 * @id dhtmlXGridObject.setCellTextStyle
 * @class dhtmlXGridObject
 * @method setCellTextStyle
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 * @param {Number} ind ind - cell index
 * @param {String} styleString styleString - style string in common format (ex: "color:red;border:1px solid gray;")
 ...
 * @id dhtmlXGridObject.setCheckedRows
 * @class dhtmlXGridObject
 * @method setCheckedRows
 * @memberOf dhtmlXGridObject
 * @param {Number} cInd col_ind - column index
 * @param {String} v v - value, 0 - not checked, any other value - checked
 ...
 * @id dhtmlXGridObject.setColAlign
 * @class dhtmlXGridObject
 * @method setColAlign
 * @memberOf dhtmlXGridObject
 * @param {String} alStr alStr - list of align values (possible values are: right,left,center,justify). Default delimiter is ","
 ...
 * @id dhtmlXGridObject.setColLabel
 * @class dhtmlXGridObject
 * @method setColLabel
 * @memberOf dhtmlXGridObject
 * @param {Number} col col - header column index
 * @param {String} label label - new label for the cpecified header&#039;s column. Can contai img:[imageUrl]Text Label
 * @param {Number} ind ind - header row index (default is 1)
 ...
 * @id dhtmlXGridObject.setColSorting
 * @class dhtmlXGridObject
 * @method setColSorting
 * @memberOf dhtmlXGridObject
 * @param {String} sortStr sortStr - sort codes list with default delimiter
...
/**
 * set column types
 * @id dhtmlXGridObject.setColTypes
 * @class dhtmlXGridObject
 * @method setColTypes
 * @memberOf dhtmlXGridObject
 * @param {String} typeStr typeStr - type codes list (default delimiter is ",")
 ...
 * @id dhtmlXGridObject.setColVAlign
 * @class dhtmlXGridObject
 * @method setColVAlign
 * @memberOf dhtmlXGridObject
 * @param {String} valStr valStr - vertical align values list for columns (possible values are: baseline,sub,super,top,text-top,middle,bottom,text-bottom)
 ...
 * @id dhtmlXGridObject.setColWidth
 * @class dhtmlXGridObject
 * @method setColWidth
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - column index
 * @param {String} value value - new width value
 ...
 * @id dhtmlXGridObject.setColspan
 * @class dhtmlXGridObject
 * @method setColspan
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 * @param {Number} col_ind col_id - index of column
 * @param {String} colspan colspan - size of colspan
 ...
 * @id dhtmlXGridObject.setColumnColor
 * @class dhtmlXGridObject
 * @method setColumnColor
 * @memberOf dhtmlXGridObject
 * @param {String} clr clr - comma delimited colors list
 ...
 * @id dhtmlXGridObject.setColumnExcellType
 * @class dhtmlXGridObject
 * @method setColumnExcellType
 * @memberOf dhtmlXGridObject
 * @param {Number} colIndex colIndex - column index
 * @param {String} type type - type of excell
...
/**
 * hide/show column
 * @id dhtmlXGridObject.setColumnHidden
 * @class dhtmlXGridObject
 * @method setColumnHidden
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - column index
 * @param {Boolean} state state - true/false - hide/show column
 ...
 * @id dhtmlXGridObject.setColumnId
 * @class dhtmlXGridObject
 * @method setColumnId
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind- index of column
 * @param {String} id id- id of column
 ...
 * @id dhtmlXGridObject.setColumnIds
 * @class dhtmlXGridObject
 * @method setColumnIds
 * @memberOf dhtmlXGridObject
 * @param {String} ids ids - comma delimitered list of ids or empty if to use values set earlier
 ...
 * @id dhtmlXGridObject.setColumnMinWidth
 * @class dhtmlXGridObject
 * @method setColumnMinWidth
 * @memberOf dhtmlXGridObject
 * @param {String} width width - minimum column width, can be set for specified column, or as comma separated list for all columns
 * @param {Number} ind ind - column index
 ...
 * @id dhtmlXGridObject.setColumnsVisibility
 * @class dhtmlXGridObject
 * @method setColumnsVisibility
 * @memberOf dhtmlXGridObject
 * @param {Boolean} list list - list of true/false separated by comma, false - show column, true - hide column
 * @example //hide first column
 ...
 * @id dhtmlXGridObject.setCustomSorting
 * @class dhtmlXGridObject
 * @method setCustomSorting
 * @memberOf dhtmlXGridObject
 * @param {String} func func - function to use for comparison
 * @param {Number} col col - index of column to apply custom sorting to
 ...
 * @id dhtmlXGridObject.setDateFormat
 * @class dhtmlXGridObject
 * @method setDateFormat
 * @memberOf dhtmlXGridObject
 * @param {String} mask mask - date mask, d,m,y will mean day,month,year; for example "%d/%m/%y" - 22/05/1985
 ...
 * @id dhtmlXGridObject.setDelimiter
 * @class dhtmlXGridObject
 * @method setDelimiter
 * @memberOf dhtmlXGridObject
 * @param {String} delim delim - delimiter as string
 ...
 * @id dhtmlXGridObject.setDragBehavior
 * @class dhtmlXGridObject
 * @method setDragBehavior
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode - behavior name
 ...
 * @id dhtmlXGridObject.setDragText
 * @class dhtmlXGridObject
 * @method setDragText
 * @memberOf dhtmlXGridObject
 * @param {String} single single - single form (like "product")
 * @param {String} plural plural - plural form (if omitted, then "s" will be added to single form)
 ...
 * @id dhtmlXGridObject.setEditable
 * @class dhtmlXGridObject
 * @method setEditable
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode - set not editable if FALSE, set editable otherwise
 ...
 * @id dhtmlXGridObject.setExternalTabOrder
 * @class dhtmlXGridObject
 * @method setExternalTabOrder
 * @memberOf dhtmlXGridObject
 * @param {Object} start start - html object or its id - gets focus when tab+shift are pressed in the first cell
 * @param {Object} end end - html object or its id - gets focus when tab is pressed in the last cell
 ...
 * @id dhtmlXGridObject.setFieldName
 * @class dhtmlXGridObject
 * @method setFieldName
 * @memberOf dhtmlXGridObject
 * @param {String} mask GRID_ID - ID of grids container,
 ...
 * @id dhtmlXGridObject.setFooterLabel
 * @class dhtmlXGridObject
 * @method setFooterLabel
 * @memberOf dhtmlXGridObject
 * @param {Number} c col - column index
 * @param {String} label label - new label for the cpecified footer&#039;s column. Can contain img:[imageUrl]Text Label
 * @param {Number} [ind] ind - footer row index (optional, 1 by default)
 ...
 * @id dhtmlXGridObject.setHeader
 * @class dhtmlXGridObject
 * @method setHeader
 * @memberOf dhtmlXGridObject
 * @param {String} hdrStr hdrStr - header string with delimiters
 * @param {String} [splitSign] splitSign - string used as a split marker, optional. Default is "#cspan"
 * @param {String} [styles] styles - array of header styles
 ...
 * @id dhtmlXGridObject.setIconPath
 * @class dhtmlXGridObject
 * @method setIconPath
 * @memberOf dhtmlXGridObject
 * @param {String} path path - url (or relative path) of images folder with closing "/"
 ...
 * @id dhtmlXGridObject.setImagePath
 * @class dhtmlXGridObject
 * @method setImagePath
 * @memberOf dhtmlXGridObject
 * @param {String} path path - url (or relative path) of images folder with closing "/"
 ...
 * @id dhtmlXGridObject.setInitWidths
 * @class dhtmlXGridObject
 * @method setInitWidths
 * @memberOf dhtmlXGridObject
 * @param {String} wp wp - list of column width in pixels
 ...
 * @id dhtmlXGridObject.setInitWidthsP
 * @class dhtmlXGridObject
 * @method setInitWidthsP
 * @memberOf dhtmlXGridObject
 * @param {String} wp wp - list of column width in percents. Sum of the column widths must be equal to 100.
 ...
 * @id dhtmlXGridObject.setMathRound
 * @class dhtmlXGridObject
 * @method setMathRound
 * @memberOf dhtmlXGridObject
 * @param {String} digits digits - set how many digits must be rounded, set 0 for disabling
 ...
 * @id dhtmlXGridObject.setNoHeader
 * @class dhtmlXGridObject
 * @method setNoHeader
 * @memberOf dhtmlXGridObject
 * @param {String} fl fl - true to use no header in the grid
...
/**
 *
 * @id dhtmlXGridObject.setNumberFormat
 * @class dhtmlXGridObject
 * @method setNumberFormat
 * @memberOf dhtmlXGridObject
 * @param {String} mask mask - numeric mask; for example 0,000.00 - 1,234.56
 * @param {Number} cInd cInd - column index
 * @param {String} p_sep p_sep - char used as decimal separator (point by default)
 * @param {String} d_sep d_sep - char used as groups part separator (comma by default)
 ...
 * @id dhtmlXGridObject.setPagingSkin
 * @class dhtmlXGridObject
 * @method setPagingSkin
 * @memberOf dhtmlXGridObject
 * @param {String} name name - skin name (default,toolbar,bricks)
 ...
 * @id dhtmlXGridObject.setPagingTemplates
 * @class dhtmlXGridObject
 * @method setPagingTemplates
 * @memberOf dhtmlXGridObject
 * @param {String} navigation_template navigation_template - template for paging controls zone
 * @param {String} info_template info_template - template for paging state zone
 ...
 * @id dhtmlXGridObject.setPagingWTMode
 * @class dhtmlXGridObject
 * @method setPagingWTMode
 * @memberOf dhtmlXGridObject
 * @param {Boolean} navButtons navButtons - {true|false} enable/disable navigation buttons
 * @param {Boolean} navLabel navLabel - {true|false} enable/disable navigation label
 * @param {Boolean} pageSelect pageSelect - {true|false} enable/disable page selector
 * @param {Boolean} perPageSelect perPageSelect - {true|false} enable/disable rows per  page selector
...
/**
 * sets row attribute
 * @id dhtmlXGridObject.setRowAttribute
 * @class dhtmlXGridObject
 * @method setRowAttribute
 * @memberOf dhtmlXGridObject
 * @param {String} rId rId - row ID
 * @param {String} name name - attribute name
 * @param {String} value value - new attribute&#039;s value
 * @example <?xml version='1.0' encoding='iso-8859-1'?>
 *         <rows>
 *             <row id="unique_rowid" some="data">
 *                     <cell some="data">cell content</cell>
 ...
 * @id dhtmlXGridObject.setRowColor
 * @class dhtmlXGridObject
 * @method setRowColor
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 * @param {String} color color - color value
 ...
 * @id dhtmlXGridObject.setRowExcellType
 * @class dhtmlXGridObject
 * @method setRowExcellType
 * @memberOf dhtmlXGridObject
 * @param {String} rowId rowId - row ID
 * @param {String} type type - type of excell
 ...
 * @id dhtmlXGridObject.setRowHidden
 * @class dhtmlXGridObject
 * @method setRowHidden
 * @memberOf dhtmlXGridObject
 * @param {String} id id - row ID
 * @param {Boolean} state state - true/false - hide/show row
 ...
 * @id dhtmlXGridObject.setRowId
 * @class dhtmlXGridObject
 * @method setRowId
 * @memberOf dhtmlXGridObject
 * @param {Number} ind ind - row index
 * @param {String} row_id row_id - new row id
...
/**
 * sets row text BOLD
 * @id dhtmlXGridObject.setRowTextBold
 * @class dhtmlXGridObject
 * @method setRowTextBold
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 ...
 * @id dhtmlXGridObject.setRowTextNormal
 * @class dhtmlXGridObject
 * @method setRowTextNormal
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
...
/**
 * sets style to row.
 * @id dhtmlXGridObject.setRowTextStyle
 * @class dhtmlXGridObject
 * @method setRowTextStyle
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id - row id
 * @param {String} styleString styleString - style string in common format (exmpl: "color:red;border:1px solid gray;")
 ...
 * @id dhtmlXGridObject.setRowspan
 * @class dhtmlXGridObject
 * @method setRowspan
 * @memberOf dhtmlXGridObject
 * @param {String} rowID rowID - row Id
 * @param {Number} colInd colInd - column index
 * @param {String} length length - length of rowspan
 ...
 * @id dhtmlXGridObject.setSerializableColumns
 * @class dhtmlXGridObject
 * @method setSerializableColumns
 * @memberOf dhtmlXGridObject
 * @param {Boolean} list list - list of true/false values separated by comma, if list empty then all fields will be serialized
...
/**
 *
 * @id dhtmlXGridObject.setSerializationLevel
 * @class dhtmlXGridObject
 * @method setSerializationLevel
 * @memberOf dhtmlXGridObject
 * @param {String} userData userData - enable/disable user data serialization
 * @param {String} selectedAttr selectedAttr -  include "selected" row&#039;s attribute in result XML
 * @param {String} config config - serialize grid configuration (only information about grid structure)
 * @param {String} changedAttr changedAttr - include "changed" cell&#039;s attribute in result XML
 * @param {String} onlyChanged onlyChanged - include only changed  rows in result XML
 * @param {String} asCDATA asCDATA - output cell values as CDATA sections (prevent invalid XML)
 ...
 * @id dhtmlXGridObject.setSkin
 * @class dhtmlXGridObject
 * @method setSkin
 * @memberOf dhtmlXGridObject
 * @param {String} name name - style name
 ...
 * @id dhtmlXGridObject.setSortImgState
 * @class dhtmlXGridObject
 * @method setSortImgState
 * @memberOf dhtmlXGridObject
 * @param {Boolean} state state - true/false - show/hide image
 * @param {Number} ind ind - index of column
 * @param {String} [order] order - asc/desc - type of image (optional, "asc" by default)
 * @param {Number} [row] row - one based index of header row (used in multirow headers, top row by default)
 * @example //minimal parameters set
 ...
 * @id dhtmlXGridObject.setStyle
 * @class dhtmlXGridObject
 * @method setStyle
 * @memberOf dhtmlXGridObject
 * @param {String} ss_header ss_header - style def. expression for header
 * @param {String} ss_grid ss_grid - style def. expression for grid cells
 * @param {String} ss_selCell ss_selCell - style def. expression for selected cell
 * @param {String} ss_selRow ss_selRow - style def. expression for selected Row
 ...
 * @id dhtmlXGridObject.setTabOrder
 * @class dhtmlXGridObject
 * @method setTabOrder
 * @memberOf dhtmlXGridObject
 * @param {Number} order order - list of tab indexes (default delimiter is ",")
 ...
 * @id dhtmlXGridObject.setUserData
 * @class dhtmlXGridObject
 * @method setUserData
 * @memberOf dhtmlXGridObject
 * @param {String} row_id row_id -  row id. if empty then user data is set for grid (not row)
 * @param {String} name name -  name of user data block
 * @param {String} value value -  value of user data block
...
/**
 * sort grid
 * @id dhtmlXGridObject.sortRows
 * @class dhtmlXGridObject
 * @method sortRows
 * @memberOf dhtmlXGridObject
 * @param {Number} col col - index of column, by which grid need to be sorted
 * @param {String} [type] type - sorting type (str,int,date), optional, by default sorting type taken from column setting
 * @param {String} [order] order - sorting order (asc,des), optional, by default sorting order based on previous sorting operation
...
/**
 *
 * @id dhtmlXGridObject.startFastOperations
 * @class dhtmlXGridObject
 * @method startFastOperations
 * @memberOf dhtmlXGridObject
...
/**
 *
 * @id dhtmlXGridObject.stopFastOperations
 * @class dhtmlXGridObject
 * @method stopFastOperations
 * @memberOf dhtmlXGridObject
 * @example mygrid.startFastOperations();
 * �
 *    for (var i=0; i<1000; i++)
...
/**
 *
 * @id dhtmlXGridObject.submitAddedRows
 * @class dhtmlXGridObject
 * @method submitAddedRows
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false}  enable|disable mode
 ...
 * @id dhtmlXGridObject.submitOnlyChanged
 * @class dhtmlXGridObject
 * @method submitOnlyChanged
 * @memberOf dhtmlXGridObject
 * @param {String} mode mode - {boolean}  enable|disable mode
 ...
 * @id dhtmlXGridObject.submitOnlyRowID
 * @class dhtmlXGridObject
 * @method submitOnlyRowID
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false}  enable|disable mode
 ...
 * @id dhtmlXGridObject.submitOnlySelected
 * @class dhtmlXGridObject
 * @method submitOnlySelected
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false}  enable|disable mode
...
/**
 *
 * @id dhtmlXGridObject.submitSerialization
 * @class dhtmlXGridObject
 * @method submitSerialization
 * @memberOf dhtmlXGridObject
 * @param {Boolean} mode mode - {true|false}  enable|disable mode
 ...
 * @id dhtmlXGridObject.treeToGridElement
 * @class dhtmlXGridObject
 * @method treeToGridElement
 * @memberOf dhtmlXGridObject
 * @param {Object} treeObj treeObj - object of tree
 * @param {String} treeNodeId treeNodeId - id of node created in tree
 * @param {String} gridRowId gridRowId - id of grid row
...
/**
 *
 * @id dhtmlXGridObject.uncheckAll
 * @class dhtmlXGridObject
 * @method uncheckAll
 * @memberOf dhtmlXGridObject
 ...
 * @id dhtmlXGridObject.updateCellFromClipboard
 * @class dhtmlXGridObject
 * @method updateCellFromClipboard
 * @memberOf dhtmlXGridObject
 * @param {String} [rowId] rowId - id of row (optional, use selected row by default)
 * @param {Number} [cellInd] cellInd - column index(optional, use selected cell by default)
 * @example <script>
...
/**
 *
 * @id dhtmlXGridObject.updateFromXML
 * @class dhtmlXGridObject
 * @method updateFromXML
 * @memberOf dhtmlXGridObject
 * @param {String} url url - url to the file
 * @param {String} [insert_new] insert_new - insert new items (optional, true by default)
 * @param {String} [del_missed] del_missed - delete missed rows (optional, false by default)
 * @param {String} [afterCall] afterCall - function, will be executed after refresh completted
 ...
 * @id dhtmlXGridObject.updateRowFromClipboard
 * @class dhtmlXGridObject
 * @method updateRowFromClipboard
 * @memberOf dhtmlXGridObject
 * @param {String} [rowId] rowId - id of row (optional, use selected row by default)
 * @example //minimal parameters set
...
/**
 *
 * dhtmlXTreeObject object class.
 * @id dhtmlXTreeObject
 * @class dhtmlXTreeObject
 * @constructor
 ...
 * @class dhtmlXTreeObject
 * @method assignKeys
 * @memberOf dhtmlXTreeObject
 * @param {String} keys keys - configuration array, please check pro_key_nav.html in samples for more details
 * @example
 */
...
/**
 * adds any user-defined handler to available events
 * @id dhtmlXTreeObject.attachEvent
 * @class dhtmlXTreeObject
 * @method attachEvent
 * @memberOf dhtmlXTreeObject
 * @param {String} evName evName - name of the event;
...
/**
 * change item id
 * @id dhtmlXTreeObject.changeItemId
 * @class dhtmlXTreeObject
 * @method changeItemId
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - old node id
 * @param {String} newItemId newItemId - new node id
 * @example
 */
 ...
 * @id dhtmlXTreeObject.clearSelection
 * @class dhtmlXTreeObject
 * @method clearSelection
 * @memberOf dhtmlXTreeObject
 * @param {String} [itemId] itemId - used in multi selection tree (optional)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.closeAllItems
 * @class dhtmlXTreeObject
 * @method closeAllItems
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @example
 */
...
/**
 * collapse node
 * @id dhtmlXTreeObject.closeItem
 * @class dhtmlXTreeObject
 * @method closeItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @example
 */
 ...
 * @id dhtmlXTreeObject.defineItemForm
 * @class dhtmlXTreeObject
 * @method defineItemForm
 * @memberOf dhtmlXTreeObject
 * @param {String} formId formId - id of form node
 * @example
 */
 ...
 * @id dhtmlXTreeObject.deleteChildItems
 * @class dhtmlXTreeObject
...
/**
 * delete node
 * @id dhtmlXTreeObject.deleteItem
 * @class dhtmlXTreeObject
 * @method deleteItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @param {String} selectParent selectParent - If true parent of deleted item get selection, else no selected items leaving in tree.
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.destructor
 * @class dhtmlXTreeObject
 * @method destructor
 * @memberOf dhtmlXTreeObject
 * @example
...
/**
 * removes an event handler
 * @id dhtmlXTreeObject.detachEvent
 * @class dhtmlXTreeObject
 * @method detachEvent
 * @memberOf dhtmlXTreeObject
 * @param {String} id id - event id
...
/**
 * disable checkbox
 * @id dhtmlXTreeObject.disableCheckbox
 * @class dhtmlXTreeObject
 * @method disableCheckbox
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - Id of tree item
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.doPaste
 * @class dhtmlXTreeObject
 * @method doPaste
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of new parent node
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableActiveImages
 * @class dhtmlXTreeObject
 * @method enableActiveImages
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableAutoSavingSelected
 * @class dhtmlXTreeObject
 * @method enableAutoSavingSelected
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableAutoTooltips
 * @class dhtmlXTreeObject
 * @method enableAutoTooltips
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableCheckBoxes
 * @class dhtmlXTreeObject
 * @method enableCheckBoxes
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @param {String} hidden hidden - if set to true, checkboxes not rendered but can be shown by showItemCheckbox
 * @example
 */
...
/**
 * enable context menu
 * @id dhtmlXTreeObject.enableContextMenu
 * @class dhtmlXTreeObject
 * @method enableContextMenu
 * @memberOf dhtmlXTreeObject
 * @param {Object} menu menu - dhtmlXMenu object
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableDistributedParsing
 * @class dhtmlXTreeObject
 * @method enableDistributedParsing
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @param {String} [count] count - critical count to start distibuting (optional)
 * @param {String} [delay] delay - delay between distributed calls, ms (optional)
 * @example
 */
...
/**
 * enable/disable drag-and-drop
 * @id dhtmlXTreeObject.enableDragAndDrop
 * @class dhtmlXTreeObject
 * @method enableDragAndDrop
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - enabled/disabled [ can be true/false/temporary_disabled - last value mean that tree can be D-n-D can be switched to true later ]
 * @param {String} rmode rmode - enabled/disabled drag and drop on super root
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableDragAndDropScrolling
 * @class dhtmlXTreeObject
 * @method enableDragAndDropScrolling
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - enabled/disabled
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableHighlighting
 * @class dhtmlXTreeObject
 * @method enableHighlighting
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.enableIEImageFix
 * @class dhtmlXTreeObject
 * @method enableIEImageFix
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false - enable/disable fix
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableImageDrag
 * @class dhtmlXTreeObject
 * @method enableImageDrag
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableItemEditor
 * @class dhtmlXTreeObject
 * @method enableItemEditor
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableKeySearch
 * @class dhtmlXTreeObject
 * @method enableKeySearch
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableKeyboardNavigation
 * @class dhtmlXTreeObject
 * @method enableKeyboardNavigation
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableLoadingItem
 * @class dhtmlXTreeObject
 * @method enableLoadingItem
 * @memberOf dhtmlXTreeObject
 * @param {String} text text - text of temporary item (default is "Loading...")
 * @example
 */
...
/**
 * enable drag without removing (copy instead of move)
 * @id dhtmlXTreeObject.enableMercyDrag
 * @class dhtmlXTreeObject
 * @method enableMercyDrag
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 ...
 * @id dhtmlXTreeObject.enableMultiLineItems
 * @class dhtmlXTreeObject
 * @method enableMultiLineItems
 * @memberOf dhtmlXTreeObject
 * @param {String} width width - text width, if equls zero then use single lines items;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableMultiselection
 * @class dhtmlXTreeObject
 * @method enableMultiselection
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @param {String} strict strict - 1 - on, 0 - off; in strict mode only items on the same level can be selected
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableRadioButtons
 * @class dhtmlXTreeObject
 * @method enableRadioButtons
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} itemId mode - true/false
 * @param {String} [mode] itemId - node for which replacement called (optional)
 * @example
 */
...
/**
 * replace checkboxes with radio buttons
 * @id dhtmlXTreeObject.enableSingleRadioMode
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.enableSmartCheckboxes
 * @class dhtmlXTreeObject
 * @method enableSmartCheckboxes
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.enableSmartRendering
 * @class dhtmlXTreeObject
 * @method enableSmartRendering
 * @memberOf dhtmlXTreeObject
 * @example
...
/**
 *
 * @id dhtmlXTreeObject.enableSmartXMLParsing
 * @class dhtmlXTreeObject
 * @method enableSmartXMLParsing
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableTextSigns
 * @class dhtmlXTreeObject
 * @method enableTextSigns
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableThreeStateCheckboxes
 * @class dhtmlXTreeObject
...
/**
 * enable tree images
 * @id dhtmlXTreeObject.enableTreeImages
 * @class dhtmlXTreeObject
 * @method enableTreeImages
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - 1 - on, 0 - off;
 * @example
 */
 ...
 * @id dhtmlXTreeObject.enableTreeLines
 * @class dhtmlXTreeObject
 * @method enableTreeLines
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - enable/disable tree lines
 * @example
 */
 ...
 * @id dhtmlXTreeObject.findItem
 * @class dhtmlXTreeObject
 * @method findItem
 * @memberOf dhtmlXTreeObject
 * @param {String} searchStr searchStr - search text
 * @param {String} direction direction - 0: top -> bottom; 1: bottom -> top
 * @param {String} top top - 1: start searching from top
 * @example
 */
 ...
 * @id dhtmlXTreeObject.findItemIdByLabel
 * @class dhtmlXTreeObject
 * @method findItemIdByLabel
 * @memberOf dhtmlXTreeObject
 * @param {String} searchStr searchStr - search text
 * @param {String} direction direction - 0: top -> bottom; 1: bottom -> top
 * @param {String} top top - 1: start searching from top
 ...
 * @id dhtmlXTreeObject.focusItem
 * @class dhtmlXTreeObject
 * @method focusItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - item Id
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.getAllChecked
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.getAllCheckedBranches
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.getAllChildless
 * @class dhtmlXTreeObject
 * @method getAllChildless
 * @memberOf dhtmlXTreeObject
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.getAllItemsWithKids
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.getAllPartiallyChecked
 * @class dhtmlXTreeObject
 * @method getAllPartiallyChecked
 * @memberOf dhtmlXTreeObject
 * @example
 */
 ...
 * @id dhtmlXTreeObject.getAllSubItems
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.getAllUnchecked
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.getChildItemIdByIndex
 * @class dhtmlXTreeObject
 * @method getChildItemIdByIndex
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - parent node id
 * @param {Number} index index - index of child node
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.getDistributedParsingState
 * @class dhtmlXTreeObject
 * @method getDistributedParsingState
 * @memberOf dhtmlXTreeObject
 * @example
 */
 ...
 * @id dhtmlXTreeObject.getIndexById
 * @class dhtmlXTreeObject
 * @method getIndexById
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 ...
 * @id dhtmlXTreeObject.getItemColor
 * @class dhtmlXTreeObject
 * @method getItemColor
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 ...
 * @id dhtmlXTreeObject.getItemIdByIndex
 * @class dhtmlXTreeObject
 * @method getItemIdByIndex
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - parent node id
 * @param {Number} index index - index of node, 0 based
 * @example
 */
 ...
 * @id dhtmlXTreeObject.getItemImage
 * @class dhtmlXTreeObject
 * @method getItemImage
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of item
 * @param {Number} imageInd imageInd - index of image ( 0 - leaf, 1 - closed folder, 2 - opened folder)
 * @param {String} fullPath value - value of top offset
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.getItemParsingState
 * @class dhtmlXTreeObject
 * @method getItemParsingState
 * @memberOf dhtmlXTreeObject
 * @example
 */
...
/**
 * return node text
 * @id dhtmlXTreeObject.getItemText
 * @class dhtmlXTreeObject
 * @method getItemText
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
...
/**
 * get item&#039;s tooltip
 * @id dhtmlXTreeObject.getItemTooltip
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.getOpenState
 * @class dhtmlXTreeObject
 * @method getOpenState
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 ...
 * @id dhtmlXTreeObject.getParentId
 * @class dhtmlXTreeObject
 * @method getParentId
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
...
/**
 *
 * @id dhtmlXTreeObject.getSelectedItemId
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.getSelectedItemText
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.getSubItems
 * @class dhtmlXTreeObject
 * @method getSubItems
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 ...
 * @id dhtmlXTreeObject.getUserData
 * @class dhtmlXTreeObject
 * @method getUserData
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - target node id
 * @param {String} name name - key for user data
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.getXMLState
 * @class dhtmlXTreeObject
 * @method getXMLState
 * @memberOf dhtmlXTreeObject
 * @example
 ...
 * @id dhtmlXTreeObject.hasChildren
 * @class dhtmlXTreeObject
 * @method hasChildren
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
...
/**
 * hide item&#039;s form
 * @id dhtmlXTreeObject.hideItemForm
 * @class dhtmlXTreeObject
 * @method hideItemForm
 * @memberOf dhtmlXTreeObject
 * @param {String} itemID itemID -  item id
 ...
 * @id dhtmlXTreeObject.insertNewChild
 * @class dhtmlXTreeObject
 * @method insertNewChild
 * @memberOf dhtmlXTreeObject
 * @param {String} parentId parentId - parent node id
 * @param {String} itemId itemId - new node id
 * @param {String} itemText itemText - new node label
 * @param {String} [itemActionHandler] itemActionHandler - function fired on node select event (optional)
 * @param {String} [image1] image1 - image for node without children; (optional)
 * @param {String} [image2] image2 - image for closed node; (optional)
 * @param {String} [image3] image3 - image for opened node (optional)
 * @param {String} [optionStr] optionStr - options string (optional)
 * @param {String} [children] children - node children flag (for dynamical trees) (optional)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.insertNewNext
 * @class dhtmlXTreeObject
 * @method insertNewNext
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @param {String} newItemId newItemId - new node id
 * @param {String} itemText itemText - new node text
 * @param {String} [itemActionHandler] itemActionHandler - function fired on node select event (optional)
 * @param {String} [image1] image1 - image for node without children; (optional)
 * @param {String} [image2] image2 - image for closed node; (optional)
 * @param {String} [image3] image3 - image for opened node (optional)
 ...
 * @id dhtmlXTreeObject.isItemChecked
 * @class dhtmlXTreeObject
 * @method isItemChecked
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - target node id
 ...
 * @id dhtmlXTreeObject.loadCSV
 * @class dhtmlXTreeObject
 * @method loadCSV
 * @memberOf dhtmlXTreeObject
 * @param {String} file file - link to CSV file
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadCSVString
 * @class dhtmlXTreeObject
 * @method loadCSVString
 * @memberOf dhtmlXTreeObject
 * @param {String} csv csv - csv string
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadJSArray
 * @class dhtmlXTreeObject
 * @method loadJSArray
 * @memberOf dhtmlXTreeObject
 * @param {String} ar ar - js array
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadJSArrayFile
 * @class dhtmlXTreeObject
 * @method loadJSArrayFile
 * @memberOf dhtmlXTreeObject
 * @param {String} file file - link to JSArray file
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadJSON
 * @class dhtmlXTreeObject
 * @method loadJSON
 * @memberOf dhtmlXTreeObject
 * @param {String} file file - link to JSON file
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadJSONObject
 * @class dhtmlXTreeObject
 * @method loadJSONObject
 * @memberOf dhtmlXTreeObject
 * @param {Object} json json - json object
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadOpenStates
 * @class dhtmlXTreeObject
 * @method loadOpenStates
 * @memberOf dhtmlXTreeObject
 * @param {String} [name] name - optional,cookie name
 ...
 * @id dhtmlXTreeObject.loadXML
 * @class dhtmlXTreeObject
 * @method loadXML
 * @memberOf dhtmlXTreeObject
 * @param {String} file file - link to XML file
 * @param {String} afterCall afterCall - function which will be called after xml loading
 * @example
 */
 ...
 * @id dhtmlXTreeObject.loadXMLString
 * @class dhtmlXTreeObject
 * @method loadXMLString
 * @memberOf dhtmlXTreeObject
 * @param {String} xmlString xmlString - XML string
...
/**
 * lock tree
 * @id dhtmlXTreeObject.lockTree
 * @class dhtmlXTreeObject
 * @method lockTree
 * @memberOf dhtmlXTreeObject
 * @param {String} isLock isLock - bool value. True - lock, false - unlock
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.makeAllDraggable
 * @class dhtmlXTreeObject
 * @method makeAllDraggable
 * @memberOf dhtmlXTreeObject
 * @param {String} [func] func - custom drag processor function, optional
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.makeDraggable
 * @class dhtmlXTreeObject
 * @method makeDraggable
 * @memberOf dhtmlXTreeObject
 * @param {Object} obj obj - HTML object, or HTML object ID
 * @param {String} [func] func - custom drag processor function, optional
 * @example
 */
 ...
 * @id dhtmlXTreeObject.moveItem
 * @class dhtmlXTreeObject
 * @method moveItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - item Id
 * @param {String} mode mode - moving mode (left,up,down,item_child,item_sibling,item_sibling_next,up_strict,down_strict)
 * @param {String} targetId targetId - target Node in item_child and item_sibling mode
 * @param {String} [targetTree] targetTree - used for moving between trees (optional)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.openAllItems
 * @class dhtmlXTreeObject
 * @method openAllItems
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 ...
 * @id dhtmlXTreeObject.openAllItemsDynamic
 * @class dhtmlXTreeObject
 * @method openAllItemsDynamic
 * @memberOf dhtmlXTreeObject
 * @param {String} [itemId] itemId - node id, optional
 * @example
 */
 ...
 * @id dhtmlXTreeObject.openItemsDynamic
 * @class dhtmlXTreeObject
 * @method openItemsDynamic
 * @memberOf dhtmlXTreeObject
 * @param {String} list list - list of nodes which will be expanded
 * @param {Boolean} flag flag - true/false - select last node in the list
 ...
 * @id dhtmlXTreeObject.openOnItemAdded
 * @class dhtmlXTreeObject
...
/**
 *
 * @id dhtmlXTreeObject.preventIECaching
 * @class dhtmlXTreeObject
 * @method preventIECaching
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - enable/disable random value ( disabled by default )
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.refreshItem
 * @class dhtmlXTreeObject
 * @method refreshItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node, if not defined tree super root used.
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.refreshItems
 * @class dhtmlXTreeObject
 * @method refreshItems
 * @memberOf dhtmlXTreeObject
 * @param {String} itemIdList itemIdList - list of node identificators
 * @param {String} source source - server side script
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.registerXMLEntity
 * @class dhtmlXTreeObject
 * @method registerXMLEntity
 * @memberOf dhtmlXTreeObject
 * @param {String} rChar rChar - source char
 * @param {String} rEntity rEntity - target entity
 * @example
 */
 ...
 * @id dhtmlXTreeObject.restoreSelectedItem
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.saveOpenStates
 * @class dhtmlXTreeObject
 * @method saveOpenStates
 * @memberOf dhtmlXTreeObject
 * @param {String} [name] name - optional,cookie name
 * @param {String} [cookie_param] cookie_param - additional parametrs added to cookie
 * @example
 */
 ...
 * @id dhtmlXTreeObject.saveSelectedItem
 * @class dhtmlXTreeObject
 ...
 * @id dhtmlXTreeObject.selectItem
 * @class dhtmlXTreeObject
 * @method selectItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @param {String} mode mode - If true, script function for selected node will be called. ( onClick event )
 * @param {String} preserve preserve - preserve earlier selected nodes
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.serializeTree
 * @class dhtmlXTreeObject
 * @method serializeTree
 * @memberOf dhtmlXTreeObject
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.serializeTreeToJSON
 * @class dhtmlXTreeObject
 * @method serializeTreeToJSON
 * @memberOf dhtmlXTreeObject
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setCheck
 * @class dhtmlXTreeObject
 * @method setCheck
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - target node id
 * @param {String} state state - checkbox state (0/1/"unsure")
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setChildCalcHTML
 * @class dhtmlXTreeObject
 * @method setChildCalcHTML
 * @memberOf dhtmlXTreeObject
 * @param {String} htmlA htmlA - postfix ([ - by default)
 * @param {String} htmlB htmlB - postfix (] - by default)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setChildCalcMode
 * @class dhtmlXTreeObject
 * @method setChildCalcMode
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - mode name as string . Possible values: child - children, no recursive; leafs - children without subchildren, no recursive;  ,childrec - children, recursive; leafsrec - children without subchildren, recursive; disabled (disabled by default)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setCustomSortFunction
 * @class dhtmlXTreeObject
 * @method setCustomSortFunction
 * @memberOf dhtmlXTreeObject
 * @param {String} func func - sorting function
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setDataMode
 * @class dhtmlXTreeObject
 * @method setDataMode
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - data mode (json,xml,csv)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setDragBehavior
 * @class dhtmlXTreeObject
 * @method setDragBehavior
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - behavior name (child,sibling,complex)
 * @param {String} select select - select droped node after drag-n-drop, true by default
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setEditStartAction
 * @class dhtmlXTreeObject
 * @method setEditStartAction
 * @memberOf dhtmlXTreeObject
 * @param {Boolean} click_IE click_IE - click on already selected item - true/false [true by default]
 * @param {String} dblclick dblclick - on double click
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setEscapingMode
 * @class dhtmlXTreeObject
 * @method setEscapingMode
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - escaping mode ("utf8" for UTF escaping)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setFormAppearOn
 * @class dhtmlXTreeObject
 * @method setFormAppearOn
 * @memberOf dhtmlXTreeObject
 * @param {String} onClick onClick - form appears on click event
 * @param {String} onDblClick onDblClick - form appears on double click event
 * @param {String} onMouseOver onMouseOver - form appears on mouseover event
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setFormDisappearOn
 * @class dhtmlXTreeObject
 * @method setFormDisappearOn
 * @memberOf dhtmlXTreeObject
 * @param {String} onClick onClick - form disappears on click event
 * @param {String} onDblClick onDblClick - form disappears on double click event
 * @param {String} onMouseOver onMouseOver - form disappears on mouseover event
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setIconPath
 * @class dhtmlXTreeObject
 * @method setIconPath
 * @memberOf dhtmlXTreeObject
 * @param {String} path path - url (or relative path) of images folder with closing "/"
...
/**
 * set size of icons
 * @id dhtmlXTreeObject.setIconSize
 * @class dhtmlXTreeObject
 * @method setIconSize
 * @memberOf dhtmlXTreeObject
 * @param {String} newWidth newWidth - new icon width
 * @param {String} newHeight newHeight - new icon height
 * @param {String} [itemId] itemId - item Id, if skipped set default value for all new icons, optional
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setImageArrays
 * @class dhtmlXTreeObject
 * @method setImageArrays
 * @memberOf dhtmlXTreeObject
 * @param {String} arrayName arrayName - name of array: plus, minus
 * @param {String} image1 image1 - line crossed image
 * @param {String} image2 image2 - image with top line
 * @param {String} image3 image3 - image with bottom line
 * @param {String} image4 image4 - image without line
 * @param {String} image5 image5 - single root image
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setImagePath
 * @class dhtmlXTreeObject
 * @method setImagePath
 * @memberOf dhtmlXTreeObject
 * @param {String} newPath newPath - path to images directory (related to the page with tree or absolute http url)
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setItemCloseable
 * @class dhtmlXTreeObject
 * @method setItemCloseable
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @param {String} flag flag -  if 0 - node can&#039;t be closed, else node can be closed
 * @example
 */
...
/**
 * set node text color
 * @id dhtmlXTreeObject.setItemColor
 * @class dhtmlXTreeObject
 * @method setItemColor
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @param {String} defaultColor defaultColor - node color
 * @param {String} selectedColor selectedColor - selected node color
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setItemContextMenu
 * @class dhtmlXTreeObject
 * @method setItemContextMenu
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @param {Object} cMenu cMenu - context menu object
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setItemImage
 * @class dhtmlXTreeObject
 * @method setItemImage
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @param {String} image1 image1 - node without children icon or closed node icon (if image2 specified)
 * @param {String} [image2] image2 - open node icon (optional)
 * @example
 */
...
/**
 * set item images
 * @id dhtmlXTreeObject.setItemImage2
 * @class dhtmlXTreeObject
 * @method setItemImage2
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @param {String} image1 image1 - node without children icon
 * @param {String} image2 image2 - open node icon
 * @param {String} image3 image3 - closed node icon
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setItemStyle
 * @class dhtmlXTreeObject
 * @method setItemStyle
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - node id
 * @param {String} style_string style_string - valid CSS string
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.setItemText
 * @class dhtmlXTreeObject
 * @method setItemText
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of node
 * @param {String} newLabel newLabel - node text
 * @param {String} [newTooltip] newTooltip - (optional)tooltip for the node
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setItemTopOffset
 * @class dhtmlXTreeObject
 * @method setItemTopOffset
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of item
 * @param {String} value value - value of top offset in px
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setListDelimeter
 * @class dhtmlXTreeObject
 * @method setListDelimeter
 * @memberOf dhtmlXTreeObject
 * @param {String} separator separator - char or string to use for separating items in lists
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setLockedIcons
 * @class dhtmlXTreeObject
 * @method setLockedIcons
 * @memberOf dhtmlXTreeObject
 * @param {String} im0 im0 - icon for locked leaf
 * @param {String} im1 im1 - icon for closed branch
 * @param {String} im2 im2 - icon for opened branch
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setOnDblClickHandler
 * @class dhtmlXTreeObject
 * @method setOnDblClickHandler
 * @memberOf dhtmlXTreeObject
 * @param {String} func func - event handling function
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setOnFormDismissal
 * @class dhtmlXTreeObject
 * @method setOnFormDismissal
 * @memberOf dhtmlXTreeObject
 * @param {String} func func - user defined function
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setOnFormInitialisation
 * @class dhtmlXTreeObject
 * @method setOnFormInitialisation
 * @memberOf dhtmlXTreeObject
 * @param {String} func func - user defined function
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.setSerializationLevel
 * @class dhtmlXTreeObject
 * @method setSerializationLevel
 * @memberOf dhtmlXTreeObject
 * @param {String} userData userData - enable/disable user data serialization
 * @param {String} fullXML fullXML - enable/disable full XML serialization
 * @param {String} escapeEntities escapeEntities - convert tag brackets to related html entitites
 * @param {String} userDataAsCData userDataAsCData - output user data in CDATA sections
 * @param {String} DTD DTD - if specified, then set as XML&#039;s DTD
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.setStdImages
 * @class dhtmlXTreeObject
 * @method setStdImages
 * @memberOf dhtmlXTreeObject
 * @param {String} image1 a0 - image for node without children;
 * @param {String} image2 a1 - image for closed node;
 * @param {String} image3 a2 - image for opened node
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setSubChecked
 * @class dhtmlXTreeObject
 * @method setSubChecked
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - target node id
 * @param {String} state state - checkbox state
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setUserData
 * @class dhtmlXTreeObject
 * @method setUserData
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - target node id
 * @param {String} name name - key for user data
 * @param {String} value value - user data value
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.setXMLAutoLoading
 * @class dhtmlXTreeObject
 * @method setXMLAutoLoading
 * @memberOf dhtmlXTreeObject
 * @param {String} filePath filePath - name of script returning XML; in case of virtual loading - user defined function
 * @example
 */
 ...
 * @id dhtmlXTreeObject.setXMLAutoLoadingBehaviour
 * @class dhtmlXTreeObject
 * @method setXMLAutoLoadingBehaviour
 * @memberOf dhtmlXTreeObject
 * @param {String} mode mode - id for some_script?id=item_id ;  name for  some_scriptitem_id, xmlname for  some_scriptitem_id.xml ; function for calling user defined handler
 * @example
 */
 ...
 * @id dhtmlXTreeObject.showItemCheckbox
 * @class dhtmlXTreeObject
 * @method showItemCheckbox
 * @memberOf dhtmlXTreeObject
 * @param {String} [itemId] itemId - id of selected item, optional, set null to change states of all items
 * @param {String} [state] state - checkbox show state : 0/1
 * @example
 */
...
/**
 * show item&#039;s form
 * @id dhtmlXTreeObject.showItemForm
 * @class dhtmlXTreeObject
 * @method showItemForm
 * @memberOf dhtmlXTreeObject
 * @param {String} itemID itemID -  item id
 ...
 * @id dhtmlXTreeObject.showItemSign
 * @class dhtmlXTreeObject
 * @method showItemSign
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - id of selected item
 * @param {String} state state - show state : 0/1
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.smartRefreshBranch
 * @class dhtmlXTreeObject
 * @method smartRefreshBranch
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId -  top node in branch
 * @param {String} [source] source - server side script , optional
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeObject.smartRefreshItem
 * @class dhtmlXTreeObject
 * @method smartRefreshItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId -  top node in branch
 * @param {String} [source] source - server side script , optional
 * @example
 ...
 * @id dhtmlXTreeObject.sortTree
 * @class dhtmlXTreeObject
 * @method sortTree
 * @memberOf dhtmlXTreeObject
 * @param {String} nodeId nodeId - id of node to start sorting from
 * @param {String} order all_levels - sorting all levels or only current level
 * @param {String} all_levels order - sorting order - ASC or DES
 * @example
 */
 ...
 * @id dhtmlXTreeObject.updateItem
 * @class dhtmlXTreeObject
 * @method updateItem
 * @memberOf dhtmlXTreeObject
 * @param {String} itemId itemId - list of node identificators
 * @param {String} [name] name - list of node identificators, optional
 * @param {String} [im0] im0 - list of node identificators, optional
 * @param {String} [im1] im1 - list of node identificators, optional
 * @param {String} [im2] im2 - list of node identificators, optional
 * @param {String} [achecked] achecked - list of node identificators, optional
 * @example
 */
...
/**
 *
 * dhtmlXTreeGridObject object class.
 * @id dhtmlXTreeGridObject
 * @class dhtmlXTreeGridObject
 * @constructor
 ...
 * @class dhtmlXTreeGridObject
 * @method addRow
 * @memberOf dhtmlXTreeGridObject
 * @param {String} new_id new_id  - new row id
 * @param {String} text text  - array of row label
 * @param {String} ind ind  - position of row (set to null, for using parentId)
 * @param {String} parent_id parent_id  - id of parent row
 * @param {String} img img  - img url for new row
 * @param {String} [child] child - child flag [optional]
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.addRowAfter
 * @class dhtmlXTreeGridObject
 * @method addRowAfter
 * @memberOf dhtmlXTreeGridObject
 * @param {String} new_id new_id  - new row id
 * @param {String} text text  - array of row label
 * @param {String} sibl_id sibl_id  - id of row, related to which new one will be added
 * @param {String} img img  - img url for new row
 * @param {String} [child] child - child flag [optional]
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.addRowBefore
 * @class dhtmlXTreeGridObject
 * @method addRowBefore
 * @memberOf dhtmlXTreeGridObject
 * @param {String} new_id new_id  - new row id
...
/**
 * collapse row
 * @id dhtmlXTreeGridObject.closeItem
 * @class dhtmlXTreeGridObject
 * @method closeItem
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
...
/**
 *
 * @id dhtmlXTreeGridObject.collapseAll
 * @class dhtmlXTreeGridObject
 * @method collapseAll
 * @memberOf dhtmlXTreeGridObject
 * @example
...
/**
 * get all possible values in column
 * @id dhtmlXTreeGridObject.collectTreeValues
 * @class dhtmlXTreeGridObject
 * @method collectTreeValues
 * @memberOf dhtmlXTreeGridObject
 * @param {Number} column column - {number} zero based index of column
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.deleteChildItems
 * @class dhtmlXTreeGridObject
 * @method deleteChildItems
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.enableTreeCellEdit
 * @class dhtmlXTreeGridObject
 * @method enableTreeCellEdit
 * @memberOf dhtmlXTreeGridObject
 * @param {Boolean} mode mode -  (boolean) true/false
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeGridObject.enableTreeGridLines
 * @class dhtmlXTreeGridObject
 * @method enableTreeGridLines
 * @memberOf dhtmlXTreeGridObject
 * @example
 */
...
/**
 *
 * @id dhtmlXTreeGridObject.expandAll
 * @class dhtmlXTreeGridObject
 * @method expandAll
 * @memberOf dhtmlXTreeGridObject
 * @example
...
/**
 * filter grid by mask
 * @id dhtmlXTreeGridObject.filterTreeBy
 * @class dhtmlXTreeGridObject
 * @method filterTreeBy
 * @memberOf dhtmlXTreeGridObject
 * @param {Number} column column - {number} zero based index of column
 * @param {String} value value - {string} filtering mask
 * @param {String} preserve preserve - {bool} filter current or initial state ( false by default )
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.getAllSubItems
 * @class dhtmlXTreeGridObject
 * @method getAllSubItems
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getChildItemIdByIndex
 * @class dhtmlXTreeGridObject
 * @method getChildItemIdByIndex
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 * @param {Number} ind ind - child node index
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.getItemImage
 * @class dhtmlXTreeGridObject
 * @method getItemImage
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getItemText
 * @class dhtmlXTreeGridObject
 * @method getItemText
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getLevel
 * @class dhtmlXTreeGridObject
 * @method getLevel
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getOpenState
 * @class dhtmlXTreeGridObject
 * @method getOpenState
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getParentId
 * @class dhtmlXTreeGridObject
 * @method getParentId
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.getSubItems
 * @class dhtmlXTreeGridObject
 * @method getSubItems
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.hasChildren
 * @class dhtmlXTreeGridObject
 * @method hasChildren
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
...
/**
 * expand row
 * @id dhtmlXTreeGridObject.openItem
 * @class dhtmlXTreeGridObject
 * @method openItem
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.setFiltrationLevel
 * @class dhtmlXTreeGridObject
 * @method setFiltrationLevel
 * @memberOf dhtmlXTreeGridObject
 * @param {String} level level - level value, -1 value means last one
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.setImageSize
 * @class dhtmlXTreeGridObject
 * @method setImageSize
 * @memberOf dhtmlXTreeGridObject
 * @param {String} width width -  width of image
 * @param {String} height height - height of image
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.setItemCloseable
 * @class dhtmlXTreeGridObject
 * @method setItemCloseable
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 ...
 * @id dhtmlXTreeGridObject.setItemImage
 * @class dhtmlXTreeGridObject
 * @method setItemImage
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 * @param {String} url url - image url
 ...
 * @id dhtmlXTreeGridObject.setItemText
 * @class dhtmlXTreeGridObject
 * @method setItemText
 * @memberOf dhtmlXTreeGridObject
 * @param {String} rowId rowId - id of row
 * @param {String} newtext newtext - new text
 * @example
 */
 ...
 * @id dhtmlXTreeGridObject.setOnOpenEndHandler
 * @class dhtmlXTreeGridObject
 ...
 * @id dhtmlXTreeGridObject.setOnOpenStartHandler
 * @class dhtmlXTreeGridObject
 ...
 * @id dhtmlXTreeGridObject.sortTreeRows
 * @class dhtmlXTreeGridObject
 * @method sortTreeRows
 * @memberOf dhtmlXTreeGridObject
 * @param {Number} col col - column index
 * @param {String} type type - str.int.date
 ...
 * @id dhtmlXTreeGridObject.getLabel
 * @class dhtmlXTreeGridObject
 * @method getLabel
 * @memberOf dhtmlXTreeGridObject
 * @param {String} val val - new value
 * @example
 */
...
/**
 * sets text representation of cell ( setLabel doesn&#039;t triger math calculations as setValue do)
 * @id dhtmlXTreeGridObject.setLabel
 * @class dhtmlXTreeGridObject
 * @method setLabel
 * @memberOf dhtmlXTreeGridObject
 * @param {String} val val - new value
...
/**
 * delete item(s)
 * @id dhtmlxFolders.deleteItem
 * @class dhtmlxFolders
 * @method deleteItem
 * @memberOf dhtmlxFolders
 * @param {String} id id - id (or array of ids) of item to delete
...
/**
 * enable/disable context menu
 * @id dhtmlxFolders.enableContextMenu
 * @class dhtmlxFolders
 * @method enableContextMenu
 * @memberOf dhtmlxFolders
 * @param {Object} menu menu object, if null - context menu will be disabled
 * @example
 */
 ...
 * @id dhtmlxFolders.enableDragAndDrop
 * @class dhtmlxFolders
 * @method enableDragAndDrop
 * @memberOf dhtmlxFolders
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlxFolders.enableEditMode
 * @class dhtmlxFolders
 * @method enableEditMode
 * @memberOf dhtmlxFolders
 * @param {String} state newPath - new base directory path
 ...
 * @id dhtmlxFolders.enablePaging
 * @class dhtmlxFolders
 * @method enablePaging
 * @memberOf dhtmlxFolders
 * @param {String} itemsPerPage itemsPerPage - number of items per page, or (if 0) disable paging
 * @param {String} withDynLoading withDynLoading - true to allow dynamical loading
...
/**
 * set selection mode
 * @id dhtmlxFolders.enableSelection
 * @class dhtmlxFolders
 * @method enableSelection
 * @memberOf dhtmlxFolders
 * @param {String} mode mode - selection mode: 0 - disabled,1 - allowed, 2 - allowed single
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.enableXMLSmartRefresh
 * @class dhtmlxFolders
 * @method enableXMLSmartRefresh
 * @memberOf dhtmlxFolders
 * @param {Boolean} mode mode - true to enable, false to disable
 ...
 * @id dhtmlxFolders.filterItems
 * @class dhtmlxFolders
 * @method filterItems
 * @memberOf dhtmlxFolders
 * @param {Object} filterFunc filterFunc - function to use to define if item should appear or not. if this function returns true, then item will be visible. Incomming arguments are: item object and mask
 * @param {String} mask mask - mask to use in filter
 * @param {String} preservePrevious preservePrevious - preserver previously applied filters
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.forEachSelected
 * @class dhtmlxFolders
 * @method forEachSelected
 * @memberOf dhtmlxFolders
...
/**
 *
 * @id dhtmlxFolders.getCurrentPage
 * @class dhtmlxFolders
...
/**
 *
 * @id dhtmlxFolders.getItemDataObject
 * @class dhtmlxFolders
 * @method getItemDataObject
 * @memberOf dhtmlxFolders
 * @param {Object} itemId itemId - id of item to get data object from
...
/**
 *
 * @id dhtmlxFolders.getNumberOfPages
 * @class dhtmlxFolders
...
/**
 *
 * @id dhtmlxFolders.getSelectedId
 * @class dhtmlxFolders
 ...
 * @id dhtmlxFolders.goToPage
 * @class dhtmlxFolders
 * @method goToPage
 * @memberOf dhtmlxFolders
 * @param {Number} pageNumber pageNumber - 1 based index of page to open
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.loadXML
 * @class dhtmlxFolders
 * @method loadXML
 * @memberOf dhtmlxFolders
 * @param {String} url url - xml file URL
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.loadXMLString
 * @class dhtmlxFolders
 * @method loadXMLString
 * @memberOf dhtmlxFolders
 * @param {String} xmlString xmlString - xml string
...
/**
 * moves item
 * @id dhtmlxFolders.moveItem
 * @class dhtmlxFolders
 * @method moveItem
 * @memberOf dhtmlxFolders
 * @param {String} sid sid - source item id
 * @param {String} mode mode - mode of movement (next, before, in)
 * @param {String} tid tid - target item id
 * @param {Object} sObj sObj - source object (if not specified then current Folders object)
 * @param {Object} tObj tObj - target object (if not specified then current Folders object)
 * @example
 */
 ...
 * @id dhtmlxFolders.selectItem
 * @class dhtmlxFolders
 * @method selectItem
 * @memberOf dhtmlxFolders
 * @param {String} id id - item id to select
 * @param {Boolean} ctr ctr - state of ctrl button (true/false)
 * @param {Boolean} shf shf - state of shift button (true/false)
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.setCSSBaseName
 * @class dhtmlxFolders
 * @method setCSSBaseName
 * @memberOf dhtmlxFolders
 * @example
 */
 ...
 * @id dhtmlxFolders.setImagePath
 * @class dhtmlxFolders
 * @method setImagePath
 * @memberOf dhtmlxFolders
 * @param {String} newPath newPath - new base directory path
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.setItemTagName
 * @class dhtmlxFolders
 * @method setItemTagName
 * @memberOf dhtmlxFolders
 * @param {String} newTagName newPath - new base directory path
 * @example
 */
 ...
 * @id dhtmlxFolders.setItemType
 * @class dhtmlxFolders
 * @method setItemType
 * @memberOf dhtmlxFolders
 * @param {String} name name - name of type (if user-defined xml-xsl type, them use "xml_generic", if userdefined js type, then use "js_generic")
 * @param {Object} processor processor - (for xml-xsl) url of xsl file to use for this type, (for js) function which gets json object and returns html string.
 * @example
 */
...
/**
 *
 * @id dhtmlxFolders.setPagerContainer
 * @class dhtmlxFolders
 * @method setPagerContainer
 * @memberOf dhtmlxFolders
 * @example
 */
 ...
 * @id dhtmlxFolders.setUserData
 * @class dhtmlxFolders
 * @method setUserData
 * @memberOf dhtmlxFolders
 * @param {String} name name - userdata block name
 * @param {String} value value - value of userdata block
 * @example
 */
...
/**
 * sort items
 * @id dhtmlxFolders.sortItems
 * @class dhtmlxFolders
 * @method sortItems
 * @memberOf dhtmlxFolders
 * @param {Object} sortFunc sortFunc - custom function used for comparing two values. it gets 2 objects for comparison and must return positive int if necessary property of first ojects "bigger", 0 if they are equel for both and negative if second obj property is "bigger"
 * @param {String} order order - direction (0 or 1)
 * @example
 */
...
/**
 *
 * dhtmlXDataView object class.
 * @id dhtmlXDataView
 * @class dhtmlXDataView
 * @constructor
 ...
 * @class dhtmlXDataView
 * @method attachEvent
 * @memberOf dhtmlXDataView
 * @param {String} evName evName - event name;
...
/**
 *
 * @id dhtmlXDataView.copy
 * @class dhtmlXDataView
 * @method copy
 * @memberOf dhtmlXDataView
 * @param {String} sid sid - id of source item, mandatory
 ...
 * @id dhtmlXDataView.unselect
 * @class dhtmlXDataView
 * @method unselect
 * @memberOf dhtmlXDataView
 * @param {String} [id] id - item id which needs to be unselected, optional
 ...
 * @id dhtmlXDataView.detachEvent
 * @class dhtmlXDataView
 * @method detachEvent
 * @memberOf dhtmlXDataView
 * @param {String} id id - if of handler ( result of attachEvent operation )
 ...
 * @id dhtmlXDataView.edit
 * @class dhtmlXDataView
 * @method edit
 * @memberOf dhtmlXDataView
 * @param {String} id id - id of item in question
 ...
 * @id dhtmlXDataView.filter
 * @class dhtmlXDataView
 * @method filter
 * @memberOf dhtmlXDataView
 * @param {String} key key - name of property, or custom filtering method
 ...
 * @id dhtmlXDataView.getSelected
 * @class dhtmlXDataView
 * @method getSelected
 * @memberOf dhtmlXDataView
 * @param {String} as_array as_array - forces return value to be an array
 ...
 * @id dhtmlXDataView.idByIndex
 * @class dhtmlXDataView
 * @method idByIndex
 * @memberOf dhtmlXDataView
 * @param {Number} index index - index of the item in question
 ...
 * @id dhtmlXDataView.indexById
 * @class dhtmlXDataView
 * @method indexById
 * @memberOf dhtmlXDataView
 * @param {String} id ID - ID of the item in question
 ...
 * @id dhtmlXDataView.load
 * @class dhtmlXDataView
 * @method load
 * @memberOf dhtmlXDataView
 * @param {String} url url - data url, need to be in the same domain
 * @param {String} type Callback is always the last parameter.
 * @param {Function} callback Methos is async., so you need to use callback to catch the moment when data is really loaded in the view.
 ...
 * @id dhtmlXDataView.locate
 * @class dhtmlXDataView
 * @method locate
 * @memberOf dhtmlXDataView
 * @param {String} ev ev - native html event
 ...
 * @id dhtmlXDataView.parse
 * @class dhtmlXDataView
 * @method parse
 * @memberOf dhtmlXDataView
 * @param {Object} object object - string or object
 * @param {String} type type - type of data
 ...
 * @id dhtmlXDataView.refresh
 * @class dhtmlXDataView
 * @method refresh
 * @memberOf dhtmlXDataView
 * @param {String} [id] id - id of item in question, optional
 ...
 * @id dhtmlXDataView.select
 * @class dhtmlXDataView
 * @method select
 * @memberOf dhtmlXDataView
 * @param {String} [id] id - id of item which need to be selected, optional
 ...
 * @id dhtmlXDataView.set
 * @class dhtmlXDataView
 * @method set
 * @memberOf dhtmlXDataView
 * @param {String} id id - if of item in question
 * @example view.set(id,{
 * 		property:value
 * 	});
 */
...
/**
 * adds any user-defined handler to available events
 * @id dhtmlXDataView.sort
 * @class dhtmlXDataView
 * @method sort
 * @memberOf dhtmlXDataView
 * @param {String} key key - name of property, by which dataview will be sorted, or custom sorting method
 ...
 * @id dhtmlXDataView.customize
 * @class dhtmlXDataView
 * @method customize
 * @memberOf dhtmlXDataView
 * @param {String} properties properties - set of custom properties
 ...
 * @method add
 * @memberOf dhtmlChart
 * @param {Object} obj obj - a data object
 * @example chart.add({
 *         id: 1,
 *         value: 5.64,
 *         label: 2009
 ...
 * @id dhtmlChart.define
 * @class dhtmlChart
 * @method define
 * @memberOf dhtmlChart
 * @param {String} mode property - the name of mode or property which needs being configured
 ...
 * @method set
 * @memberOf dhtmlChart
 * @param {String} id id - the id of the item in question
 ...
 * @method sort
 * @memberOf dhtmlChart
 * @param {String} key key - name of property, by which chart will be sorted, or custom sorting method,
...
/**
 *
 * dhtmlXMenuObject object class.
 * @id dhtmlXMenuObject
 * @class dhtmlXMenuObject
 * @constructor
 ...
 * @class dhtmlXMenuObject
 * @method addCheckbox
 * @memberOf dhtmlXMenuObject
 * @param {String} mode mode - (string) sibling|child
 * @param {String} nextToId nextToId - the item after which the checkbox will be added in the "sibling" mode or parent item&#039;s id in the "child" mode
 * @param {String} pos pos - item&#039;s position in the child mode (null for sibling)
 * @param {String} itemId itemId - id of a new checkbox
 * @param {String} itemText itemText - text of a new checkbox
 * @param {String} state state - checked|unchecked
 * @param {String} disabled disabled - enabled|disabled
 ...
 * @id dhtmlXMenuObject.addContextZone
 * @class dhtmlXMenuObject
 * @method addContextZone
 * @memberOf dhtmlXMenuObject
 * @param {Object} zoneId zoneId - id of the object on page to render as a contextual zone
 ...
 * @id dhtmlXMenuObject.addNewChild
 * @class dhtmlXMenuObject
 * @method addNewChild
 * @memberOf dhtmlXMenuObject
 * @param {String} parentId parentId - the item which will contain a new item in the sublevel
 * @param {String} pos position - the position of a new item
 * @param {String} itemId itemId - id of a new item
 * @param {String} itemText itemText - text of a new item
 * @param {Boolean} disabled disabled - true|false, whether the item is disabled or not
 * @param {String} imgEnabled img - image for the enabled item
 * @param {String} imgDisabled imgDis - image for the disabled item
...
/**
 * add a new separator
 * @id dhtmlXMenuObject.addNewSeparator
 * @class dhtmlXMenuObject
 * @method addNewSeparator
 * @memberOf dhtmlXMenuObject
 * @param {String} nextToId nextToId - id of the element after which a new separator will be inserted
 * @param {String} itemId itemId - id of a new separator
 ...
 * @id dhtmlXMenuObject.addNewSibling
 * @class dhtmlXMenuObject
 * @method addNewSibling
 * @memberOf dhtmlXMenuObject
 * @param {String} nextToId nextToId - id of the element after which a new one will be inserted
 * @param {String} itemId itemId - id of a new item
 * @param {String} itemText itemText - text of a new item
 * @param {Boolean} disabled disabled - true|false, whether the item is disabled or not
 * @param {String} imgEnabled img - image for the enabled item
 ...
 * @id dhtmlXMenuObject.addRadioButton
 * @class dhtmlXMenuObject
 * @method addRadioButton
 * @memberOf dhtmlXMenuObject
 * @param {String} mode mode - (string) sibling|child
 * @param {String} nextToId nextToId - the item after which the radio button will be added in the "sibling" mode or parent item&#039;s id in the "child" mode
 * @param {String} pos pos - the item&#039;s position in the child mode (null for sibling)
 * @param {String} itemId itemId - id of a new radio button
 * @param {String} itemText itemText - text of a new radio button
 * @param {String} group group - radiogroup&#039;s id
 * @param {String} state state - checked|unchecked
 * @param {String} disabled disabled - enabled|disabled
...
/**
 * attaches an event handler
 * @id dhtmlXMenuObject.attachEvent
 * @class dhtmlXMenuObject
 * @method attachEvent
 * @memberOf dhtmlXMenuObject
 * @param {String} original original - event&#039;s original name;
...
/**
 * returns true if the event exists
 * @id dhtmlXMenuObject.checkEvent
 * @class dhtmlXMenuObject
 * @method checkEvent
 * @memberOf dhtmlXMenuObject
 * @param {String} name name - event&#039;s name
 ...
 * @id dhtmlXMenuObject.clearItemImage
 * @class dhtmlXMenuObject
 * @method clearItemImage
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item id
...
/**
 * removes an event handler
 * @id dhtmlXMenuObject.detachEvent
 * @class dhtmlXMenuObject
 * @method detachEvent
 * @memberOf dhtmlXMenuObject
 * @param {String} id id - event&#039;s id
 ...
 * @id dhtmlXMenuObject.enableDynamicLoading
 * @class dhtmlXMenuObject
 * @method enableDynamicLoading
 * @memberOf dhtmlXMenuObject
 * @param {String} url url - server-side script, transmitted params are action=loadMenu and parentId
 * @param {Boolean} icon icon - true|false, replaces elemet&#039;s arrow with loading image while loading
 ...
 * @id dhtmlXMenuObject.getCheckboxState
 * @class dhtmlXMenuObject
 * @method getCheckboxState
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId id - item id
...
/**
 *
 * @id dhtmlXMenuObject.getContextMenuHideAllMode
 * @class dhtmlXMenuObject
 * @method getContextMenuHideAllMode
 * @memberOf dhtmlXMenuObject
 ...
 * @id dhtmlXMenuObject.getHotKey
 * @class dhtmlXMenuObject
 * @method getHotKey
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - menu item&#039;s id
 ...
 * @id dhtmlXMenuObject.getItemImage
 * @class dhtmlXMenuObject
 * @method getItemImage
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item
 ...
 * @id dhtmlXMenuObject.getItemPosition
 * @class dhtmlXMenuObject
 * @method getItemPosition
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
...
/**
 * returns item&#039;s text
 * @id dhtmlXMenuObject.getItemText
 * @class dhtmlXMenuObject
 * @method getItemText
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 ...
 * @id dhtmlXMenuObject.getItemType
 * @class dhtmlXMenuObject
 * @method getItemType
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
...
/**
 * returns parent&#039;s id
 * @id dhtmlXMenuObject.getParentId
 * @class dhtmlXMenuObject
 * @method getParentId
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 ...
 * @id dhtmlXMenuObject.getRadioChecked
 * @class dhtmlXMenuObject
 * @method getRadioChecked
 * @memberOf dhtmlXMenuObject
 * @param {String} group group - radio button group name
 ...
 * @id dhtmlXMenuObject.getTooltip
 * @class dhtmlXMenuObject
 * @method getTooltip
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - menu item&#039;s id
 ...
 * @id dhtmlXMenuObject.getUserData
 * @class dhtmlXMenuObject
 * @method getUserData
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 * @param {String} name name - the name of userdata (string)
...
/**
 *
 * @id dhtmlXMenuObject.hideContextMenu
 * @class dhtmlXMenuObject
...
/**
 * hides an item
 * @id dhtmlXMenuObject.hideItem
 * @class dhtmlXMenuObject
 * @method hideItem
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId id - the item&#039;s id to hide
 ...
 * @id dhtmlXMenuObject.isContextZone
 * @class dhtmlXMenuObject
 * @method isContextZone
 * @memberOf dhtmlXMenuObject
 * @param {Object} zoneId zoneId - id of the object to check
 * @example var menu = new dhtmlXMenuObject();
 *     menu.renderAsContextMenu();
 ...
 * @id dhtmlXMenuObject.isItemEnabled
 * @class dhtmlXMenuObject
 * @method isItemEnabled
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id to check
 ...
 * @id dhtmlXMenuObject.isItemHidden
 * @class dhtmlXMenuObject
 * @method isItemHidden
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id to check
 ...
 * @id dhtmlXMenuObject.loadFromHTML
 * @class dhtmlXMenuObject
 * @method loadFromHTML
 * @memberOf dhtmlXMenuObject
 * @param {Object} objId object - html data container
 * @param {Boolean} clearAfterAdd clearAfterAdd - true|false, removes the container object after the data is loaded
 * @param {String} onLoadFunction onLoadFunction - is called after the data is loaded (but before clearing html content if clear is set to true)
 * @example <script>
 ...
 *             // code here
 *         }
 *         menu.loadFromHTML("menuData", true, main);
 *     </script>
 */
 ...
 * @id dhtmlXMenuObject.loadXML
 * @class dhtmlXMenuObject
 * @method loadXML
 * @memberOf dhtmlXMenuObject
 * @param {String} xmlFile xmlFile - an xml file with webmenu data
 * @param {String} onLoadFunction onLoadFunction - a function that is called after loading is done
 * @example <script>
 ...
 * @id dhtmlXMenuObject.loadXMLString
 * @class dhtmlXMenuObject
 * @method loadXMLString
 * @memberOf dhtmlXMenuObject
 * @param {String} xmlString xmlFile - an xml string with webmenu data
 * @param {String} onLoadFunction onLoadFunction - function that is called after loading is done
 * @example <script>
 *         onLoadFunction = function(){
 ...
 * @id dhtmlXMenuObject.removeContextZone
 * @class dhtmlXMenuObject
 * @method removeContextZone
 * @memberOf dhtmlXMenuObject
 * @param {String} zoneId zoneId - id of a contextual zone
 ...
 * @id dhtmlXMenuObject.removeItem
 * @class dhtmlXMenuObject
 * @method removeItem
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId id - id of the item for removing
...
/**
 *
 * @id dhtmlXMenuObject.renderAsContextMenu
 * @class dhtmlXMenuObject
 * @method renderAsContextMenu
 * @memberOf dhtmlXMenuObject
 ...
 * @id dhtmlXMenuObject.setAlign
 * @class dhtmlXMenuObject
 * @method setAlign
 * @memberOf dhtmlXMenuObject
 * @param {String} align align - left|right
 ...
 * @id dhtmlXMenuObject.setAutoHideMode
 * @class dhtmlXMenuObject
 * @method setAutoHideMode
 * @memberOf dhtmlXMenuObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXMenuObject.setAutoShowMode
 * @class dhtmlXMenuObject
 * @method setAutoShowMode
 * @memberOf dhtmlXMenuObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXMenuObject.setCheckboxState
 * @class dhtmlXMenuObject
 * @method setCheckboxState
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 * @param {Boolean} state state - a new state (true|false)
 ...
 * @id dhtmlXMenuObject.setContextMenuHideAllMode
 * @class dhtmlXMenuObject
 * @method setContextMenuHideAllMode
 * @memberOf dhtmlXMenuObject
 * @param {Boolean} mode mode - true/false
 ...
 * @id dhtmlXMenuObject.setHotKey
 * @class dhtmlXMenuObject
 * @method setHotKey
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - menu item&#039;s id
 * @param {String} hkey hkey - hot-key text (string)
 ...
 * @id dhtmlXMenuObject.setHref
 * @class dhtmlXMenuObject
 * @method setHref
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId
 * @param {String} href href - url to open instead of onClik event handling
 * @param {String} target target - target attribute
 ...
 * @id dhtmlXMenuObject.setIconsPath
 * @class dhtmlXMenuObject
 * @method setIconsPath
 * @memberOf dhtmlXMenuObject
 * @param {String} path path - path on harddrive to items&#039; icons
...
/**
 *
 * @id dhtmlXMenuObject.setImagePath
 * @class dhtmlXMenuObject
 * @method setImagePath
 * @memberOf dhtmlXMenuObject
 * @example
...
/**
 * disables an item
 * @id dhtmlXMenuObject.setItemDisabled
 * @class dhtmlXMenuObject
 * @method setItemDisabled
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - item&#039;s id to disable
...
/**
 * enables an item
 * @id dhtmlXMenuObject.setItemEnabled
 * @class dhtmlXMenuObject
 * @method setItemEnabled
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - item&#039;s id to enable
 ...
 * @id dhtmlXMenuObject.setItemImage
 * @class dhtmlXMenuObject
 * @method setItemImage
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 * @param {String} img img - the image for the enabled item (empty string for none)
 * @param {String} imgDis imgDis - the image for the disabled item (empty string for none)
 ...
 * @id dhtmlXMenuObject.setItemPosition
 * @class dhtmlXMenuObject
 * @method setItemPosition
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item
 * @param {String} pos pos - the position (int)
 * @example
 */
 ...
 * @id dhtmlXMenuObject.setItemText
 * @class dhtmlXMenuObject
 * @method setItemText
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 * @param {String} text text - a new text
 ...
 * @id dhtmlXMenuObject.setOpenMode
 * @class dhtmlXMenuObject
 * @method setOpenMode
 * @memberOf dhtmlXMenuObject
 * @param {String} mode mode - win|web, the default mode is web, in the win mode a user should click anywhere to hide the menu, in the web mode - just put the mouse pointer out of the menu area (string)
 ...
 * @id dhtmlXMenuObject.setOverflowHeight
 * @class dhtmlXMenuObject
 * @method setOverflowHeight
 * @memberOf dhtmlXMenuObject
 * @param {String} itemsNum itemsNum - count of the maximum number of visible items
 ...
 * @id dhtmlXMenuObject.setRadioChecked
 * @class dhtmlXMenuObject
 * @method setRadioChecked
 * @memberOf dhtmlXMenuObject
 * @param {String} group group - radio button group name
 * @param {String} itemId itemId - radio button&#039;s id
 ...
 * @id dhtmlXMenuObject.setTooltip
 * @class dhtmlXMenuObject
 * @method setTooltip
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - menu item&#039;s id
 * @param {String} tip tip - tooltip
 ...
 * @id dhtmlXMenuObject.setTopText
 * @class dhtmlXMenuObject
 * @method setTopText
 * @memberOf dhtmlXMenuObject
 ...
 * @id dhtmlXMenuObject.setUserData
 * @class dhtmlXMenuObject
 * @method setUserData
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id
 * @param {String} name name - the name of userdata (string)
 * @param {String} value value - the value of userdata (usually string)
 ...
 * @id dhtmlXMenuObject.setVisibleArea
 * @class dhtmlXMenuObject
 * @method setVisibleArea
 * @memberOf dhtmlXMenuObject
 * @param {String} x1 x1, x2 - int, leftmost and rightmost coordinates by x axis
 * @param {String} x2 y1, y2 - int, topmost and bottommost coordinates by y axis
 ...
 * @id dhtmlXMenuObject.setWebModeTimeout
 * @class dhtmlXMenuObject
 * @method setWebModeTimeout
 * @memberOf dhtmlXMenuObject
 * @param {String} tm tm - timeout, ms, 400 default
 ...
 * @id dhtmlXMenuObject.showContextMenu
 * @class dhtmlXMenuObject
 * @method showContextMenu
 * @memberOf dhtmlXMenuObject
 * @param {String} x x - position of the menu on x axis
 * @param {String} y y - position of the menu on y axis
...
/**
 * shows an item
 * @id dhtmlXMenuObject.showItem
 * @class dhtmlXMenuObject
 * @method showItem
 * @memberOf dhtmlXMenuObject
 * @param {String} itemId itemId - the item&#039;s id to show
 ...
 * @class dhtmlxToolbar
 * @method addButton
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a button
 * @param {String} pos pos - position of a button
 * @param {String} text text - text for a button (null for no text)
 * @param {String} imgEnabled imgEnabled - image for enabled state (null for no image)
 * @param {String} imgDisabled imgDisabled - image for desabled state (null for no image)
 ...
 * @id dhtmlxToolbar.addButtonSelect
 * @class dhtmlxToolbar
 * @method addButtonSelect
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a select button
 * @param {String} pos pos - position of a select button
 * @param {String} text text - text for a select button (null for no text)
 * @param {String} opts opts - listed options for a select button
 * @param {String} imgEnabled imgEnabled - image for enabled state (null for no image)
 * @param {String} imgDisabled imgDisabled - image for desabled state (null for no image)
 ...
 * @id dhtmlxToolbar.addButtonTwoState
 * @class dhtmlxToolbar
 * @method addButtonTwoState
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a two-state button
 * @param {String} pos pos - position of a two-state button
 * @param {String} text text - text for a two-state button (null for no text)
 * @param {String} imgEnabled imgEnabled - image for enabled state (null for no image)
 * @param {String} imgDisabled imgDisabled - image for desabled state (null for no image)
 ...
 * @id dhtmlxToolbar.addInput
 * @class dhtmlxToolbar
 * @method addInput
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of an input item
 * @param {String} pos pos - position of an input item
 * @param {String} value value - value (text) in an input item by the default
 * @param {String} width width - width of an input item (px)
 ...
 * @id dhtmlxToolbar.addListOption
 * @class dhtmlxToolbar
 * @method addListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 * @param {String} pos pos - position of a listed option
 * @param {String} type type - type of a listed option (button|separator)
 * @param {String} text text - text for a listed option
 * @param {String} img img - image for a listed option
 ...
 * @id dhtmlxToolbar.addSeparator
 * @class dhtmlxToolbar
 * @method addSeparator
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a separator
 * @param {String} pos pos - position of a separator
 ...
 * @id dhtmlxToolbar.addSlider
 * @class dhtmlxToolbar
 * @method addSlider
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a slider
 * @param {String} pos pos - position of a slider
 * @param {String} len len - length (width) of a slider (px)
 * @param {String} valueMin valueMin - minimal available value of a slider
 * @param {String} valueMax valueMax - maximal available value of a slider
 * @param {String} valueNow valueNow - initial current value of a slider
 * @param {String} textMin textMin - label for minimal value side (on the left side)
 * @param {String} textMax textMax - label for maximal value side (on the right side)
 * @param {String} tip tip - tooltip template (%v will replaced with current value)
 ...
 * @id dhtmlxToolbar.addText
 * @class dhtmlxToolbar
 * @method addText
 * @memberOf dhtmlxToolbar
 * @param {String} id id - id of a text item
 * @param {String} pos pos - position of a text item
 * @param {String} text text - text for a text item
 ...
 * @id dhtmlxToolbar.attachEvent
 * @class dhtmlxToolbar
 * @method attachEvent
 * @memberOf dhtmlxToolbar
 * @param {String} original original - event original name;
 * @param {String} catcher catcher - event handler;
 * @param {Object} CallObj CallObj - object which will call event.
 ...
 * @id dhtmlxToolbar.checkEvent
 * @class dhtmlxToolbar
 * @method checkEvent
 * @memberOf dhtmlxToolbar
 * @param {String} name name - event name
 ...
 * @id dhtmlxToolbar.clearItemImage
 * @class dhtmlxToolbar
 * @method clearItemImage
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 ...
 * @id dhtmlxToolbar.clearItemImageDis
 * @class dhtmlxToolbar
 * @method clearItemImageDis
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 ...
 * @id dhtmlxToolbar.clearListOptionImage
 * @class dhtmlxToolbar
 * @method clearListOptionImage
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.disableItem
 * @class dhtmlxToolbar
 * @method disableItem
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item to disable
 ...
 * @id dhtmlxToolbar.disableListOption
 * @class dhtmlxToolbar
 * @method disableListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.enableItem
 * @class dhtmlxToolbar
 * @method enableItem
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item to enable
 ...
 * @id dhtmlxToolbar.enableListOption
 * @class dhtmlxToolbar
 * @method enableListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.forEachItem
 * @class dhtmlxToolbar
 * @method forEachItem
 * @memberOf dhtmlxToolbar
 * @param {String} handler handler - user function, will take item id as an argument
 ...
 * @id dhtmlxToolbar.forEachListOption
 * @class dhtmlxToolbar
 * @method forEachListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} handler handler - user defined function, listed option id will passed as an argument
 ...
 * @id dhtmlxToolbar.getAllListOptions
 * @class dhtmlxToolbar
 * @method getAllListOptions
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 ...
 * @id dhtmlxToolbar.getItemState
 * @class dhtmlxToolbar
 * @method getItemState
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a two-state item to check
 ...
 * @id dhtmlxToolbar.getItemToolTip
 * @class dhtmlxToolbar
 * @method getItemToolTip
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 ...
 * @id dhtmlxToolbar.getItemToolTipTemplate
 * @class dhtmlxToolbar
 * @method getItemToolTipTemplate
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a slider
 ...
 * @id dhtmlxToolbar.getListOptionImage
 * @class dhtmlxToolbar
 * @method getListOptionImage
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.getListOptionPosition
 * @class dhtmlxToolbar
 * @method getListOptionPosition
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.getListOptionSelected
 * @class dhtmlxToolbar
 * @method getListOptionSelected
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 ...
 * @id dhtmlxToolbar.getListOptionText
 * @class dhtmlxToolbar
 * @method getListOptionText
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.getListOptionToolTip
 * @class dhtmlxToolbar
 * @method getListOptionToolTip
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.getValue
 * @class dhtmlxToolbar
 * @method getValue
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a slider or an input item
 * @example
 */
 ...
 * @id dhtmlxToolbar.getWidth
 * @class dhtmlxToolbar
 * @method getWidth
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an input item
 ...
 * @id dhtmlxToolbar.hideItem
 * @class dhtmlxToolbar
 * @method hideItem
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item to hide
 ...
 * @id dhtmlxToolbar.hideListOption
 * @class dhtmlxToolbar
 * @method hideListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.isEnabled
 * @class dhtmlxToolbar
 * @method isEnabled
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item to check
 ...
 * @id dhtmlxToolbar.isListOptionEnabled
 * @class dhtmlxToolbar
 * @method isListOptionEnabled
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.isListOptionVisible
 * @class dhtmlxToolbar
 * @method isListOptionVisible
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.loadXML
 * @class dhtmlxToolbar
 * @method loadXML
 * @memberOf dhtmlxToolbar
 * @param {String} xmlFile xmlFile - file with dta to load
 * @param {String} onLoadFunction onLoadFunction - function to call after data will loaded
 ...
 *         // code here
 *     }
 *     toolbar.loadXML("file.xml", main);
 */
dhtmlxToolbar.prototype.loadXML = function (xmlFile, onLoadFunction) {
};
/**
 * loads data to object from xml string
 * @id dhtmlxToolbar.loadXMLString
 * @class dhtmlxToolbar
 * @method loadXMLString
 * @memberOf dhtmlxToolbar
 * @param {String} xmlString xmlString - xml string with data to load
 * @param {String} onLoadFunction onLoadFunction - function to call after data will loaded
 ...
 * @id dhtmlxToolbar.removeListOption
 * @class dhtmlxToolbar
 * @method removeListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.setIconsPath
 * @class dhtmlxToolbar
 * @method setIconsPath
 * @memberOf dhtmlxToolbar
 * @param {String} path path - path to images on harddisk
 ...
 * @id dhtmlxToolbar.setItemImage
 * @class dhtmlxToolbar
 * @method setItemImage
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 * @param {String} url url - url of an image
 ...
 * @id dhtmlxToolbar.setItemImageDis
 * @class dhtmlxToolbar
 * @method setItemImageDis
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 * @param {String} url url - url of an image
 ...
 * @id dhtmlxToolbar.setItemState
 * @class dhtmlxToolbar
 * @method setItemState
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a two-state item
 * @param {Boolean} state state - state, true for pressed, false for released
 ...
 * @id dhtmlxToolbar.setItemText
 * @class dhtmlxToolbar
 * @method setItemText
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 * @param {String} text text - new text for an item
 ...
 * @id dhtmlxToolbar.setItemToolTip
 * @class dhtmlxToolbar
 * @method setItemToolTip
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 * @param {String} tip tip - tooltip (empty for clear)
 ...
 * @id dhtmlxToolbar.setItemToolTipTemplate
 * @class dhtmlxToolbar
 * @method setItemToolTipTemplate
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a slider
 * @param {String} template template - tooltip template (%v will replaced with current value)
 ...
 * @id dhtmlxToolbar.setListOptionImage
 * @class dhtmlxToolbar
 * @method setListOptionImage
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 * @param {String} img img - image for a listed option
 ...
 * @id dhtmlxToolbar.setListOptionPosition
 * @class dhtmlxToolbar
 * @method setListOptionPosition
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 * @param {String} pos pos - position of a listed option
 ...
 * @id dhtmlxToolbar.setListOptionSelected
 * @class dhtmlxToolbar
 * @method setListOptionSelected
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @id dhtmlxToolbar.setListOptionText
 * @class dhtmlxToolbar
 * @method setListOptionText
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 * @param {String} text text - text for a listed option
 ...
 * @id dhtmlxToolbar.setListOptionToolTip
 * @class dhtmlxToolbar
 * @method setListOptionToolTip
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 * @param {String} tip tip - tooltip for a listed option
 ...
 * @id dhtmlxToolbar.setMaxValue
 * @class dhtmlxToolbar
 * @method setMaxValue
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a slider
 * @param {String} value value - value (int)
 * @param {String} label label - label for value (empty for no label)
 ...
 * @id dhtmlxToolbar.setPosition
 * @class dhtmlxToolbar
 * @method setPosition
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item
 * @param {String} pos pos - new position
 ...
 * @id dhtmlxToolbar.setSkin
 * @class dhtmlxToolbar
 * @method setSkin
 * @memberOf dhtmlxToolbar
 * @param {String} name name - skin name (string)
 ...
 * @id dhtmlxToolbar.setValue
 * @class dhtmlxToolbar
 * @method setValue
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of a slider or an input item
 * @param {String} value value - value (int for slider, any for input item)
 * @param {Boolean} CallEvent CallEvent - true/false, call "onValueChanged" event for slider
 ...
 * @id dhtmlxToolbar.setWidth
 * @class dhtmlxToolbar
 * @method setWidth
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an text/input/buttonSelect item
 * @param {String} width width - new width (px)
 ...
 * @id dhtmlxToolbar.showItem
 * @class dhtmlxToolbar
 * @method showItem
 * @memberOf dhtmlxToolbar
 * @param {String} itemId itemId - id of an item to show
 ...
 * @id dhtmlxToolbar.showListOption
 * @class dhtmlxToolbar
 * @method showListOption
 * @memberOf dhtmlxToolbar
 * @param {String} parentId parentId - id of a select button
 * @param {String} optionId optionId - id of a listed option
 ...
 * @class dhtmlXCombo
 * @method addOption
 * @memberOf dhtmlXCombo
 * @param {String} options value - (variable) - different input for different kinds of options - please refer to examples
 * @example
 */
 ...
 * @id dhtmlXCombo.clearAll
 * @class dhtmlXCombo
 * @method clearAll
 * @memberOf dhtmlXCombo
 * @param {String} all value - (bool) clear current value as well
 * @example
 */
 ...
 * @id dhtmlXCombo.deleteOption
 * @class dhtmlXCombo
 * @method deleteOption
 * @memberOf dhtmlXCombo
 * @param {String} value value - (string) value of option in question
 * @example
 */
...
/**
 * disable combobox
 * @id dhtmlXCombo.disable
 * @class dhtmlXCombo
 * @method disable
 * @memberOf dhtmlXCombo
 * @param {String} mode mode - (boolean) disable combobox
 * @example
 */
 ...
 * @id dhtmlXCombo.enableFilteringMode
 * @class dhtmlXCombo
 * @method enableFilteringMode
 * @memberOf dhtmlXCombo
 * @param {String} mode mode - (boolean) enable filtering mode
 * @param {String} [url] url - (string) url for filtering from XML, optional
 * @param {String} [cache] cache - (boolean) XML caching, optional
 * @param {String} [autosubload] autosubload - (boolean) enable auto load additional suggestions on selecting last loaded option
 * @example
 */
 ...
 * @id dhtmlXCombo.enableOptionAutoHeight
 * @class dhtmlXCombo
 * @method enableOptionAutoHeight
 * @memberOf dhtmlXCombo
 * @param {Boolean} fl flag - (boolean) true/false
 * @param {String} maxHeight maxHeight - (int) height limitation (if a list height is bigger than maxHeight, a vertical scroll appears)
 * @example
 */
 ...
 * @id dhtmlXCombo.enableOptionAutoPositioning
 * @class dhtmlXCombo
 * @method enableOptionAutoPositioning
 * @memberOf dhtmlXCombo
 * @param {Boolean} fl flag - (boolean) true/false
 * @example
 */
 ...
 * @id dhtmlXCombo.enableOptionAutoWidth
 * @class dhtmlXCombo
 * @method enableOptionAutoWidth
 * @memberOf dhtmlXCombo
 * @param {Boolean} fl flag - (boolean) true/false
 * @example
 */
 ...
 * @id dhtmlXCombo.getIndexByValue
 * @class dhtmlXCombo
 * @method getIndexByValue
 * @memberOf dhtmlXCombo
 * @param {String} val value - (string) value of option in question
 * @example
 */
...
/**
 * get Option by index
 * @id dhtmlXCombo.getOptionByIndex
 * @class dhtmlXCombo
 * @method getOptionByIndex
 * @memberOf dhtmlXCombo
 * @param {Number} ind ind - (int) index of option in question
 * @example
 */
...
/**
 * get Option by label
 * @id dhtmlXCombo.getOptionByLabel
 * @class dhtmlXCombo
 * @method getOptionByLabel
 * @memberOf dhtmlXCombo
 * @param {String} value label - (string) label of option in question
 * @example
 */
...
/**
 *
 * @id dhtmlXCombo.getSelectedIndex
 * @class dhtmlXCombo
...
/**
 *
 * @id dhtmlXCombo.getSelectedText
 * @class dhtmlXCombo
...
/**
 *
 * @id dhtmlXCombo.getSelectedValue
 * @class dhtmlXCombo
...
/**
 *
 * @id dhtmlXCombo.loadXML
 * @class dhtmlXCombo
 * @method loadXML
 * @memberOf dhtmlXCombo
 * @param {String} url url - (string) xml url
 * @example
 */
...
/**
 *
 * @id dhtmlXCombo.loadXMLString
 * @class dhtmlXCombo
 * @method loadXMLString
 * @memberOf dhtmlXCombo
 * @param {String} astring astring - (string) xml string
 * @example
 */
 ...
 * @id dhtmlXCombo.readonly
 * @class dhtmlXCombo
 * @method readonly
 * @memberOf dhtmlXCombo
 * @param {String} mode mode - (boolean) readonly mode
 * @param {String} autosearch autosearch - (boolean) true by default
 * @example
 */
 ...
 * @id dhtmlXCombo.render
 * @class dhtmlXCombo
 * @method render
 * @memberOf dhtmlXCombo
 * @param {String} mode mode - (boolean) enable/disable
 * @example
 */
...
/**
 * select option
 * @id dhtmlXCombo.selectOption
 * @class dhtmlXCombo
 * @method selectOption
 * @memberOf dhtmlXCombo
 * @param {Number} ind ind - (int) index of option in question
 * @param {String} [filter] filter - (boolean) enable autocomplit range, optional
 * @param {Boolean} [conf] conf - (boolean) true for real selection, false for pre-selection
 * @example
 */
...
/**
 * sets option checked
 * @id dhtmlXCombo.setChecked
 * @class dhtmlXCombo
 * @method setChecked
 * @memberOf dhtmlXCombo
 * @param {Number} index index - option index
 * @example
 */
 ...
 * @id dhtmlXCombo.setComboText
 * @class dhtmlXCombo
 * @method setComboText
 * @memberOf dhtmlXCombo
 * @param {String} text text - (string) new text label
 * @example
 */
...
/**
 * set text in covmbobox
 * @id dhtmlXCombo.setComboValue
 * @class dhtmlXCombo
 * @method setComboValue
 * @memberOf dhtmlXCombo
 * @param {String} text text - (string) new text label
 * @example
 */
...
/**
 *
 * @id dhtmlXCombo.setDefaultImage
 * @class dhtmlXCombo
 * @method setDefaultImage
 * @memberOf dhtmlXCombo
 * @param {String} url url - url of default image
 * @example
 */
 ...
 * @id dhtmlXCombo.setName
 * @class dhtmlXCombo
 * @method setName
 * @memberOf dhtmlXCombo
 * @param {String} name name - (string) new combobox name
 * @example
 */
 ...
 * @id dhtmlXCombo.setOptionHeight
 * @class dhtmlXCombo
 * @method setOptionHeight
 * @memberOf dhtmlXCombo
 * @param {String} height height - (number) height
 * @example
 */
 ...
 * @id dhtmlXCombo.setOptionWidth
 * @class dhtmlXCombo
 * @method setOptionWidth
 * @memberOf dhtmlXCombo
 * @param {String} width width - (number) width
 * @example
 */
...
/**
 * change control size
 * @id dhtmlXCombo.setSize
 * @class dhtmlXCombo
 * @method setSize
 * @memberOf dhtmlXCombo
 * @param {String} new_size new_size - (int) new size value
 * @example
 */
 ...
 * @id dhtmlXCombo.updateOption
 * @class dhtmlXCombo
 * @method updateOption
 * @memberOf dhtmlXCombo
 * @param {Number} oldvalue oldvalue - (string) index of option in question
 * @param {String} avalue avalue - (variable)
 * @example
 */
...
/**
 *
 * dhtmlXCalendarObject object class.
 * @id dhtmlXCalendarObject
 * @class dhtmlXCalendarObject
 * @constructor
 ...
 * @class dhtmlXCalendarObject
 * @method attachEvent
 * @memberOf dhtmlXCalendarObject
 * @param {String} evName evName - the event name;
 * @param {Function} evHandler several handlers can be attached to one and the same event, and all of them will be executed.
...
/**
 *
 * @id dhtmlXCalendarObject.attachObj
 * @class dhtmlXCalendarObject
 * @method attachObj
 * @memberOf dhtmlXCalendarObject
 * @param {String} input one and the same calendar can be attached to several inputs.
...
/**
 *
 * @id dhtmlXCalendarObject.setInsensitiveDays
 * @class dhtmlXCalendarObject
 * @method setInsensitiveDays
 * @memberOf dhtmlXCalendarObject
 * @param {String} date setSensetiveRange()
...
/**
 *
 * @id dhtmlXCalendarObject.setSensitiveRange
 * @class dhtmlXCalendarObject
 * @method setSensitiveRange
 * @memberOf dhtmlXCalendarObject
 * @param {String} date clearSensitiveRange()
...
/**
 *
 * @id dhtmlXCalendarObject.detachEvent
 * @class dhtmlXCalendarObject
 * @method detachEvent
 * @memberOf dhtmlXCalendarObject
 * @param {String} evId attachEvent()
 * @example var myEvent = myCalendar.attachEvent("onClick", function (){
 *     //event handler code
 * })
 * ..
...
/**
 *
 * @id dhtmlXCalendarObject.detachObj
 * @class dhtmlXCalendarObject
 * @method detachObj
 * @memberOf dhtmlXCalendarObject
 * @param {String} input attachObj()
 * @example <input type="text" id="input1">
 * <input type="text" id="input2">
 * <script>
...
/**
 * Different modes server_side different date formats:
 * @id dhtmlXCalendarObject.disableDays
 * @class dhtmlXCalendarObject
 * @method disableDays
 * @memberOf dhtmlXCalendarObject
 * @param {String} mode mode - (&#039;week&#039;, &#039;month&#039; or &#039;year&#039;) defines the repetition period of the specified dates.
 * @param {String} date enableDays()
...
/**
 *
 * @id dhtmlXCalendarObject.getDate
 * @class dhtmlXCalendarObject
 * @method getDate
 * @memberOf dhtmlXCalendarObject
 * @param {Boolean} isFormatted isFormatted - (boolean) if the parameter is set to &#039;true&#039; the formatted date will be returned. By default is &#039;false&#039;. Optional.
 ...
 * @id dhtmlXCalendarObject.getFormatedDate
 * @class dhtmlXCalendarObject
 * @method getFormatedDate
 * @memberOf dhtmlXCalendarObject
 * @param {String} format format - the custom date format string. If the parameter is omitted, the currently set date format will be used.
 * @param {String} date %d - day as number ( with leading zero );
...
/**
 *
 * @id dhtmlXCalendarObject.hideTime
 * @class dhtmlXCalendarObject
 * @method hideTime
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * @id dhtmlXCalendarObject.loadUserLanguage
 * @class dhtmlXCalendarObject
 * @method loadUserLanguage
 * @memberOf dhtmlXCalendarObject
 * @param {String} lang lang - the language name.
 * @param {String} func func - the function called after language is loaded.
...
/**
 *
 * @id dhtmlXCalendarObject.setDate
 * @class dhtmlXCalendarObject
 * @method setDate
 * @memberOf dhtmlXCalendarObject
 * @param {String} date date - the date you want to make selected.
...
/**
 * Format string can contain any separator character and any element from the following list:
 * @id dhtmlXCalendarObject.setDateFormat
 * @class dhtmlXCalendarObject
 * @method setDateFormat
 * @memberOf dhtmlXCalendarObject
 * @param {String} format %d - day as number ( with leading zero );
...
/**
 *
 * @id dhtmlXCalendarObject.setHolidays
 * @class dhtmlXCalendarObject
 * @method setHolidays
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * @id dhtmlXCalendarObject.setInsensitiveRange
 * @class dhtmlXCalendarObject
 * @method setInsensitiveRange
 * @memberOf dhtmlXCalendarObject
 * @param {String} date clearSensitiveRange()
...
/**
 *
 * @id dhtmlXCalendarObject.setParent
 * @class dhtmlXCalendarObject
 * @method setParent
 * @memberOf dhtmlXCalendarObject
 * @param {String} parent parent - a parent node (container).
...
/**
 *
 * @id dhtmlXCalendarObject.setPosition
 * @class dhtmlXCalendarObject
 * @method setPosition
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * @id dhtmlXCalendarObject.setSkin
 * @class dhtmlXCalendarObject
 * @method setSkin
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * @id dhtmlXCalendarObject.setWeekStartDay
 * @class dhtmlXCalendarObject
 * @method setWeekStartDay
 * @memberOf dhtmlXCalendarObject
 * @param {String} day day - the day you want to start a week. Can take a value from &#039;1&#039; (Monday) to &#039;7&#039; (Sunday).
...
/**
 *
 * @id dhtmlXCalendarObject.showTime
 * @class dhtmlXCalendarObject
 * @method showTime
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * @id dhtmlXCalendarObject.unload
 * @class dhtmlXCalendarObject
 * @method unload
 * @memberOf dhtmlXCalendarObject
...
/**
 *
 * dhtmlXColorPicker object class.
 * @id dhtmlXColorPicker
 * @class dhtmlXColorPicker
 * @constructor
...
/**
 *
 * @id dhtmlXColorPicker.detachEvent
 * @class dhtmlXColorPicker
 * @method detachEvent
 * @memberOf dhtmlXColorPicker
 * @param {String} id id - event id
...
/**
 *
 * @id dhtmlXColorPicker.getSelectedColor
 * @class dhtmlXColorPicker
 ...
 * @id dhtmlXColorPicker.linkTo
 * @class dhtmlXColorPicker
 * @method linkTo
 * @memberOf dhtmlXColorPicker
 * @param {Object} obj1 obj1 - color target
 * @param {Object} obj2 obj2 - action element
 * @param {Object} obj3 obj3 - color value target
 * @example
 */
 ...
 * @id dhtmlXColorPicker.loadUserLanguage
 * @class dhtmlXColorPicker
 * @method loadUserLanguage
 * @memberOf dhtmlXColorPicker
 * @param {String} lang lang - language (ex: en-us|ru)
 * @example
 */
 ...
 * @id dhtmlXColorPicker.setColor
 * @class dhtmlXColorPicker
 * @method setColor
 * @memberOf dhtmlXColorPicker
 * @param {String} rgb rgb - array with decimal values of Red, Green and Blue or string with hex color
 * @example
 */
 ...
 * @id dhtmlXColorPicker.setCustomColors
 * @class dhtmlXColorPicker
 * @method setCustomColors
 * @memberOf dhtmlXColorPicker
 * @param {String} colors colors - array with predefined colors (like #F8560A)
 * @example
 */
...
/**
 *
 * @id dhtmlXColorPicker.setImagePath
 * @class dhtmlXColorPicker
 * @method setImagePath
 * @memberOf dhtmlXColorPicker
 * @example
 ...
 * @id dhtmlXColorPicker.setOnCancelHandler
 * @class dhtmlXColorPicker
 * @method setOnCancelHandler
 * @memberOf dhtmlXColorPicker
 * @param {String} func func - event handling function (or its name)
 * @example
 */
 ...
 * @id dhtmlXColorPicker.setOnSelectHandler
 * @class dhtmlXColorPicker
 * @method setOnSelectHandler
 * @memberOf dhtmlXColorPicker
 * @param {String} func func - event handling function (or its name)
 * @example
 */
...
/**
 * show ColorPicker
 * @id dhtmlXColorPicker.setPosition
 * @class dhtmlXColorPicker
 * @method setPosition
 * @memberOf dhtmlXColorPicker
 * @param {String} x x - (int) position left
 * @param {String} y x - (top) position top
 * @example
 */
 ...
 * @id dhtmlxSlider.enableTooltip
 * @class dhtmlxSlider
 * @method enableTooltip
 * @memberOf dhtmlxSlider
 * @param {String} mode mode - (boolean)
 * @example
 */
 ...
 * @id dhtmlxSlider.linkTo
 * @class dhtmlxSlider
 * @method linkTo
 * @memberOf dhtmlxSlider
 * @param {Object} obj obj - (string|object) linked object id, or linked object itself
 * @example
 */
...
/**
 * set new TO value
 * @id dhtmlxSlider.setMax
 * @class dhtmlxSlider
 * @method setMax
 * @memberOf dhtmlxSlider
 * @param {String} val val - (integer) set new To value
 * @example
 */
...
/**
 * set new FROM value
 * @id dhtmlxSlider.setMin
 * @class dhtmlxSlider
 * @method setMin
 * @memberOf dhtmlxSlider
 * @param {String} val val - (integer) set new From value
 * @example
 */
 ...
 * @id dhtmlxSlider.setOnChangeHandler
 * @class dhtmlxSlider
 * @method setOnChangeHandler
 * @memberOf dhtmlxSlider
 * @param {String} func func - (string|function) user defined function
 * @example
 */
...
/**
 * set new "ST value
 * @id dhtmlxSlider.setStep
 * @class dhtmlxSlider
 * @method setStep
 * @memberOf dhtmlxSlider
 * @param {String} val val - (integer) set new Step value
 * @example
 */
 ...
 * @id dhtmlxSlider.setValue
 * @class dhtmlxSlider
 * @method setValue
 * @memberOf dhtmlxSlider
 * @param {String} val val - (integer) new value
 * @example
 */
...
/**
 *
 * @id dhtmlXEditor.applyStrikethrough
 * @class dhtmlXEditor
 * @method applyStrikethrough
 * @memberOf dhtmlXEditor
 * @example
 */
...
/**
 *
 * @id dhtmlXEditor.applyUnderscore
 * @class dhtmlXEditor
 * @method applyUnderscore
 * @memberOf dhtmlXEditor
 * @example
 */
...
/**
 *
 * @id dhtmlXEditor.createBulList
 * @class dhtmlXEditor
 * @method createBulList
 * @memberOf dhtmlXEditor
 * @example
 */
...
/**
 *
 * @id dhtmlXEditor.createNumList
 * @class dhtmlXEditor
 * @method createNumList
 * @memberOf dhtmlXEditor
 * @example
 */
...
/**
 *
 * @id dhtmlXEditor.decreaseIndent
 * @class dhtmlXEditor
...
/**
 *
 * @id dhtmlXEditor.increaseIndent
 * @class dhtmlXEditor
 ...
 * @id dhtmlXEditor.setContent
 * @class dhtmlXEditor
 * @method setContent
 * @memberOf dhtmlXEditor
 * @param {String} str html - html string which should be set as editor content
 * @example
 */
 ...
 * @id dhtmlXEditor.setContentHTML
 * @class dhtmlXEditor
 * @method setContentHTML
 * @memberOf dhtmlXEditor
 * @param {String} url url - path to the html page
 * @example
 */
...
/**
 *
 * dhtmlXVaultObject object class.
 * @id dhtmlXVaultObject
 * @class dhtmlXVaultObject
 * @constructor
 ...
 * @id dhtmlXVaultObject.create
 * @class dhtmlXVaultObject
 * @method create
 * @memberOf dhtmlXVaultObject
 * @param {Object} htmlObject htmlObject - id of parent html object
 * @example
 */
 ...
 * @id dhtmlXVaultObject.getFileExtension
 * @class dhtmlXVaultObject
 * @method getFileExtension
 * @memberOf dhtmlXVaultObject
 * @param {String} fileName fileName - full file name, for example "c:\dhtmlXVault\readme.txt".
 * @example
 */
...
/**
 * removes an event handler
 * @id dhtmlXVaultObject.detachEvent
 * @class dhtmlXVaultObject
 * @method detachEvent
 * @memberOf dhtmlXVaultObject
 * @param {String} id id - event id
 ...
 * @id dhtmlXVaultObject.onAddFile
 * @class dhtmlXVaultObject
 * @method onAddFile
 * @memberOf dhtmlXVaultObject
 * @param {String} fileName fileName - a file being added by the user. You may check its type and return false to disable adding.
 ...
 * @id dhtmlXVaultObject.onFileUploaded
 * @class dhtmlXVaultObject
 * @method onFileUploaded
 * @memberOf dhtmlXVaultObject
 * @param {String} file file - a single file just uploaded.
 ...
 * @id dhtmlXVaultObject.onUploadComplete
 * @class dhtmlXVaultObject
 * @method onUploadComplete
 * @memberOf dhtmlXVaultObject
 * @param {Object} files files - an array of file objects.
 * @example file = { id: "1", name: "file.name", uploaded: true/false, error: true/false };
 */
 ...
 * @id dhtmlXVaultObject.setFilesLimit
 * @class dhtmlXVaultObject
 * @method setFilesLimit
 * @memberOf dhtmlXVaultObject
 * @param {String} count count - the number of files user can upload at most.
 * @example
 */
 ...
 * @id dhtmlXVaultObject.setFormField
 * @class dhtmlXVaultObject
 * @method setFormField
 * @memberOf dhtmlXVaultObject
 * @param {String} fieldName fieldName - the name of form field you want to add. This field will be posted to the server together with the file contents.
 * @param {String} value value - the value of this field.
 * @example
 */
 ...
 * @id dhtmlXVaultObject.setImagePath
 * @class dhtmlXVaultObject
 * @method setImagePath
 * @memberOf dhtmlXVaultObject
 * @param {String} path path - relative path to the "imgs" folder, usually it is "codebase/imgs/".
 * @example
 */
 ...
 * @id dhtmlXVaultObject.setServerHandlers
 * @class dhtmlXVaultObject
 * @method setServerHandlers
 * @memberOf dhtmlXVaultObject
 * @param {String} uploadHandler uploadHandler - handles file uploading
 * @param {String} getInfoHandler getInfoHandler - handles progress indication
 * @param {String} getIdHandler getIdHandler - handles session initialization
 * @example
 */
 ...
 * @param {String} sid sid - id of item before update
 * @param {String} tid tid - id of item after up0ate
 * @param {String} action action - action name
 * @param {String} btag btag - reference to the xml node
 * @example
 */
 ...
 * @id dataProcessor.checkBeforeUpdate
 * @class dataProcessor
 * @method checkBeforeUpdate
 * @memberOf dataProcessor
 * @param {String} rowId rowId - id of row to set update-status for
 * @example
 */
 ...
 * @id dataProcessor.clearVerificator
 * @class dataProcessor
 * @method clearVerificator
 * @memberOf dataProcessor
 * @param {String} ind ind - column Index (0 based)
 * @example
 */
 ...
 * @id dataProcessor.enableDataNames
 * @class dataProcessor
 * @method enableDataNames
 * @memberOf dataProcessor
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dataProcessor.enablePartialDataSend
 * @class dataProcessor
 * @method enablePartialDataSend
 * @memberOf dataProcessor
 * @param {Boolean} mode mode - true/false
 * @example
 */
 ...
 * @id dataProcessor.enableUTFencoding
 * @class dataProcessor
 * @method enableUTFencoding
 * @memberOf dataProcessor
 * @param {String} mode true - utf based escaping, simple - use current page encoding
 * @example
 */
 ...
 * @id dataProcessor.init
 * @class dataProcessor
 * @method init
 * @memberOf dataProcessor
 * @param {Object} anObj anObj - the object to attach dataProcessor to
 * @example
 */
 ...
 * @id dataProcessor.ignore
 * @class dataProcessor
 * @method ignore
 * @memberOf dataProcessor
 * @param {String} code code - code block, any operation in which, will not cause dataProcessor reaction
 ...
 * @id dataProcessor.sendData
 * @class dataProcessor
 * @method sendData
 * @memberOf dataProcessor
 * @param {String} rowId rowId - id of row which data to send. If not specified, then all "updated" rows will be send
 * @example
 */
 ...
 * @id dataProcessor.setDataColumns
 * @class dataProcessor
 * @method setDataColumns
 * @memberOf dataProcessor
 * @param {Boolean} val val - array or list of true/false values
 * @example
 */
 ...
 * @id dataProcessor.setOnBeforeUpdateHandler
 * @class dataProcessor
 * @method setOnBeforeUpdateHandler
 * @memberOf dataProcessor
 * @param {String} func func - event handling function
 * @example
 */
 ...
 * @id dataProcessor.setTransactionMode
 * @class dataProcessor
 * @method setTransactionMode
 * @memberOf dataProcessor
 * @param {String} mode mode - GET/POST
 * @param {Boolean} total total - true/false - send records row by row or all at once (for grid only)
 * @example
 */
 ...
 * @id dataProcessor.setUpdated
 * @class dataProcessor
 * @method setUpdated
 * @memberOf dataProcessor
 * @param {String} rowId rowId - id of row to set update-status for
 * @param {Boolean} state state - true for "updated", false for "not updated"
 * @param {String} mode mode - update mode name - "inserted","updated","deleted" ("updated" by default)
 * @example
 */
 ...
 * @id dataProcessor.setUpdateMode
 * @class dataProcessor
 * @method setUpdateMode
 * @memberOf dataProcessor
 * @param {String} mode mode - "row" - based on row selection changed, "cell" - based on cell editing finished, "off" - manual data sending
 * @example
 */
 ...
 * @id dataProcessor.setVerificator
 * @class dataProcessor
 * @method setVerificator
 * @memberOf dataProcessor
 * @param {Number} ind ind - column index (0 based)
 * @param {Number} verifFunction verifFunction - function (object) which should verify cell value (if not specified, then value will be compared to empty string). Three arguments will be passed into it: value, row ID and column index
...
/**
 *
 * dhtmlXDataStore object class.
 * @id dhtmlXDataStore
 * @class dhtmlXDataStore
 * @constructor
 ...
 * @class dhtmlXDataStore
 * @method add
 * @memberOf dhtmlXDataStore
 * @param {Object} obj obj - the data object that will be added to the dataset
 * @example myStore.add({
 *           FirstName:"Alex",
 *           LastName:"Fgorle",
 *           Department:"HR",
...
/**
 *
 * @id dhtmlXDataStore.attachEvent
 * @class dhtmlXDataStore
 * @method attachEvent
 * @memberOf dhtmlXDataStore
 * @param {String} evName evName - the event name.
...
/**
 *
 * @id dhtmlXDataStore.copy
 * @class dhtmlXDataStore
 * @method copy
 * @memberOf dhtmlXDataStore
 * @param {String} sid sid - the id of the source item, mandatory
...
/**
 *
 * @id dhtmlXDataStore.detachEvent
 * @class dhtmlXDataStore
 * @method detachEvent
 * @memberOf dhtmlXDataStore
 * @param {String} id id - the id of the handler ( the result of attachEvent() operation )
...
/**
 *
 * @id dhtmlXDataStore.filter
 * @class dhtmlXDataStore
 * @method filter
 * @memberOf dhtmlXDataStore
 * @param {String} key key - the name of a property, or a custom filtering method
...
/**
 *
 * @id dhtmlXDataStore.idByIndex
 * @class dhtmlXDataStore
 * @method idByIndex
 * @memberOf dhtmlXDataStore
 * @param {Number} index index - the index of the item in question
...
/**
 *
 * @id dhtmlXDataStore.load
 * @class dhtmlXDataStore
 * @method load
 * @memberOf dhtmlXDataStore
 * @param {String} url url - the data url (needs to be in the same domain)
 * @param {String} type callback - the callback function
 * @param {Function} callback type - the type of data
...
/**
 *
 * @id dhtmlXDataStore.parse
 * @class dhtmlXDataStore
 * @method parse
 * @memberOf dhtmlXDataStore
 * @param {Object} object object - a string or an object
...
/**
 *
 * @id dhtmlXDataStore.saveBatch
 * @class dhtmlXDataStore
 * @method saveBatch
 * @memberOf dhtmlXDataStore
 * @param {String} func func - the user-defined handler function.
...
/**
 *
 * @id dhtmlXDataStore.sort
 * @class dhtmlXDataStore
 * @method sort
 * @memberOf dhtmlXDataStore
 * @param {String} key key - the name of a property by which DataStore will be sorted or a custom sorting method
 ...
 * @method addEvent
 * @memberOf scheduler
 * @param {Object} start_date start date - date object or string;
 ...
 * @method addEventNow
 * @memberOf scheduler
 * @param {Object} [event_obj] event_obj - object with all event properties you wish to specify, optional
...
/**
 * Method will hide custom form, remove modal cover, and exec after-saving operations if necessary.
 Can be used as part of custom lightbox form.
 * @id scheduler.endLightbox
 * @class scheduler
 * @method endLightbox
 * @memberOf scheduler
 * @param {Boolean} mode result of edit operation, false - cancel, true - data need to be saved
 * @param {String} [custom_form] html container of the form, optional
...
/**
 *
 * @id scheduler.formSection
 * @class scheduler
 * @method formSection
 * @memberOf scheduler
 * @param {String} name name - name of lightbox section
 * @example //get value
 ...
 * @id scheduler.getEventEndDate
 * @class scheduler
 * @method getEventEndDate
 * @memberOf scheduler
 * @param {String} event_id event id
 * @example
 */
 ...
 * @id scheduler.getEventStartDate
 * @class scheduler
 * @method getEventStartDate
 * @memberOf scheduler
 * @param {String} event_id event id
 * @example
 */
 ...
 * @id scheduler.getEvents
 * @class scheduler
 * @method getEvents
 * @memberOf scheduler
 * @param {Object} from from {date object}
 ...
 * @id scheduler.getLabel
 * @class scheduler
 * @method getLabel
 * @memberOf scheduler
 * @param {String} property property - map_to parameter of the option
 ...
 * @method init
 * @memberOf scheduler
 * @param {Object} contaner_id container id - id or object of html container, inside which the scheduler will be created
 * @param {Object} [date] date - js date object, initial date in scheduler, optional - current date will be used by default
 * @param {String} [mode] mode - name of default mode as string ( "month","day","week" ), optional - "week" by default
 * @example
 */
 ...
 * @method load
 * @memberOf scheduler
 * @param {String} url url - the server side url ( may be a static xml or server side script which outputs data as XML )
 * @param {Function} callback type - the type of loading data
 ...
 * @method parse
 * @memberOf scheduler
 * @param {Object} data url - string or object , which represents data
 * @param {Object} type type - data type, can be "json" for loading from json object
 ...
 * @id scheduler.serverList
 * @class scheduler
 * @method serverList
 * @memberOf scheduler
 * @param {String} list_name name of a list
 ...
 * @id scheduler.setCurrentView
 * @class scheduler
 * @method setCurrentView
 * @memberOf scheduler
 * @param {Object} date date - date object, which defines current view date;
 * @param {String} mode mode - string, current view mode;
 * @example
 */
...
/**
 *
 * @id scheduler.setEventEndDate
 * @class scheduler
 * @method setEventEndDate
 * @memberOf scheduler
 * @param {String} event_id event id;
 * @param {Object} end_date new end date ( date object ).
 * @example
 */
 ...
 * @id scheduler.setEventStartDate
 * @class scheduler
 * @method setEventStartDate
 * @memberOf scheduler
 * @param {String} event_id event id;
 * @param {Object} start_date new start date ( date object ).
 * @example
 */
...
/**
 * Method can be used as start part of custom lightbox form, it will block scheduler and show provide html container at center of the screen.
 The pair endLightbox command can be used to hide the custom lightbox form.
 * @id scheduler.startLightbox
 * @class scheduler
 * @method startLightbox
 * @memberOf scheduler
 * @param {String} event_id event id
 * @param {String} custom_form html element of custom form
...
/**
 *
 * @id scheduler.resetLightbox
 * @class scheduler
 * @method resetLightbox
 * @memberOf scheduler
...
/**
 * unselect event
 * @id scheduler.unselect
 * @class scheduler
 * @method unselect
 * @memberOf scheduler
 * @param {String} [event_id] event id - optional, if not provided , then currently selected event will be unselected
 * @example
 */
...
/**
 *
 * @id scheduler.createUnitsView
 * @class scheduler
 * @method createUnitsView
 * @memberOf scheduler
 * @param {String} configuration name - name of view
 * @example var sections=[
...
/**
 * X scale
 * @id scheduler.createTimelineView
 * @class scheduler
 * @method createTimelineView
 * @memberOf scheduler
 * @param {String} configuration name - name of mode, same as name of the tab in html template ( you can have few different timelines, with different name , at the same time )
 ...
 * @id scheduler.addSection
 * @class scheduler
 * @method addSection
 * @memberOf scheduler
 * @param {Object} section_object section object
 * @example scheduler.createTimelineView({
 *         ...
 * 	y_unit: [ 
 * 		{key:10, label:"Web Testing Dep.", open: false, children: [
...
/**
 *
 * @id scheduler.renderCalendar
 * @class scheduler
 * @method renderCalendar
 * @memberOf scheduler
 * @param {Object} [configuration] container - optional, html container, inside each calendar will be rendered; can be ID of html element or HTML object
...
/**
 * Parameters:
 * @id scheduler.destroyCalendar
 * @class scheduler
 * @method destroyCalendar
 * @memberOf scheduler
 * @param {Object} [calendar] calendar - optional, calendar&#039;s object, when called without parameters attempts to destroy last created containerless calendar
...
/**
 *
 * @id scheduler.isCalendarVisible
 * @class scheduler
 * @method isCalendarVisible
 * @memberOf scheduler
...
/**
 *
 * @id scheduler.markCalendar
 * @class scheduler
 * @method markCalendar
 * @memberOf scheduler
 * @param {Object} calendar calendar - calendar object
 * @param {Object} date date - date object, defines date which need to be marked
 * @param {String} [css] css - optional, css class which will be used for marking
 ...
 * @memberOf scheduler
 * @param {Object} calendar calendar - calendar object
 * @param {Object} date date - date object, defines date which need to be unmarked
 * @param {String} [css] css - optional, css class which was used for marking
...
/**
 * Parameters:
 * @id scheduler.updateCalendar
 * @class scheduler
 * @method updateCalendar
 * @memberOf scheduler
 * @param {Object} calendar calendar - calendar object, which was created by renderCalendar
 * @param {String} new_date new_date  - new date, which need to be rendered in mini-calendar
...
/**
 * Parameters:
 * @id scheduler.linkCalendar
 * @class scheduler
 * @method linkCalendar
 * @memberOf scheduler
 * @param {String} calendar calendar - calendar which was created with renderCalendar call
 * @param {String} shift shift - allows to define how date in mini-calendar will differ from one in scheduler
 * @example var calendar = scheduler.renderCalendar(...);
 ...
 * @method toICal
 * @memberOf scheduler
 * @param {String} url url - url of server side part of PDF converter
 * @param {String} [mode] mode - optional, color mode, can be "color","gray","bw"
 ...
 * @method toICal
 * @memberOf scheduler
 * @param {String} [header] header - optional text string, which will be used as calendar&#039;s name
 ...
 * @id scheduler.getRecDates
 * @class scheduler
 * @method getRecDates
 * @memberOf scheduler
 * @param {String} event_id event_id - id of the recurring event
 * @param {String} maximum_number start_date
...
/**
 *
 * @id scheduler.blockTime
 * @class scheduler
 * @method blockTime
 * @memberOf scheduler
 * @param {Object} date date - js date object, or number ( if number provided - it will be treated as day of week )
