...
YAHOO.util.CustomEvent.prototype = {subscribe:function (fn, obj, bOverride) {
...
if (!YAHOO.util.Event) {
    YAHOO.util.Event = function () {
        ...
        var legacyEvents = [];
        var legacyHandlers = [];
        return{EL:0, TYPE:1, FN:2, WFN:3, SCOPE:3, ADJ_SCOPE:4, isSafari:(navigator.userAgent.match(/safari/gi)), isIE:(!this.isSafari && navigator.userAgent.match(/msie/gi)), addListener:function (el, sType, fn, oScope, bOverride) {
            ...
            return((!el.addEventListener && !el.attachEvent) || (sType == "click" && this.isSafari));
