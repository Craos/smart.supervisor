...
dhtmlXGridCellObject.prototype = {getAttribute:function (a) {
...
function eXcell_ch(a) {
    ...
    this.changeState = function (a) {
        ...
        if (this.grid.isEditable && !this.cell.parentNode._locked && !this.isDisabled())this.grid.callEvent("onEditCell", [0, this.cell.parentNode.idd, this.cell._cellIndex]) ? (this.val = this.getValue(), this.val == "1" ? this.setValue("0") : this.setValue("1"), this.cell.wasChanged = !0, this.grid.callEvent("onEditCell", [1, this.cell.parentNode.idd, this.cell._cellIndex]), this.grid.callEvent("onCheckbox", [this.cell.parentNode.idd, this.cell._cellIndex, this.val !=
            "1"]), this.grid.callEvent("onCheck", [this.cell.parentNode.idd, this.cell._cellIndex, this.val != "1"])) : this.editor = null
    };
    this.getValue = function () {
...
function eXcell_txt(a) {
    ...
    this.edit = function () {
        ...
        this.obj.onkeydown = function (a) {
            var b = a || event;
            if (b.keyCode == 9)return globalActiveDHTMLGridObject.entBox.focus(), globalActiveDHTMLGridObject.doKey({keyCode:b.keyCode, shiftKey:b.shiftKey, srcElement:"0"}), !1
        };
    ...
    this.detach = function () {
        var a = "", a = _isFF ? this.obj.firstChild.value : this.obj.value;
...
function eXcell_co(a) {
    ...
    this.edit = function () {
        ...
        this.obj.onkeyup = function (a) {
            ...
            if (!(b == 38 || b == 40 || b == 9))for (var d = this.readonly ? String.fromCharCode(b) : this.value, f = c.list.options, e = 0; e < f.length; e++)if (f[e].text.indexOf(d) == 0)return f[e].selected = !0
        };
        ...
        this.list.onclick =
            function (a) {
                var b = a || window.event, d = b.target || b.srcElement;
        ...
        if (!this.editable)this.obj.style.visibility = "hidden", this.list.focus(), this.list.onkeydown = function (a) {
            a = a || window.event;
            c.grid.setActive(!0);
            if (a.keyCode < 30)return c.grid.doKey({target:c.cell, keyCode:a.keyCode, shiftKey:a.shiftKey, ctrlKey:a.ctrlKey})
        }
    };
    this.getValue = function () {
    ...
    this.detach = function () {
        ...
        if (this.list.parentNode != null)if (this.editable) {
            var a = this.list.options[this.list.selectedIndex];
            if (a && a.text == this.obj.value)this.setValue(this.list.value); else {
...
function eXcell_cp(a) {
    ...
    this.colorPanel = function (a, b) {
        ...
        g.onclick = function (a) {
            var b = a || window.event, c = b.target || b.srcElement, d = c.parentNode.parentNode.parentNode.editor_obj;
            d.setValue(c._bg);
            d.grid.editStop()
        };
        for (var e = 256 / a, f = 0; f <= 256 / e; f++)for (var l = g.insertRow(f), i = 0; i <= 256 / e; i++)for (var j = 0; j <= 256 / e; j++) {
            R = new Number(e * f) - (f == 0 ? 0 : 1);
            G = new Number(e * i) - (i == 0 ? 0 : 1);
            B = new Number(e * j) - (j == 0 ? 0 : 1);
            var k =
                this.toolDNum(R.toString(16)) + "" + this.toolDNum(G.toString(16)) + "" + this.toolDNum(B.toString(16)), h = l.insertCell(i);
            h.width = "10px";
            h.innerHTML = "&nbsp;";
...
function eXcell_img(a) {
    ...
    this.getValue = function () {
        if (this.cell.firstChild.tagName == "IMG")return this.cell.firstChild.src + (this.cell.titFl != null ? "^" + this.cell._brval : ""); else if (this.cell.firstChild.tagName == "A") {
...
eXcell_img.prototype.setValue = function (a) {
    var b = a;
    if (a.indexOf("^") != -1) {
        var c = a.split("^"), a = c[0], b = this.cell._attrs.title || c[1];
...
eXcell_dyn.prototype.setValue = function (a) {
    ...
    if (a > 0)var b = "green", c = "dyn_up.gif"; else a == 0 ? (b = "black", c = "dyn_.gif") : (b = "red", c = "dyn_down.gif");
...
function dhtmlXGridComboObject() {
    ...
    this.put = function (a, b) {
        for (var c = 0; c < this.keys.length; c++)if (this.keys[c] == a)return this.values[c] = b, !0;
    ...
    this.remove = function (a) {
        for (var b = 0; b < this.keys.length; b++)if (this.keys[b] ==
