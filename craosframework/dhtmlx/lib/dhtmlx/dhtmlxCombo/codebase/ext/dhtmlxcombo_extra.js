...
dhtmlXCombo_imageOption.prototype.render = function () {
    if (!this.content) {
        ...
        var a = "";
        this.img_src != "" && (a += '<img style="float:left;" src="' + this.img_src + '" />');
...
dhtmlXCombo_imageOption.prototype.RedrawHeader = function (a, b) {
    a.DOMelem_image.style.visibility = b ? "hidden" : "visible";
    a.DOMelem_image.src = b ? "" : this.img_src
};
...
dhtmlXCombo_checkboxOption.prototype.render = function () {
    if (!this.content) {
        ...
        this.content.style.cssText = "width:100%; overflow:hidden; " + this.css;
        var a = "";
        a += this.checked ? '<input style="float:left;" type="checkbox" checked   />' : '<input style="float:left;" type="checkbox" />';
        a += '<div style="float:left">' + this.text + "</div>";
        this.content.innerHTML = a;
        this.content.firstChild.onclick = function (a) {
            this.parentNode.parentNode.combo.DOMelem_input.focus();
            (a || event).cancelBubble = !0;
            if (!this.parentNode.parentNode.combo.callEvent("onCheck", [this.parentNode._self.value, this.checked]))return this.checked = !this.checked, !1
        }
    }
    return this.content
};
...
dhtmlXCombo_checkboxOption.prototype._DrawHeaderCheckbox = function (a) {
    ...
    b.onclick = function (c) {
        ...
        d != -1 && (a.setChecked(d, b.checked), a.callEvent("onCheck", [a.getActualValue(), a.optionsArr[d].content.firstChild.checked]));
...
dhtmlXCombo_checkboxOption.prototype.RedrawHeader = function (a, b) {
    a.DOMelem_checkbox.style.visibility = b ? "hidden" : "";
    a.DOMelem_checkbox.checked = b ? !1 : this.content.firstChild.checked
};
...
dhtmlXCombo.prototype.setChecked = function (a, b) {
    ...
    this._selOption == this.optionsArr[a] && this._selOption.RedrawHeader(this)
};
