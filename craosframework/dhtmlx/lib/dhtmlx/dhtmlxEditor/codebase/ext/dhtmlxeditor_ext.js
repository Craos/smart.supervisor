...
dhtmlXEditor.prototype.initDhtmlxToolbar = function () {
    ...
    if (this.skin == "dhx_skyblue")this.tb.base.style.borderLeft = "none", this.tb.base.style.borderRight = "none", this.tb.base.style.top = "-1px";
    this.setSizes();
    this.tb.setIconsPath(this.iconsPath + "dhxeditor_" + this.skin + "/");
    this._availFonts = "Arial,Arial Narrow,Comic Sans MS,Courier,Georgia,Impact,Tahoma,Times New Roman,Verdana".split(",");
    this._initFont = this._availFonts[0];
    this._xmlFonts = "";
    for (var d =
        0; d < this._availFonts.length; d++) {
        var h = String(this._availFonts[d]).replace(/\s/g, "_");
    ...
    this._xmlSizes = "";
    for (var f in this._availSizes)this._xmlSizes += '<item type="button" id="applyFontSize:' +
        f + ":" + this._availSizes[f] + '" text="' + this._availSizes[f] + '"/>';
    ...
    this._checkAlign = function (a) {
        this.tb.setItemState("alignCenter", !1);
        this.tb.setItemState("alignRight", !1);
        this.tb.setItemState("alignJustify", !1);
        this.tb.setItemState("alignLeft", !1);
        a && this.tb.setItemState(a, !0)
    };
    this._checkH = function (a) {
        this.tb.setItemState("applyH1", !1);
        this.tb.setItemState("applyH2", !1);
        this.tb.setItemState("applyH3", !1);
        this.tb.setItemState("applyH4", !1);
        a && this.tb.setItemState(a, !0)
    };
    this._doOnFocusChanged = function (a) {
        ...
        } else this.tb.setItemState("applyBold", !1);
        var c = "alignLeft";
        String(a.textAlign).search(/center/) != -1 && (c = "alignCenter");
        String(a.textAlign).search(/right/) != -1 && (c = "alignRight");
        String(a.textAlign).search(/justify/) != -1 && (c = "alignJustify");
        this.tb.setItemState(c, !0);
        this._checkAlign(c);
        this.tb.setItemState("applyH1", a.h1);
        this.tb.setItemState("applyH2", a.h2);
        this.tb.setItemState("applyH3",
            a.h3);
        this.tb.setItemState("applyH4", a.h4);
        if (window._KHTMLrv)a.sub = a.vAlign == "sub", a.sup = a.vAlign == "super";
        this.tb.setItemState("applyItalic", a.fontStyle == "italic");
        this.tb.setItemState("applyStrikethrough", a.del);
        this.tb.setItemState("applySub", a.sub);
        this.tb.setItemState("applySuper", a.sup);
        this.tb.setItemState("applyUnderscore", a.u)
    };
    this._doOnToolbarClick = function (a) {
        var b = String(a).split(":");
        this[b[0]] != null && typeof this[b[0]] == "function" && (this[b[0]](b[1]), this.callEvent("onToolbarClick",
            [a]))
    };
    ...
    this._doOnBeforeStateChange = function (a, b) {
        return(a == "alignLeft" || a == "alignCenter" || a == "alignRight" || a == "alignJustify") && b == !0 ? !1 : !0
    };
    var g = this;
    this.tb.attachEvent("onClick", function (a) {
        g._doOnToolbarClick(a)
    });
    this.tb.attachEvent("onStateChange",
        function (a, b) {
            g._doOnStateChange(a, b)
        });
    this.tb.attachEvent("onBeforeStateChange", function (a, b) {
        return g._doOnBeforeStateChange(a, b)
    });
    ...
    this.clearFormatting = function () {
        ...
        this.tb.setItemState("applyBold", !1);
        this.tb.setItemState("applyItalic", !1);
        this.tb.setItemState("applyStrikethrough", !1);
        this.tb.setItemState("applySub", !1);
        this.tb.setItemState("applySuper", !1);
        this.tb.setItemState("applyUnderscore", !1)
    };
    this.getParentByTag =
        function (a, b) {
            var b = b.toLowerCase(), c = a;
            do if (b == "" || c.nodeName.toLowerCase() == b)return c; while (c = c.parentNode);
            return a
        };
    this.isStyleProperty = function (a, b, c, d) {
        var b = b.toLowerCase(), e = a;
        do if (e.nodeName.toLowerCase() == b && e.style[c] == d)return!0; while (e = e.parentNode);
        return!1
    };
