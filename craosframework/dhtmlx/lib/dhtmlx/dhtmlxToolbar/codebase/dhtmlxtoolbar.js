...
function dhtmlXToolbarObject(b, c) {
    var a = this;
    for (this.cont = typeof b != "object" ? document.getElementById(b) : b; this.cont.childNodes.length > 0;)this.cont.removeChild(this.cont.childNodes[0]);
    this.cont.dir = "ltr";
    ...
    this.setAlign = function (a) {
        ...
        if (this._spacer)this._spacer.className = "dhxtoolbar_spacer " + (a == "right" ? " float_left" : " float_right")
    };
    this._isIE6 = !1;
    if (_isIE)this._isIE6 = window.XMLHttpRequest == null ? !0 : !1;
    if (this._isIPad = navigator.userAgent.search(/iPad/gi) >= 0)this.cont.ontouchstart = function (a) {
        a = a || event;
        a.returnValue = !1;
        a.cancelBubble = !0;
        return!1
    ...
    this._improveTerraceSkin = function (a) {
        var b = null;
        a != null && (b = {}, b[a] = a);
        var g = {buttonInput:!0, separator:!0, text:!0}, f;
        for (f in b || this.objPull)if (this.objPull[f] != null && this.objPull[f].obj != null) {
            if (this.objPull[f].type == "buttonInput")this.objPull[f].obj.className = this.objPull[f].obj.className.replace(/dhx_toolbar_btn/, "dhx_toolbar_inp");
            var i = this.objPull[f][this.objPull[f].type == "buttonSelect" ? "arw" : "obj"], c = !1, j = !1;
            if (!g[this.objPull[f].type]) {
                i == i.parentNode.lastChild && (c = !0);
                if (i.nextSibling != null) {
                    var h = null, l;
                    for (l in this.objPull)if (this.objPull[l].obj == i.nextSibling)h = this.objPull[l].type;
                    g[h] && (c = !0)
                }
                this.objPull[f].obj == i.parentNode.firstChild && (j = !0);
                if (this.objPull[f].obj.previousSibling != null) {
                    h = null;
                    for (l in this.objPull)if (this.objPull[l].obj == this.objPull[f].obj.previousSibling)h = this.objPull[l].type;
                    g[h] && (j = !0)
                }
            }
            i.style.borderRight =
    ...
    this.setSkin = function (a, b) {
        if (b === !0)this.cont.className = this.cont.className.replace(/dhx_toolbar_base_\d{1,}_/, "dhx_toolbar_base_" + this.iconSize + "_"); else {
            this.skin = a;
            if (this.skin == "dhx_skyblue")this.selectPolygonOffsetTop = 1;
            if (this.skin == "dhx_web")this.selectPolygonOffsetLeft = this.selectPolygonOffsetTop = 1;
        ...
        for (var c in this.objPull) {
            ...
            if (f.type == "slider")f.pen._detectLimits(), f.pen._definePos(), f.label.className = "dhx_toolbar_slider_label_" + this.skin + (this.rtl ? " rtl" : "");
            if (f.type == "buttonSelect")f.polygon.className = "dhx_toolbar_poly_" + this.iconSize + "_" + this.skin + (this.rtl ? " rtl" : "")
        }
    ...
    this.loadXML = function (a, b) {
        if (b != null)this._doOnLoad = function () {
            b()
        };
    ...
    this._addItemToStorage = function (a, b) {
        var c = a.id || this._genStr(24), f = a.type || "";
        if (f !=
            "" && this["_" + f + "Object"] != null) {
            if ((typeof a.openAll == "undefined" || a.openAll == null) && this.skin == "dhx_terrace")a.openAll = !0;
            this.objPull[this.idPrefix + c] = new this["_" + f + "Object"](this, c, a);
            this.objPull[this.idPrefix + c].type = f;
            this.setPosition(c, b)
        }
        if (a.userdata)for (var i = 0; i < a.userdata.length; i++)this.setUserData(c, a.userdata[i].name, a.userdata[i].value)
    };
    this._genStr = function (a) {
        for (var b = "", c = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", f = 0; f < a; f++)b += c.charAt(Math.round(Math.random() *
            (c.length - 1)));
        return b
    };
    ...
    this._getObj = function (a, b) {
        for (var c = null, f = 0; f < a.childNodes.length; f++)a.childNodes[f].tagName != null && String(a.childNodes[f].tagName).toLowerCase() == String(b).toLowerCase() && (c = a.childNodes[f]);
        return c
    };
    ...
    this._enableItem = function (a) {
        if (!a.state) {
            ...
            if (a.arw)a.arw.className = String(a.obj.className).replace("btn",
                "arw");
    ...
    this._disableItem = function (a) {
        if (a.state) {
            ...
            if (a.arw)a.arw.className = String(a.obj.className).replace("btn", "arw");
            var b = this._getObj(a.obj, "img");
            ...
            if (a.polygon != null && a.polygon.style.display != "none") {
                ...
                if (a.polygon._ie6cover)a.polygon._ie6cover.style.display = "none";
        ...
        a.forEachItem(function (b) {
            if (a.objPull[a.idPrefix +
                ...
                if (c.polygon.style.display != "none") {
                    ...
                    if (c.polygon._ie6cover)c.polygon._ie6cover.style.display = "none";
    ...
    if (this._spacer != null) {
        ...
        if (this._spacer == this.objPull[c].obj.parentNode) {
            for (var a = !0; a;) {
                ...
                if (d == b || this._spacer.childNodes.length == 0)this.objPull[c].arw != null && this.base.appendChild(this.objPull[c].arw), a = !1
            }
            this._spacer.idd = b;
            this._fixSpacer();
            return
        ...
        for (var f = null, g = 0; g < this.base.childNodes.length; g++)this.base.childNodes[g] == this.objPull[this.idPrefix + b].obj && (f = g,
        ...
        if (f != null) {
            ...
            for (this._spacer.idd = b; this.base.childNodes.length > f + 1;)this._spacer.appendChild(this.base.childNodes[f + 1]);
...
dhtmlXToolbarObject.prototype.getType = function (b) {
    ...
    if (c != null) {
        var a = null, d = this.objPull[this.idPrefix + c]._listOptions[b];
        d != null && (a = d.sep != null ? "buttonSelectSeparator" : "buttonSelectButton");
        return a
    } else return this.objPull[this.idPrefix + b] == null ? null : this.objPull[this.idPrefix + b].type
};
...
dhtmlXToolbarObject.prototype.getParentId = function (b) {
    var c = null, a;
    for (a in this.objPull)if (this.objPull[a]._listOptions)for (var d in this.objPull[a]._listOptions)d == b && (c = String(a).replace(this.idPrefix, ""));
    return c
};
...
dhtmlXToolbarObject.prototype.addButton = function (b, c, a, d, e) {
    this._addItem({id:b, type:"button", text:a, img:d, imgdis:e}, c)
};
dhtmlXToolbarObject.prototype.addText = function (b, c, a) {
    this._addItem({id:b, type:"text", text:a}, c)
};
dhtmlXToolbarObject.prototype.addButtonSelect = function (b, c, a, d, e, g, f, i, k) {
    ...
    this._addItem({id:b, type:"buttonSelect", text:a, img:e, imgdis:g, renderSelect:f, openAll:i, items:j, maxOpen:k}, c)
};
dhtmlXToolbarObject.prototype.addButtonTwoState = function (b, c, a, d, e) {
    this._addItem({id:b, type:"buttonTwoState", img:d, imgdis:e, text:a}, c)
};
dhtmlXToolbarObject.prototype.addSeparator = function (b, c) {
    this._addItem({id:b, type:"separator"}, c)
};
dhtmlXToolbarObject.prototype.addSlider = function (b, c, a, d, e, g, f, i, k) {
    this._addItem({id:b, type:"slider", length:a, valueMin:d, valueMax:e, valueNow:g, textMin:f, textMax:i, toolTip:k}, c)
};
dhtmlXToolbarObject.prototype.addInput = function (b, c, a, d) {
    this._addItem({id:b, type:"buttonInput", value:a, width:d}, c)
};
...
dhtmlXToolbarObject.prototype._getPosition = function (b) {
    if (this.objPull[this.idPrefix + b] == null)return null;
    for (var c = null, a = 0, d = 0; d < this.base.childNodes.length; d++)this.base.childNodes[d].idd != null && (this.base.childNodes[d].idd == b && (c = a), a++);
    if (!c && this._spacer != null)for (d = 0; d < this._spacer.childNodes.length; d++)this._spacer.childNodes[d].idd != null && (this._spacer.childNodes[d].idd == b && (c = a), a++);
    return c
};
...
dhtmlXToolbarObject.prototype._setPosition = function (b, c) {
    if (this.objPull[this.idPrefix + b] != null) {
        if (isNaN(c))c = this.base.childNodes.length;
        c < 0 && (c = 0);
        var a = null;
        if (this._spacer)a = this._spacer.idd, this.removeSpacer();
...
dhtmlXToolbarObject.prototype._getIdByPosition = function (b, c) {
    for (var a = null, d = 0, e = 0, g = 0; g < this.base.childNodes.length; g++)this.base.childNodes[g].idd != null && a == null && d++ == b && (a = this.base.childNodes[g].idd), a == null && e++;
    e = a == null ? null : e;
    return c == !0 ? [a, e] : a
};
...
dhtmlXToolbarObject.prototype._removeItem = function (b) {
    ...
    if (c == "buttonTwoState")a.obj._doOnMouseOver = null, a.obj._doOnMouseOut = null, a.obj.onmouseover = null, a.obj.onmouseout = null, a.obj.onmousedown = null, a.obj.onselectstart = null, a.obj.renderAs = null, a.obj.idd = null, a.obj.parentNode.removeChild(a.obj),
    ...
    if (c == "buttonSelect") {
        for (var d in a._listOptions)this.removeListOption(b, d);
        a._listOptions = null;
        if (a.polygon._ie6cover)document.body.removeChild(a.polygon._ie6cover),
    ...
    if (c == "buttonInput")a.obj.childNodes[0].onkeydown = null, a.obj.removeChild(a.obj.childNodes[0]), a.obj.w = null, a.obj.idd = null, a.obj.parentNode.removeChild(a.obj), a.obj = null, a.id = null, a.type = null, a.enableItem = null, a.disableItem = null, a.isEnabled = null, a.showItem = null, a.hideItem = null, a.isVisible = null, a.setItemToolTip = null, a.getItemToolTip = null, a.setWidth = null, a.getWidth = null, a.setValue = null, a.getValue = null, a.setItemText =
    ...
    if (c == "slider") {
        ...
        a.label = null;
        a.obj.onselectstart = null;
        for (a.obj.idd = null; a.obj.childNodes.length > 0;)a.obj.removeChild(a.obj.childNodes[0]);
        a.obj.parentNode.removeChild(a.obj);
        a.obj = null;
        a.id = null;
        a.type = null;
    ...
    if (c == "separator")a.obj.onselectstart = null, a.obj.idd = null, a.obj.parentNode.removeChild(a.obj), a.obj = null, a.id = null, a.type = null, a.showItem = null, a.hideItem = null, a.isVisible = null;
    if (c == "text")a.obj.onselectstart =
...
(function () {
    for (var b = "addListOption,removeListOption,showListOption,hideListOption,isListOptionVisible,enableListOption,disableListOption,isListOptionEnabled,setListOptionPosition,getListOptionPosition,setListOptionText,getListOptionText,setListOptionToolTip,getListOptionToolTip,setListOptionImage,getListOptionImage,clearListOptionImage,forEachListOption,getAllListOptions,setListOptionSelected,getListOptionSelected".split(","), c = function (a) {
        return function (b, f, d, c, j, h) {
            b = this.idPrefix + b;
            if (this.objPull[b] !=
                null)return this.objPull[b].type != "buttonSelect" ? void 0 : this.objPull[b][a].call(this.objPull[b], f, d, c, j, h)
        }
    }, a = 0; a < b.length; a++) {
        var d = b[a];
...
dhtmlXToolbarObject.prototype._separatorObject = function (b, c, a) {
    ...
    if (b._isIPad)this.obj.ontouchstart = function (a) {
        a = a || event;
        a.returnValue = !1;
        a.cancelBubble = !0;
        return!1
...
dhtmlXToolbarObject.prototype._buttonObject = function (b, c, a) {
    ...
    this.obj._doOnMouseOver = function () {
        this.allowClick = !0;
        if (d.state != !1 && b.anyUsed == "none")this.renderAs = this.className = "dhx_toolbar_btn over"
    };
    this.obj._doOnMouseOut = function () {
        this.allowClick = !1;
        if (d.state != !1 && b.anyUsed == "none")this.className = "dhx_toolbar_btn def", this.renderAs = this.renderAs
    };
    this.obj.onclick = function (a) {
        if (d.state != !1 && this.allowClick != !1) {
            var a = a || event, c = this.idd.replace(b.idPrefix, "");
    ...
    this.obj[b._isIPad ? "ontouchstart" : "onmousedown"] = function (a) {
        if (d.state == !1)return a = a || event, a.returnValue = !1, a.cancelBubble = !0, !1;
        if (b.anyUsed == "none")return b.anyUsed = this.idd, this.className = "dhx_toolbar_btn pres", this.pressed = !0, this.onmouseover = function () {
            this._doOnMouseOver()
    ...
    if (b._isIPad)this.obj.ontouchmove = function () {
        this._doOnMouseUp()
    };
...
dhtmlXToolbarObject.prototype._buttonSelectObject = function (b, c, a) {
    ...
    if (this.mode == "select") {
        if (this.openAll = !0, this.renderSelect = !1, !a.text || a.text.length == 0)a.text = "&nbsp;"
    ...
    this.obj.onmouseover = function (a) {
        a = a || event;
        if (b.anyUsed == "none" && d.state)d.obj.renderAs =
            "dhx_toolbar_btn over", d.obj.className = d.obj.renderAs, d.arw.className = String(d.obj.renderAs).replace("btn", "arw")
    };
    this.obj.onmouseout = function () {
        d.obj.allowClick = !1;
        if (b.anyUsed == "none" && d.state)d.obj.renderAs = "dhx_toolbar_btn def", d.obj.className = d.obj.renderAs, d.arw.className = String(d.obj.renderAs).replace("btn", "arw"), d.callEvent = !1
    };
    this.arw.onmouseover = this.obj.onmouseover;
    this.arw.onmouseout = this.obj.onmouseout;
    if (this.openAll != !0)this.obj.onclick = function (a) {
        a = a || event;
        if (d.obj.allowClick &&
        ...
        a = a || event;
        if (b.anyUsed == "none" && d.state)d.obj.allowClick = !0, d.obj.className = "dhx_toolbar_btn pres", d.arw.className = "dhx_toolbar_arw pres", d.callEvent = !0
    ...
    if (b._isIPad)this.obj.ontouchmove = this.obj.onmouseout;
    this.arw[b._isIPad ? "ontouchstart" : "onmousedown"] = function (a) {
        ...
        if (d.state) {
            if (b.anyUsed == d.obj.idd) {
                ...
                if (d.polygon._ie6cover)d.polygon._ie6cover.style.display =
                    "none";
                ...
                var e = getAbsoluteTop(d.obj) + d.obj.offsetHeight + b.selectPolygonOffsetTop, g = d.polygon.offsetHeight;
                if (e + g > b.tY2) {
                ...
                if (d.polygon._ie6cover)d.polygon._ie6cover.style.left = d.polygon.style.left, d.polygon._ie6cover.style.top = d.polygon.style.top, d.polygon._ie6cover.style.width = d.polygon.offsetWidth + "px", d.polygon._ie6cover.style.height =
    ...
    if (this.openAll === !0 && (this.obj.onclick = this.arw.onclick, this.obj.onmousedown = this.arw.onmousedown, this.obj.onmouseup = this.arw.onmouseup, b._isIPad))this.obj.ontouchstart = this.arw.ontouchstart, this.obj.ontouchend = this.arw.ontouchend;
    ...
    this._fixMaxOpenHeight = function (a) {
        ...
        if (a !== null) {
            var g = 0, h;
            for (h in this._listOptions)g++;
            g > a ? (this._ph = 22 * a, c = this._ph + "px") : e = !0
        }
        this.polygon.style.width = "auto";
        this.polygon.style.height = "auto";
        if (!e && d.maxOpen != null)this.polygon.style.width = this.p_tbl.offsetWidth + b._sbw + "px", this.polygon.style.height = c
    };
    ...
    this._buttonButtonSelectObject = function (a, c, e) {
        ...
        if (c.userdata)this.obj.userData = c.userdata;
        ...
        if (c.img != null)this.obj.td_a.innerHTML = "<img class='btn_sel_img' src='" + b.imagePath + c.img + "' border='0'>", this.obj.tr._img = c.img;
        ...
        this.obj.tr[b._isIPad ?
            ...
            if (this.en && (!this._selected || !d.renderSelect))this.className = "tr_btn tr_btn_over"
        };
        this.obj.tr.onmouseout = function () {
            if (this.en)if (this._selected && d.renderSelect) {
                if (String(this.className).search("tr_btn_selected") == -1)this.className = "tr_btn tr_btn_selected"
            } else this.className = "tr_btn"
        };
        this.obj.tr[b._isIPad ? "ontouchend" : "onclick"] = function (a) {
            ...
            if (this.en) {
                ...
                d.arw.className = String(d.obj.renderAs).replace("btn", "arw");
                d.polygon.style.display = "none";
                if (d.polygon._ie6cover)d.polygon._ie6cover.style.display = "none";
                b.skin == "dhx_terrace" && b._improveTerraceButtonSelect(d.id, !0);
                b.anyUsed = "none";
    ...
    if (b._isIPad)this.polygon.ontouchstart = function (a) {
        a = a || event;
        a.returnValue = !1;
        a.cancelBubble = !0;
        return!1
    ...
    if (a.items)for (var e = 0; e < a.items.length; e++) {
    ...
    if (b._isIE6)this.polygon._ie6cover = document.createElement("IFRAME"), this.polygon._ie6cover.frameBorder = 0, this.polygon._ie6cover.style.position = "absolute", this.polygon._ie6cover.style.border =
    ...
    this.addListOption = function (a, b, c, d, e) {
        if (c == "button" || c == "separator") {
            var g = {id:a, type:c, text:d, img:e};
    ...
    this.removeListOption = function (a) {
        if (this._isListButton(a, !0)) {
            ...
            if (b.td_a != null && b.td_b != null) {
                ...
                for (b.td_b.onselectstart = null; b.td_a.childNodes.length > 0;)b.td_a.removeChild(b.td_a.childNodes[0]);
                ...
                for (b.tr.onclick = null; b.tr.childNodes.length > 0;)b.tr.removeChild(b.tr.childNodes[0]);
                ...
                b.td.onselectstart =
                    null;
                for (b.tr.onselectstart = null; b.td.childNodes.length > 0;)b.td.removeChild(b.td.childNodes[0]);
    ...
    this.showListOption = function (a) {
        if (this._isListButton(a, !0))this._listOptions[a].tr.style.display = ""
    };
    ...
    this.enableListOption = function (a) {
        if (this._isListButton(a))this._listOptions[a].tr.en = !0, this._listOptions[a].tr.className = "tr_btn" + (this._listOptions[a].tr._selected && b.renderSelect ? " tr_btn_selected" : "")
    };
    this.disableListOption = function (a) {
        if (this._isListButton(a))this._listOptions[a].tr.en = !1, this._listOptions[a].tr.className = "tr_btn tr_btn_disabled"
    };
    ...
    this.getListOptionPosition = function (a) {
        ...
        for (var c = 0; c < this.p_tbody.childNodes.length; c++)this.p_tbody.childNodes[c] ==
    ...
    this.setListOptionImage = function (a, c) {
        if (this._isListButton(a)) {
            ...
            if (d.childNodes.length > 0)d.childNodes[0].src = b.imagePath + c; else {
    ...
    this.getListOptionImage = function (a) {
        if (this._isListButton(a)) {
            var c = this._listOptions[a].tr.childNodes[b.rtl ? 1 : 0], d = null;
            if (c.childNodes.length > 0)d = c.childNodes[0].src;
            c =
                null;
            return d
        }
    ...
    this.clearListOptionImage = function (a) {
        if (this._isListButton(a)) {
            for (var c = this._listOptions[a].tr.childNodes[b.rtl ? 1 : 0]; c.childNodes.length > 0;)c.removeChild(c.childNodes[0]);
            c = null
        }
    };
    this.setListOptionText = function (a, c) {
        if (this._isListButton(a))this._listOptions[a].tr.childNodes[b.rtl ? 0 : 1].childNodes[0].innerHTML = c
    };
    ...
    this.setListOptionToolTip =
        function (a, b) {
            if (this._isListButton(a))this._listOptions[a].tr.title = b
        };
    ...
    this.getAllListOptions = function () {
        var a = [], b;
        for (b in this._listOptions)a[a.length] = b;
        return a
    };
    this.setListOptionSelected = function (a) {
        for (var b in this._listOptions) {
            var c = this._listOptions[b];
            if (c.td_a != null && c.td_b != null && c.tr.en)b == a ? (c.tr._selected = !0, c.tr.className = "tr_btn" + (this.renderSelect ? " tr_btn_selected" : ""), this.mode == "select" && (c.tr._img ? this.setItemImage(c.tr._img) : this.clearItemImage(), this.setItemText(this.getListOptionText(a)))) : (c.tr._selected = !1, c.tr.className = "tr_btn");
            c = null
        }
    };
    this.getListOptionSelected = function () {
        var a = null, b;
        for (b in this._listOptions)this._listOptions[b].tr._selected == !0 && (a = b);
        return a
    };
...
dhtmlXToolbarObject.prototype._buttonTwoStateObject = function (b, c, a) {
    ...
    this.obj._doOnMouseOver = function () {
        if (d.state != !1 && b.anyUsed == "none")this.renderAs = this.pressed ? "dhx_toolbar_btn over" : this.className = "dhx_toolbar_btn over"
    };
    this.obj._doOnMouseOut = function () {
        if (d.state != !1 && b.anyUsed == "none")this.renderAs = this.pressed ? "dhx_toolbar_btn def" : this.className = "dhx_toolbar_btn def"
    };
    this.obj[b._isIPad ? "ontouchstart" : "onmousedown"] = function () {
        if ((!b.checkEvent("onBeforeStateChange") || b.callEvent("onBeforeStateChange", [this.idd.replace(b.idPrefix, ""), this.pressed])) && d.state != !1 && b.anyUsed == "none") {
...
dhtmlXToolbarObject.prototype._sliderObject = function (b, c, a) {
    ...
    this.pen[b._isIPad ? "ontouchstart" : "onmousedown"] = function (a) {
        if (d.state != !1 && (a = a || event, this.initXY = b._isIPad ? a.touches[0].clientX : a.clientX, this.newValueNow = this.valueNow, this.allowMove = !0, this.className =
            "sl_pen over", g.tip != ""))g.style.visibility = "hidden", g.style.display = "", g.innerHTML = g.tip.replace("%v", this.valueNow), g.style.left = Math.round(getAbsoluteLeft(this) + this.offsetWidth / 2 - g.offsetWidth / 2) + "px", g.style.top = getAbsoluteTop(this) - g.offsetHeight - 3 + "px", g.style.visibility = ""
    };
    this.pen._doOnMouseMoveStart = function (a) {
        a = a || event;
        if (e.allowMove) {
            var c = b._isIPad ? a.touches[0].clientX : a.clientX, d = c - e.initXY;
            if (!(c < getAbsoluteLeft(e) + Math.round(e.offsetWidth / 2) && e.nowX == e.minX) && !(c > getAbsoluteLeft(e) +
                ...
                e.newNowX = e.nowX + d;
                if (e.newNowX < e.minX)e.newNowX = e.minX;
                if (e.newNowX > e.maxX)e.newNowX = e.maxX;
                e.nowX = e.newNowX;
                e.style.left = e.nowX + "px";
                e.initXY = c;
                e.newValueNow = Math.round((e.valueMax - e.valueMin) * (e.newNowX - e.minX) / (e.maxX - e.minX) + e.valueMin);
                if (g.tip != "")g.innerHTML = g.tip.replace(/%v/gi, e.newValueNow), g.style.left = Math.round(getAbsoluteLeft(e) + e.offsetWidth / 2 - g.offsetWidth / 2) + "px", g.style.top = getAbsoluteTop(e) - g.offsetHeight - 3 + "px";
                a.cancelBubble = !0;
                return a.returnValue = !1
            }
        }
    ...
    this.enableItem = function () {
        if (!this.state)this.state = !0, this.obj.className = "dhx_toolbar_btn def"
    };
    this.disableItem = function () {
        if (this.state)this.state = !1, this.obj.className = "dhx_toolbar_btn dis"
    };
    this.isEnabled = function () {
        return this.state
    };
    ...
    this.setValue = function (a, c) {
        a = Number(a);
        if (a < this.pen.valueMin)a = this.pen.valueMin;
        if (a > this.pen.valueMax)a = this.pen.valueMax;
        this.pen.valueNow = a;
        this.pen._definePos();
    ...
    this.setMinValue = function (a, b) {
        ...
        if (!(a > this.pen.valueMax)) {
            ...
            if (this.pen.valueNow <
                this.pen.valueMin)this.pen.valueNow = this.pen.valueMin;
            this.pen._detectLimits();
            this.pen._definePos()
        }
    };
    ...
    this.getMinValue = function () {
        var a = this.obj.childNodes[0].innerHTML, b = this.pen.valueMin;
        return[b,
            a]
    };
    this.getMaxValue = function () {
        var a = this.obj.childNodes[4].innerHTML, b = this.pen.valueMax;
        return[b, a]
    };
...
dhtmlXToolbarObject.prototype.unload = function () {
    ...
    for (this.base = null; this.cont.childNodes.length >
        0;)this.cont.removeChild(this.cont.childNodes[0]);
    this.cont.className = "";
    this.cont = null;
...
dhtmlXToolbarObject.prototype._isListOptionExists = function (b, c) {
    if (this.objPull[this.idPrefix + b] == null)return!1;
...
dhtmlXToolbarObject.prototype.setListOptionUserData = function (b, c, a, d) {
    if (this._isListOptionExists(b, c)) {
        ...
        if (e.userData == null)e.userData = {};
        e.userData[a] = d
    }
};
dhtmlXToolbarObject.prototype.getListOptionUserData = function (b, c, a) {
    if (!this._isListOptionExists(b, c))return null;
    var d = this.objPull[this.idPrefix + b]._listOptions[c];
    return!d.userData ? null : d.userData[a] ? d.userData[a] : null
};
(function () {
    dhtmlx.extend_api("dhtmlXToolbarObject", {_init:function (b) {
        return[b.parent, b.skin]
    }, icon_path:"setIconsPath", xml:"loadXML", items:"items", align:"setAlign", rtl:"setRTL", skin:"setSkin"}, {items:function (b) {
