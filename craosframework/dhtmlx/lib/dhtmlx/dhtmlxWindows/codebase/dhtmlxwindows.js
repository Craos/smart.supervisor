    ...
    if (window.dhtmlXContainer) {
        ...
        if (this[d]) {
            ...
            this.skinParams = {dhx_black:{header_height:21, border_left_width:2, border_right_width:2, border_bottom_height:2},
                dhx_blue:{header_height:21, border_left_width:2, border_right_width:2, border_bottom_height:2}, dhx_skyblue:{header_height:21, border_left_width:2, border_right_width:2, border_bottom_height:2}};
            ...
            this._createViewport = function () {
                ...
                if (_isIE)this._carcass.innerHTML =
                    "<iframe border=0 frameborder=0 style='filter: alpha(opacity=0); width: 100%; height:100%; position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;'></iframe><div style='position: absolute; top: 0px; left: 0px; width: 100%; height: 100%;'></div>", this._carcass.childNodes[0].setAttribute("src", "javascript:false;");
            ...
            this._clearVPCss = function () {
                this.vp.className = String(this.vp.className).replace(/[a-z_]{1,}/gi,
                    function (a) {
                        return{dhtmlx_skin_dhx_skyblue:1, dhtmlx_skin_dhx_blue:1, dhtmlx_skin_dhx_black:1, dhtmlx_skin_dhx_web:1, dhtmlx_skin_dhx_terrace:1}[a] == 1 ? "" : a
                    })
            };
            this._autoResizeViewport = function () {
                for (var a in this.wins) {
                    if (this.wins[a]._isFullScreened)this.wins[a]._content.style.width = document.body.offsetWidth - (_isIE ? 4 : 0) + "px", this.wins[a]._content.style.height = document.body.offsetHeight == 0 ? window.innerHeight ? window.innerHeight + "px" : document.body.scrollHeight + "px" : document.body.offsetHeight - (_isIE ? 4 : 0) +
                        "px", this.wins[a].layout != null && _isOpera && this.wins[a].layout._fixCellsContentOpera950(), this.wins[a].updateNestedObjects();
                ...
                if (this.vp != document.body && this.autoViewport != !1)for (a in this.vp.style.width = (_isIE ? document.body.offsetWidth - 4 : window.innerWidth) + "px", this.vp.style.height = (_isIE ? document.body.offsetHeight - 4 : window.innerHeight) + "px", this.wins) {
                    var b = this.wins[a], c = !1, d = !1;
                    if (b.x >
                        this.vp.offsetWidth - 10)b.x = this.vp.offsetWidth - 10, c = !0;
                    var f = b._skinParams != null ? b._skinParams : this.skinParams[this.skin];
                    if (b.y + f.header_height > this.vp.offsetHeight)b.y = this.vp.offsetHeight - f.header_height, d = !0;
                    (c || d) && this._engineRedrawWindowPos(b)
                }
            };
            ...
            this.attachViewportTo =
                function (a) {
                    if (this.autoViewport == !1)this.vp.removeChild(this.modalCoverI), this.vp.removeChild(this.modalCoverD), this.vp.removeChild(this._vpcover), this.vp.removeChild(this._carcass), this.vp != document.body && this.vp.parentNode.removeChild(this.vp), this.vp = null, this.vp = typeof a == "string" ? document.getElementById(a) : a, this.vp.autocreated = !1, this._clearVPCss(), this.vp.className += " dhtmlx_skin_" + this.skin + (this._r ? " dhx_wins_rtl" : ""), this.vp.style.position = "relative", this.vp.style.overflow = "hidden", this.vp.ax =
                        0, this.vp.ay = 0, this.vp.appendChild(this.modalCoverI), this.vp.appendChild(this.modalCoverD), this.vp.appendChild(this._vpcover), this.vp.appendChild(this._carcass)
                };
            this.setViewport = function (a, b, c, d, f) {
                if (this.autoViewport == !1)this.vp.style.left = a + "px", this.vp.style.top = b + "px", this.vp.style.width = c + "px", this.vp.style.height = d + "px", f != null && f.appendChild(this.vp), this.vp.ax = getAbsoluteLeft(this.vp), this.vp.ay = getAbsoluteTop(this.vp)
            };
            this._effects = {move:!1, resize:!1};
            this.setEffect = function (a, b) {
                this._effects[a] !=
                    null && typeof b == "boolean" && (this._effects[a] = b)
            };
            ...
            this.createWindow = function (a, b, g, d, f) {
                ...
                e.dir = "ltr";
                for (var h in this.wins)this.wins[h].zi += this.zIndexStep, this.wins[h].style.zIndex = this.wins[h].zi;
                ...
                this._engineDiableOnSelectInWindow(e,
                    !0);
                this.wins[a] = e;
                dhtmlxEventable(e);
                this._engineGetWindowHeader(e)[this._isIPad ? "ontouchstart" : "onmousedown"] = function (b) {
                    var b = b || event, a = c.wins[this.idd];
                    a.isOnTop() || a.bringToTop();
                    if (!c._engineGetWindowHeaderState(a) && c._engineCheckHeaderMouseDown(a, b) && a._allowMove && a._allowMoveGlobal) {
                        c._wasMoved = !1;
                        a.moveOffsetX = a.x - (c._isIPad ? b.touches[0].clientX : b.clientX);
                        a.moveOffsetY = a.y - (c._isIPad ? b.touches[0].clientY : b.clientY);
                        c.movingWin = a;
                        if (c._effects.move == !1)c._carcass.x = c.movingWin.x, c._carcass.y =
                            c.movingWin.y, c._carcass.w = parseInt(c.movingWin.style.width) + (_isIE ? 0 : -2), c._carcass.h = parseInt(c.movingWin.style.height) + (_isIE ? 0 : -2), c._carcass.style.left = c._carcass.x + "px", c._carcass.style.top = c._carcass.y + "px", c._carcass.style.width = c._carcass.w + "px", c._carcass.style.height = c._carcass.h + "px", c._carcass.style.zIndex = c._getTopZIndex(!0) + 1, c._carcass._keepInViewport = e._keepInViewport;
                        c._blockSwitcher(!0);
                ...
                this._engineGetWindowHeader(e).ondblclick = function (b) {
                    var a = c.wins[this.idd];
                    if (c._engineCheckHeaderMouseDown(a, b || event))a._allowResizeGlobal && !a._isParked && (a._isMaximized == !0 ? c._restoreWindow(a.idd) : c._maximizeWindow(a.idd)), a = null
                };
                ...
                e.park = function () {
                    this._isParkedAllowed && c._parkWindow(this.winId)
                };
                e.stick = function () {
                ...
                e.onmousemove = function (a) {
                    ...
                    if (c.resizingWin == null && c.movingWin ==
                        null && !this._isParked) {
                        if (c._isIPad)var g = a.touches[0].clientX, d = a.touches[0].clientY; else g = _isIE || _isOpera ? a.offsetX : a.layerX, d = _isIE || _isOpera ? a.offsetY : a.layerY;
                        ...
                        if (m == null) {
                            ...
                            c.resizingDirs = m;
                            var f = {x:a.clientX, y:a.clientY};
                            switch (c.resizingDirs) {
                                case "border_left":
                                    b.style.cursor = "w-resize";
                                    this.resizeOffsetX = this.x -
                                        f.x;
                                    break;
                                case "border_right":
                                ...
                                case "corner_up_right":
                                    b.style.cursor = "sw-resize", this.resizeOffsetY = this.y - f.y, this.resizeOffsetXW = this.x + this.w - f.x
                            }
                ...
                e.onmousedown = function (a) {
                    ...
                    if (this.canStartResize) {
                        ...
                        c.resizingWin =
                            this;
                        if (!c._effects.resize)c._carcass.x = c.resizingWin.x, c._carcass.y = c.resizingWin.y, c._carcass.w = Number(c.resizingWin.w) + (_isIE ? 0 : -2), c._carcass.h = Number(c.resizingWin.h) + (_isIE ? 0 : -2), c._carcass.style.left = c._carcass.x + "px", c._carcass.style.top = c._carcass.y + "px", c._carcass.style.width = c._carcass.w + "px", c._carcass.style.height = c._carcass.h + "px", c._carcass.style.zIndex = c._getTopZIndex(!0) + 1, c._carcass.style.cursor = this.style.cursor, c._carcass._keepInViewport = this._keepInViewport, c._carcass.style.display =
                            "";
                ...
                e.button = function (a) {
                    var a = String(a).toLowerCase(), b = null;
            ...
            this._moveWindow = function (a) {
                if (this.movingWin != null) {
                    ...
                    if (this._effects.move == !0) {
                        if (this._engineGetWindowHeader(this.movingWin).style.cursor != "move")this._engineGetWindowHeader(this.movingWin).style.cursor =
                            "move";
                        this._wasMoved = !0;
                        ...
                        if (this._engineGetWindowHeader(this.movingWin).style.cursor !=
                            "move")this._engineGetWindowHeader(this.movingWin).style.cursor = "move";
                ...
                if (this.resizingWin != null && this.resizingWin._allowResize) {
                    ...
                    if (this.resizingDirs ==
                        "border_left" || this.resizingDirs == "corner_left" || this.resizingDirs == "corner_up_left")if (this._effects.resize) {
                        var c = b.x + this.resizingWin.resizeOffsetX, d = c > this.resizingWin.x ? -1 : 1;
                        ...
                        c =
                            b.x + this.resizingWin.resizeOffsetX;
                        d = c > this._carcass.x ? -1 : 1;
                        newW = this._carcass.w + Math.abs(c - this._carcass.x) * d;
                        if (newW > this.resizingWin.maxW)newW = this.resizingWin.maxW, c = this._carcass.x + this._carcass.w - this.resizingWin.maxW;
                    ...
                    if (this.resizingDirs ==
                        "border_right" || this.resizingDirs == "corner_right" || this.resizingDirs == "corner_up_right")if (this._effects.resize) {
                        ...
                        if (newW < this.resizingWin.minW)newW =
                    ...
                    if ((this.resizingDirs == "border_top" || this.resizingDirs == "corner_up_right" || this.resizingDirs == "corner_up_left") && !this._effects.resize) {
                        ...
                        if (newH > this.resizingWin.maxH)newH = this.resizingWin.maxH, c = this.resizingWin.y + this.resizingWin.h - this.resizingWin.maxH;
            ...
            this._bringOnTop = function (a) {
                var b = a.zi, c = this._getTopZIndex(a._isSticked), d;
                for (d in this.wins)if (this.wins[d] != a && (a._isSticked || !a._isSticked && !this.wins[d]._isSticked) && this.wins[d].zi > b)this.wins[d].zi -= this.zIndexStep, this.wins[d].style.zIndex =
                    this.wins[d].zi;
                a.zi = c;
                a.style.zIndex = a.zi
            };
            ...
            this._addDefaultButtons = function (a) {
                var b = this.wins[a], d = this._engineGetWindowButton(b, "stick");
                ...
                b.btns.close = l;
                b.btns.dock = k;
                for (var n in b.btns)b.btns[n].winId = b.idd, this._attachEventsOnButton(b.idd, n);
            ...
            this._attachEventsOnButton = function (a, b) {
                ...
                this._isIPad ? (d.ontouchstart = function (a) {
                    ...
                    this._isEnabled ? (this.isPressed = !1, this.className = "dhtmlx_wins_btns_button dhtmlx_button_" + this.label +
                        "_default") : this.className = "dhtmlx_wins_btns_button dhtmlx_button_" + this.label + "_disabled"
                    ...
                    if (this._isEnabled) {
                        ...
                        a && (this.checkEvent("onClick") ?
                            this.callEvent("onClick", [c.wins[this.winId], this]) : this._doOnClick())
            ...
            this._parkWindow = function (a, b) {
                ...
                if (c._isParkedAllowed || b)if (!this.enableParkEffect || !c.parkBusy) {
                    if (c._isParked)this.enableParkEffect && !b ? (c.parkBusy = !0, this._doParkDown(c)) : (c.h = c.lastParkH, this._engineRedrawWindowSize(c), this._engineDoOnWindowParkDown(c), c.updateNestedObjects(), c.btns.park.title = c.btns.park.titleIfNotParked, c._allowResizeGlobal == !0 && (this._enableButton(c, "minmax1"), this._enableButton(c, "minmax2")), c._isParked = !1, b || (c.checkEvent("onParkDown") ?
                        c.callEvent("onParkDown", [c]) : this.callEvent("onParkDown", [c]))); else if (this.enableParkEffect && !b)if (c.lastParkH = String(c.h).search(/\%$/) == -1 ? c.h : c.offsetHeight, c._allowResizeGlobal == !0 && (this._disableButton(c, "minmax1"), this._disableButton(c, "minmax2")), this.enableParkEffect)c.parkBusy = !0, this._doParkUp(c); else {
            ...
            this._doParkDown = function (a) {
                ...
                a.h >= a.lastParkH ? (a.h = a.lastParkH, this._engineGetWindowButton(a, "park").title = this._engineGetWindowButton(a, "park").titleIfNotParked, a._allowResizeGlobal == !0 && (this._enableButton(a, "minmax1"), this._enableButton(a, "minmax2")), a._isParked = !1, a.parkBusy = !1, this._engineRedrawWindowSize(a), a.updateNestedObjects(), this._engineDoOnWindowParkDown(a), a.checkEvent("onParkDown") ? a.callEvent("onParkDown",
                    [a]) : this.callEvent("onParkDown", [a])) : (this._engineRedrawWindowSize(a), this.parkTM = window.setTimeout(function () {
                    c._doParkDown(a)
                }, this.parkTMTime))
            };
            this._enableButton = function (a, b) {
                var c = this._engineGetWindowButton(a, b);
                if (c)c._isEnabled = !0, c.className = "dhtmlx_wins_btns_button dhtmlx_button_" + c.label + "_default", c = null
            };
            this._disableButton = function (a, b) {
                var c = this._engineGetWindowButton(a, b);
                if (c)c._isEnabled = !1, c.className = "dhtmlx_wins_btns_button dhtmlx_button_" + a.btns[b].label + "_disabled", c = null
            };
            ...
            this._maximizeWindow = function (a) {
                ...
                if (b._allowResizeGlobal != !1) {
                    ...
                    b.lastMaximizeW = b.w;
                    b.lastMaximizeH = b.h;
                    b.maxW != "auto" && b.maxW != "auto" ? (b.x = Math.round(b.x +
                        (b.w - b.maxW) / 2), b.y = Math.round(b.y + (b.h - b.maxH) / 2), b._allowMove = !0) : (b.x = 0, b.y = 0, b._allowMove = !1);
                    b._isMaximized = !0;
                    b._allowResize = !1;
            ...
            this._restoreWindow = function (a) {
                ...
                if (b._allowResizeGlobal != !1) {
                    ...
                    var c = b._isParked;
                    c && this._parkWindow(b.idd, !0);
                    b.maxW != "auto" && b.maxW != "auto" ? (b.x = Math.round(b.x + (b.w - b.lastMaximizeW) /
                        2), b.y = Math.round(b.y + (b.h - b.lastMaximizeH) / 2)) : (b.x = b.lastMaximizeX, b.y = b.lastMaximizeY);
                    b.w = b.lastMaximizeW;
                    b.h = b.lastMaximizeH;
                    b._isMaximized = !1;
            ...
            this._showButton = function (a, b, c) {
                ...
                if (d && !(!c && d._userHide || d.isVisible === !0))d.isVisible = !0, d.style.display = "", d.style.visibility = "visible", d._userHide = c != !0, this._engineRedrawWindowTitle(a), d = null
            };
            this._hideButton = function (a, b, c) {
                var d = this._engineGetWindowButton(a, b);
                if (d && (c || d.isVisible !== !1))d.isVisible = !1, d.style.display = "none", d.style.visibility = "hidden", d._userHide = c == !0, this._engineRedrawWindowTitle(a), d = null
            };
            ...
            this._closeWindow = function (a) {
                var b = this.wins[a];
                if (this._focusFixIE)this._focusFixIE.style.top = (this.vp == document.body ? 0 : getAbsoluteTop(this.vp)) + Number(b.y) + "px", this._focusFixIE.focus();
            ...
            this._needHelp = function (a) {
                var b = this.wins[a];
                b.checkEvent("onHelp") ?
                    b.callEvent("onHelp", [b]) : this.callEvent("onHelp", [b]);
                b = null
            };
            ...
            this._setWindowToFullScreen = function (a, b) {
                if (b == !0) {
                    ...
                    c.style.left = "0px";
                    c.style.top = "0px";
                    c.style.width = document.body.offsetWidth -
                        (_isIE ? 4 : 0) + "px";
                    ...
                    var c = a.childNodes[0].childNodes[0].childNodes[1].childNodes[0].childNodes[0].childNodes[0].childNodes[0].childNodes[1], d = a._content;
            ...
            this._bringOnBottom = function (a) {
                for (var b in this.wins)if (this.wins[b].zi < a.zi)this.wins[b].zi += this.zIndexStep, this.wins[b].style.zIndex = this.wins[b].zi;
                a.zi = 50;
                a.style.zIndex = a.zi;
            ...
            this._addUserButton = function (a, b, c, d) {
                var b = String(b).toLowerCase(), f = this._engineAddUserButton(a, b, c);
                f.title = d;
                f.isVisible = !0;
                f._isEnabled = !0;
                f.isPressed = !1;
            ...
            if (_isIE)this._focusFixIE = document.createElement("INPUT"), this._focusFixIE.className = "dhx_windows_ieonclosefocusfix", this._focusFixIE.style.position = "absolute", this._focusFixIE.style.width = "1px", this._focusFixIE.style.height =
                "1px", this._focusFixIE.style.border = "none", this._focusFixIE.style.background = "none", this._focusFixIE.style.left = "-10px", this._focusFixIE.style.fontSize = "1px", document.body.appendChild(this._focusFixIE);
            ...
            this._isIPad ? (document.addEventListener("touchmove", this._doOnMoseMove,
                !1), document.addEventListener("touchend", this._doOnMouseUp, !1)) : (dhtmlxEvent(document.body, "mouseup", this._doOnMouseUp), dhtmlxEvent(this.vp, "mousemove", this._doOnMoseMove), dhtmlxEvent(this.vp, "mouseup", this._doOnMouseUp));
            ...
            this._removeWindowGlobal = function (a) {
                ...
                var c = b.coverBlocker(), c = c.onselectstart = null;
            ...
            this._parseNestedForEvents = function (a) {
                ...
                for (var b = 0; b <
                    a.childNodes.length; b++)a.childNodes[b].tagName != null && this._parseNestedForEvents(a.childNodes[b]);
                a = null
            };
            this._clearAll = function () {
                ...
                c = this.window = this.unload = this.setViewport = this.setSkin =
                        ...
                        this._removeUserButton = this._removeEvents = this._removeButtonGlobal = this._parseNestedForEvents = this._parkWindow = this._needHelp = this._moveWindow = this._maximizeWindow = this._makeActive = this._isWindowOnTop = this._isWindowOnBottom = this._isWindowHidden = this._hideWindow = this._hideButton = this._getWindowIcon = this._getTopZIndex = this._getActive = this._genStr = this._fixWindowDimensionInViewport = this._engineUpdateWindowIcon = this._engineSwitchWindowProgress = this._engineSwitchWindowHeader = this._engineSetWindowBody =
                            this._engineRedrawWindowTitle = this._engineRedrawWindowSize = this._engineRedrawWindowPos = this._engineRedrawSkin = this._engineGetWindowParkedHeight = this._engineGetWindowLabel = this._engineGetWindowHeaderState = this._engineGetWindowHeader = this._engineGetWindowContent = this._engineGetWindowButton = this._engineFixWindowPosInViewport = this._engineDoOnWindowParkUp = this._engineDoOnWindowParkDown = this._engineDiableOnSelectInWindow = this._engineCheckHeaderMouseDown = this._engineAllowWindowResize = this._engineAdjustWindowToContent =
                                this._engineAddUserButton = this._enableButton = this._doParkUp = this._doParkDown = this._doOnUnload = this._doOnSelectStart = this._doOnResize = this._doOnMouseUp = this._doOnMoseMove = this._disableButton = this._dhx_Engine = this._denyResize = this._denyParking = this._createViewport = this._closeWindow = this._clearWindowIcons = this._clearDocumentEvents = this._clearAll = this._centerWindow = this._bringOnTopAnyStickedWindows = this._bringOnTop = this._bringOnBottom = this._blockSwitcher = this._autoResizeViewport = this._attachWindowContentTo =
                                    this._attachEventsOnButton = this._allowReszieGlob = this._allowParking = this._addUserButton = this._addDefaultButtons = this._engineSkinParams = this._effects = this.skinParams = null
            };
            this._clearDocumentEvents = function () {
                _isIE ? (window.detachEvent("onresize", this._doOnResize), document.body.detachEvent("onselectstart", this._doOnSelectStart), document.body.detachEvent("onmouseup", this._doOnMouseUp), document.body.detachEvent("onunload", this._doOnUnload), this.vp.detachEvent("onmousemove", this._doOnMoseMove), this.vp.detachEvent("onmouseup",
...
dhtmlXWindows.prototype._dhx_Engine = function () {
    ...
    this._engineSkinParams = {dhx_blue:{hh:21, lbw:2, rbw:2, lch:2, lcw:14, rch:14, rcw:14, bbh:2, mnh:23, tbh:25, sbh:20, noh_t:null, noh_h:null}, dhx_black:{hh:21, lbw:2, rbw:2, lch:2, lcw:14, rch:14, rcw:14, bbh:2, mnh:23, tbh:25, sbh:20, noh_t:null, noh_h:null}, dhx_skyblue:{hh:29, lbw:2, rbw:2, lch:2, lcw:14, rch:14, rcw:14, bbh:2, mnh:23, tbh:25, sbh:20, noh_t:5, noh_h:-10}, dhx_web:{hh:27, lbw:5, rbw:5, lch:5, lcw:14, rch:14, rcw:14, bbh:5, mnh:23, tbh:25,
        sbh:20, noh_t:5, noh_h:-10}, dhx_terrace:{hh:37, lbw:5, rbw:5, lch:5, lcw:14, rch:14, rcw:14, bbh:5, mnh:23, tbh:25, sbh:20, noh_t:5, noh_h:-10}};
    this._isIE6 = !1;
    if (_isIE)this._isIE6 = window.XMLHttpRequest == null ? !0 : !1;
    this._engineSetWindowBody = function (d) {
        d.innerHTML = "<div iswin='1' class='dhtmlx_wins_body_outer' style='position: relative;'>" + (this._isIE6 ? "<iframe src='javascript:false;' frameborder='0' class='dhtmlx_wins_ie6_cover_fix' onload='this.contentWindow.document.body.style.overflow=\"hidden\";'></iframe>" :
        ...
        if (this.skin == "dhx_skyblue")d.dhxContGlobal.obj._offsetWidth = -10, d.dhxContGlobal.obj._offsetHeight = -5, d.dhxContGlobal.obj._offsetLeft = 5, d.dhxContGlobal.obj._offsetHeightSaved = d.dhxContGlobal.obj._offsetHeight;
        if (this.skin == "dhx_web")d.dhxContGlobal.obj._offsetWidth = -10, d.dhxContGlobal.obj._offsetHeight = -5, d.dhxContGlobal.obj._offsetLeft = 5, d.dhxContGlobal.obj._offsetHeightSaved = d.dhxContGlobal.obj._offsetHeight;
        d.skin = this.skin;
        d.dhxContGlobal.setContent(d.childNodes[0].childNodes[this._isIE6 ?
            5 : 4]);
    ...
    this._engineDiableOnSelectInWindow = function (d, c) {
        ...
        f[6] = d.childNodes[0].childNodes[this._isIE6 ?
            8 : 7];
        f[7] = d.childNodes[0].childNodes[this._isIE6 ? 9 : 8];
        for (var a = 0; a < f.length; a++)f[a].onselectstart = c ? function (a) {
            a = a || event;
            return a.returnValue = !1
        } : null, f[a] = null;
        f = null
    ...
    this._engineRedrawWindowPos = function (d) {
        if (!d._isFullScreened)d.style.left = d.x + "px", d.style.top = d.y + "px"
    };
    ...
    this._engineCheckHeaderMouseDown = function (d, c) {
        if (this._isIPad) {
            var f = c.touches[0].clientX, a = c.touches[0].clientY, b = c.target || c.srcElement;
            return b == d.childNodes[0] ||
                b == d.childNodes[0].childNodes[0] || b == d.childNodes[0].childNodes[2] || b == d.childNodes[0].childNodes[3] ? !0 : !1
        } else f = _isIE || _isOpera ? c.offsetX : c.layerX, a = _isIE || _isOpera ? c.offsetY : c.layerY, b = c.target || c.srcElement;
    ...
    this._engineDoOnWindowParkDown = function (d) {
        ...
        d.childNodes[0].childNodes[this._isIE6 ?
            9 : 8].style.display = ""
    };
    ...
    this._engineAllowWindowResize = function (d, c, f, a) {
        if (c.getAttribute) {
            var b =
                this._engineSkinParams[this.skin], g = d._noHeader == !0 ? d._hdrSize : this._engineSkinParams[this.skin].hh;
    ...
    this._engineAdjustWindowToContent = function (d, c, f) {
        var a = c + d.w - d.vs[d.av].dhxcont.clientWidth, b = f + d.h - d.vs[d.av].dhxcont.clientHeight;
        d.setDimension(a, b)
    };
    this._engineRedrawSkin = function () {
        this.vp.className = (this.vp == document.body && this.vp._css ? this.vp._css + " " : "") + "dhtmlx_winviewport dhtmlx_skin_" +
            this.skin + (this._r ? " dhx_wins_rtl" : "");
        var d = this._engineSkinParams[this.skin], c;
        for (c in this.wins)this.skin == "dhx_skyblue" ? (this.wins[c].dhxContGlobal.obj._offsetTop = this.wins[c]._noHeader ? d.noh_t : null, this.wins[c].dhxContGlobal.obj._offsetWidth = -10, this.wins[c].dhxContGlobal.obj._offsetHeight = this.wins[c]._noHeader ? d.noh_h : -5, this.wins[c].dhxContGlobal.obj._offsetLeft = 5, this.wins[c].dhxContGlobal.obj._offsetHeightSaved = -5) : (this.wins[c].dhxContGlobal.obj._offsetWidth = null, this.wins[c].dhxContGlobal.obj._offsetHeight =
            null, this.wins[c].dhxContGlobal.obj._offsetLeft = null, this.wins[c].dhxContGlobal.obj._offsetTop = null, this.wins[c].dhxContGlobal.obj._offsetHeightSaved = null), this.wins[c].skin = this.skin, this._restoreWindowIcons(this.wins[c]), this._engineRedrawWindowSize(this.wins[c])
    };
    this._engineSwitchWindowProgress = function (d, c) {
        c == !0 ? (d.childNodes[0].childNodes[this._isIE6 ? 1 : 0].style.display = "none", d.childNodes[0].childNodes[this._isIE6 ? 2 : 1].style.display = "") : (d.childNodes[0].childNodes[this._isIE6 ? 2 : 1].style.display =
            "none", d.childNodes[0].childNodes[this._isIE6 ? 1 : 0].style.display = "")
    };
    this._engineSwitchWindowHeader = function (d, c) {
        ...
        if (c == d._noHeader) {
            ...
            d.childNodes[0].childNodes[this._isIE6 ?
                3 : 2].style.display = d._noHeader ? "none" : "";
    ...
    this._engineGetWindowHeaderState =
        function (d) {
    ...
    this._engineRedrawWindowTitle = function (d) {
        if (d._noHeader !== !0) {
            var c = d.childNodes[0].childNodes[this._isIE6 ? 1 : 0].offsetWidth, f = d.childNodes[0].childNodes[this._isIE6 ? 4 : 3].offsetWidth, a = d.offsetWidth - c - f - 24;
            a < 0 ? a = "100%" : a += "px";
...
(function () {
    dhtmlx.extend_api("dhtmlXWindows", {_init:function () {
        return[]
    }, _patch:function (c) {
    ...
    }, animation:"setEffect", image_path:"setImagePath", skin:"setSkin", viewport:"_viewport", wins:"_wins"}, {_viewport:function (c) {
        ...
        for (var d = 0; d < c.length; d++) {
            ...
            a.keep_in_viewport &&
            this.window(a.id).keepInViewport(!0);
            a.deny_resize && this.window(a.id).denyResize();
            a.deny_park && this.window(a.id).denyPark();
            a.deny_move && this.window(a.id).denyMove()
        }
    }});
    var d = {move:"allowMoveA", park:"allowParkA", resize:"allowResizeA", center:"center", modal:"setModal", caption:"setText", header:"showHeader"}
})();
