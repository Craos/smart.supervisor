...
function dhtmlXMenuObject(b, c) {
    ...
    this._getSubItemToDeselectByPolygon = function (a) {
        for (var b =
            [], c = 0; c < this._selectedSubItems.length; c++)if (this._selectedSubItems[c][1] == a) {
    ...
    this._hidePolygon = function (a) {
        if (this.idPull["polygon_" +
            a] != null) {
            if (typeof this._menuEffect != "undefined" && this._menuEffect !== !1)this._hidePolygonEffect("polygon_" + a); else {
    ...
    this._showPolygon = function (a, b) {
        ...
        if (c != 0) {
            ...
            if (this.idPull[d] != null && this.idPull[a] != null && (!this.menuModeTopLevelTimeout || this.menuMode != "web" || this.context || this.idPull[a]._mouseOver ||
                ...
                if (this.autoOverflow)if (this.idPull[d].firstChild.offsetHeight > this.menuY1 + this.menuY2) {
                ...
                var q = this.idPull[a].tagName != null ? getAbsoluteLeft(this.idPull[a]) : this.idPull[a][0], t = this.idPull[a].tagName != null ? getAbsoluteTop(this.idPull[a]) : this.idPull[a][1], u = this.idPull[a].tagName !=
                    null ? this.idPull[a].offsetWidth : 0, B = this.idPull[a].tagName != null ? this.idPull[a].offsetHeight : 0, l = 0, n = 0, s = this.idPull[d].offsetWidth, v = this.idPull[d].offsetHeight + e + f;
                ...
                b == "top" && (l = q - 1, n = t - v + 2);
                if (this.fixedPosition)var w = 65536, y = 65536; else if (w = this.menuX2 != null ?
                ...
                if (typeof this._menuEffect != "undefined" && this._menuEffect !== !1)this._showPolygonEffect(d); else {
    ...
    this._redistribSubLevelSelection = function (a, b) {
        ...
        for (var d = 0; d < c.length; d++)if (this.idPull[c[d]] != null && c[d] != a && this.itemPull[c[d]].state == "enabled")this.idPull[c[d]].className =
            "sub_item";
    ...
    this._doOnClick = function (a, b, c) {
        ...
        if (this.itemPull[this.idPrefix + a].href_link != null && this.itemPull[this.idPrefix + a].state == "enabled") {
            ...
            if (e[1] != null)for (var f = String(e[1]).split("&"), g = 0; g < f.length; g++) {
                var i = String(f[g]).split("="), m = document.createElement("INPUT");
                m.type = "hidden";
                m.name = i[0] || "";
                m.value = i[1] || "";
                d.appendChild(m)
            ...
            if (this.checkEvent("onClick"))this.callEvent("onClick", [a, this.contextMenuZoneId, c]); else if (b.charAt(1) == "d" || this.menuMode == "win" && b.charAt(2) == "t")return;
    ...
    this._searchMenuNode = function (a, b) {
        for (var c =
            [], d = 0; d < b.length; d++)if (typeof b[d] == "object") {
...
dhtmlXMenuObject.prototype._improveTerraceSkin = function () {
    for (var b in this.itemPull)if (this.itemPull[b].parent == this.idPrefix + this.topId && this.idPull[b] != null) {
        var c = !1, a = !1;
