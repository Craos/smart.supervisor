...
function dhtmlXAccordion(f, i) {
    if (window.dhtmlXContainer) {
        ...
        if (f == document.body) {
            ...
            this.base.className = "dhx_acc_base_" +
                this.skin;
        ...
        } else this.base = typeof f == "string" ? document.getElementById(f) : f, this.base.className = "dhx_acc_base_" + this.skin, this.base.innerHTML = "";
        this.w = this.base.offsetWidth;
        this.h = this.base.offsetHeight;
        this.skinParams = {dhx_blue:{cell_height:24, cell_space:1, content_offset:1}, dhx_skyblue:{cell_height:27, cell_space:-1, content_offset:-1},
            dhx_black:{cell_height:24, cell_space:1, content_offset:1}, dhx_web:{cell_height:26, cell_space:9, content_offset:0, cell_pading_max:1, cell_pading_min:0}, dhx_terrace:{cell_height:37, cell_space:-1, content_offset:-1}};
        ...
        this.enableMultiMode = function () {
            ...
            if (a == 0)this.userOffset || (this.skinParams.dhx_skyblue.cell_space = 3), this.multiMode = !0;
        ...
        this.addItem = function (a, b) {
            ...
            h.onclick = function () {
                if (d.multiMode || !d.idPull[this._idd]._isActive)d.multiMode ? (d.idPull[this._idd]._isActive ? d.checkEvent("onBeforeActive") ? d.callEvent("onBeforeActive", [this._idd, "close"]) && d.closeItem(this._idd,
            ...
            h.onmouseover = function () {
                this.className =
                    "dhx_acc_item_label dhx_acc_item_lavel_hover"
            };
            ...
            if (this.multiMode && e != null)e._isActive == !0 ? (this.idPull[e._id].adjustContent(this.idPull[e._id], this.sk.cell_height + this.sk.content_offset, null, null, this.sk.cell_space), this.idPull[e._id].updateNestedObjects()) : this.idPull[e._id].style.height = this.sk.cell_height +
                this.sk.cell_space + "px", e = null;
        ...
        this.openItem = function (a, b, e) {
            ...
            if (!this._openBuzy)if (this._enableOpenEffect && !e)(!this.multiMode || !this.idPull[a]._isActive) && this._openWithEffect(a, null, null, null, null, b); else if (this.multiMode)for (var c in this.idPull) {
                if (this.idPull[c]._isActive || c == a)this.idPull[c].style.height =
                ...
                var d = 0;
                for (c in this.idPull)if (this.idPull[c].style.height = this.sk.cell_height + (this.idPull[c] != this._lastVisible() && c != a ? this.sk.cell_space : 0) + "px", c != a)this.idPull[c].childNodes[1].style.display = "none", this.skin == "dhx_web" && this.idPull[c]._setPadding(this.skinParams[this.skin].cell_pading_min, ""), this.idPull[c]._isActive = !1, d += this.idPull[c].offsetHeight;
                d = this.base.offsetHeight - d;
                if (a)this.idPull[a].style.height = d + "px", this.idPull[a].childNodes[1].style.display =
                    "", this.skin == "dhx_web" && this.idPull[a]._setPadding(this.skinParams[this.skin].cell_pading_max, "dhxcont_acc_dhx_web"), this.idPull[a].adjustContent(this.idPull[a], this.sk.cell_height + this.sk.content_offset, null, null, this.idPull[a] == this._lastVisible() ? 0 : this.sk.cell_space), this.idPull[a].updateNestedObjects(), this.idPull[a]._isActive = !0, b == "dhx_accord_outer_event" && this.callEvent("onActive", [a, !0]);
                this._updateArrows()
            }
        };
        this._lastVisible = function () {
            for (var a = null, b = this.base.childNodes.length - 1; b >=
                0; b--)!this.base.childNodes[b]._isHidden && !a && (a = this.base.childNodes[b]);
            return a
        };
        this.closeItem = function (a, b) {
            if (this.idPull[a] != null && this.idPull[a]._isActive && !this._openBuzy)this._enableOpenEffect ? this._openWithEffect(this.multiMode ? a : null, null, null, null, null, b) : (this.idPull[a].style.height = this.sk.cell_height + (this.idPull[a] != this._lastVisible() ? this.sk.cell_space : 0) + "px", this.idPull[a].childNodes[1].style.display = "none", this.skin == "dhx_web" && this.idPull[a]._setPadding(this.skinParams[this.skin].cell_pading_min,
                ""), this.idPull[a]._isActive = !1, b == "dhx_accord_outer_event" && this.callEvent("onActive", [a, !1]), this._updateArrows())
        };
        this._updateArrows = function () {
            for (var a in this.idPull) {
                ...
                if (e != null)e.className = "dhx_acc_item_arrow " + (this.idPull[a]._isActive ? "item_opened" : "item_closed"), e = null
            }
        };
        this.setText = function (a, b, e) {
            if (d.idPull[a] != null) {
                for (var c =
                    d.idPull[a].childNodes[0], h = null, f = 0; f < c.childNodes.length; f++)c.childNodes[f].tagName != null && String(c.childNodes[f].tagName).toLowerCase() == "span" && (h = c.childNodes[f]);
        ...
        this._initWindows =
            function (a) {
                if (window.dhtmlXWindows) {
                    ...
                    if (this.dhxWins.window(b))this.dhxWins.window(b).show(); else {
                        var e = this, c = this.dhxWins.createWindow(b, 20, 20, 320, 200);
                        c.setText(this.getText(a));
                        c.button("close").hide();
                        c.attachEvent("onClose", function (a) {
                            a.hide()
                        });
        ...
        this.dockWindow = function (a) {
            if (this.idPull[a]._isUnDocked && this.dhxWins && this.dhxWins.window(this.dhxWinsIdPrefix + a))this.dhxWins.window(this.dhxWinsIdPrefix + a).moveContentTo(this.idPull[a]), this.dhxWins.window(this.dhxWinsIdPrefix + a).close(), this.idPull[a]._isUnDocked = !1, this.showItem(a), this.callEvent("onDock", [a])
        };
        this.undockWindow = function (a) {
            if (!this.idPull[a]._isUnDocked)this._initWindows(a), this.idPull[a].moveContentTo(this.dhxWins.window(this.dhxWinsIdPrefix +
                a)), this.idPull[a]._isUnDocked = !0, this.hideItem(a), this.callEvent("onUnDock", [a])
        };
        ...
        this.hideItem = function (a) {
            if (this.idPull[a] != null && !this.idPull[a]._isHidden)this.closeItem(a), this.idPull[a].className = "dhx_acc_item_hidden",
                this.idPull[a]._isHidden = !0, this._defineLastItem(), this._reopenItem()
        };
        ...
        this._openWithEffect = function (a, b, e, c, d, f) {
            if (this.multiMode) {
                if (!d)this._openBuzy = !0, d = this._openStep, this.idPull[a]._isActive ? (b = a, a = null, e = this.sk.cell_height + (this.idPull[b] != this._lastVisible() ? this.sk.cell_space : 0), this.idPull[b].childNodes[1].style.display = "") : (c = this.idPull[a].h, this.idPull[a].childNodes[1].style.display = "");
                var g = !1;
                if (a) {
                ...
                if (b)i =
                    parseInt(this.idPull[b].style.height) - d, i < e && (i = e, g = !0), this.idPull[b].style.height = i + "px";
                d += this._openStepIncrement;
                if (g) {
                    if (a)this.idPull[a].adjustContent(this.idPull[a], this.sk.cell_height + this.sk.content_offset, null, null, this.idPull[a] == this._lastVisible() ? 0 : this.sk.cell_space), this.idPull[a].updateNestedObjects(), this.idPull[a]._isActive = !0;
                    if (b)this.idPull[b].childNodes[1].style.display = "none", this.idPull[b]._isActive = !1;
                    this._updateArrows();
                    this._openBuzy = !1;
                    a && f == "dhx_accord_outer_event" &&
                    this.callEvent("onActive", [a, !0]);
                ...
                if (g) {
                    ...
                    if (a)this.idPull[a].adjustContent(this.idPull[a], this.sk.cell_height + this.sk.content_offset, null, null, this.idPull[a] == this._lastVisible() ? 0 : this.sk.cell_space),
                        this.idPull[a].updateNestedObjects(), this.idPull[a]._isActive = !0;
                    this._updateArrows();
                    this._openBuzy = !1;
                    f == "dhx_accord_outer_event" && a && this.callEvent("onActive", [a, !0])
                } else k = this, window.setTimeout(function () {
                    k._openWithEffect(a, b, e, c, d, f)
                }, this._openStepTimeout)
            }
        };
        ...
        this.setItemHeight = function (a, b) {
            if (this.multiMode) {
                if (b == "*")this.idPull[a].h_auto = !0; else {
                    if (isNaN(b))return;
        ...
        this._checkAutoHeight = function () {
            ...
            if (b.length >
                0)for (var c = Math.floor(a / b.length), d = 0; d < b.length; d++)d == b.length - 1 ? c = a : a -= c, this.idPull[b[d]].h = c
        };
        this.setIcon = function (a, b) {
            if (this.idPull[a] != null) {
                ...
                if (c == null)c = document.createElement("IMG"), c.className = "dhx_acc_item_icon", e.insertBefore(c, e.childNodes[0]), this.setText(a, null, 20);
        ...
        this.clearIcon = function (a) {
            if (this.idPull[a] != null) {
                for (var b =
                    this.idPull[a].childNodes[0], d = null, c = 0; c < b.childNodes.length; c++)b.childNodes[c].className == "dhx_acc_item_icon" && (d = b.childNodes[c]);
        ...
        this._defineLastItem = function () {
            if (!this.multiMode)for (var a = !1, b = this.base.childNodes.length - 1; b >= 0; b--)this.base.childNodes[b].className.search("last_item") >=
                0 ? this.base.childNodes[b]._isHidden || a ? this.base.childNodes[b].className = String(this.base.childNodes[b].className).replace(/last_item/gi, "") : a = !0 : !this.base.childNodes[b]._isHidden && !a && (this.base.childNodes[b].className += " last_item", a = !0)
        };
        this.removeItem = function (a) {
            var b = this.idPull[a], d = b.childNodes[0];
            d.onclick = null;
            d.onmouseover = null;
            d.onmouseout = null;
        ...
        this.unload = function () {
            ...
            if (this._isAccFS == !0)_isIE ? window.detachEvent("onresize", this._doOnResize) : window.removeEventListener("resize", this._doOnResize, !1), this._resizeTMTime = this._resizeTM = this._adjustToFullScreen = this._adjustAccordion =
                this._doOnResize = this._isAccFS = null, document.body.className = String(document.body.className).replace("dhxacc_fullscreened", ""), this.cont.obj._dhxContDestruct(), this.cont.dhxcont.parentNode && this.cont.dhxcont.parentNode.removeChild(this.cont.dhxcont), this.cont.dhxcont = null, this.cont = this.cont.setContent = null;
...
(function () {
    dhtmlx.extend_api("dhtmlXAccordion", {_init:function (f) {
        return[f.parent, f.skin]
    }, icon_path:"setIconsPath", items:"_items", effect:"setEffect", multi_mode:"enableMultiMode"}, {_items:function (f) {
...
dhtmlXAccordion.prototype.loadJSON = function (f) {
    var i = {skin:"setSkin", icons_path:"setIconsPath", multi_mode:"enableMultiMode", effect:"setEffect"}, d;
    for (d in i)if (typeof f[d] != "undefined")this[i[d]](f[d]);
    for (var g = null, a = 0; a < f.cells.length; a++)if (this.addItem(f.cells[a].id, f.cells[a].text), typeof f.cells[a].icon != "undefined" && this.setIcon(f.cells[a].id, f.cells[a].icon), typeof f.cells[a].height != "undefined" && this.setItemHeight(f.cells[a].id, f.cells[a].height), typeof f.cells[a].open != "undefined")g = f.cells[a].id;
    g != null && this.openItem(g)
};
dhtmlXAccordion.prototype.loadXML = function (f, i) {
    var d = this;
    this.callEvent("onXLS", []);
    dhtmlxAjax.get(f, function (f) {
        var a = f.xmlDoc.responseXML.getElementsByTagName("accordion")[0], b = {0:!1, "true":!0, 1:!0, y:!0, yes:!0}, e = {cells:[]};
        ...
        for (var c = null, h = 0; h < a.childNodes.length; h++)if (typeof a.childNodes[h].tagName !=
            "indefined" && String(a.childNodes[h].tagName).toLowerCase() == "cell") {
            var o = a.childNodes[h].getAttribute("id") || d._genStr(12), p = a.childNodes[h].firstChild.nodeValue || "";
            e.cells.push({id:o, text:p});
