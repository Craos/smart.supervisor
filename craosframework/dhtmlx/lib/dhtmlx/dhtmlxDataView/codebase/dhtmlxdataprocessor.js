...
dataProcessor.prototype = {setTransactionMode:function (a, b) {
    ...
    if (!this._waitMode || !(this.obj.mytype == "tree" || this.obj._h2)) {
        ...
        this.messages = [];
        if (!this.checkBeforeUpdate(a) && this.callEvent("onValidationError",
    ...
    if (typeof b != "undefined")return this.serialize_one(a, ""); else {
        var c = [], d = [], e;
    ...
    this._in_progress[e] != "wait" ? (f && this.obj.setUserData(a, this.action_param, ""), delete this._in_progress[e]) :
        (delete this._in_progress[e], this.setUpdated(b, !0, this.obj.getUserData(a, this.action_param)));
    ...
    if (e.xmlDoc.responseXML) {
        for (var f = e.doXPath("//data/action"), g = 0; g < f.length; g++) {
            var h = f[g], i = h.getAttribute("type"), j = h.getAttribute("sid"), k = h.getAttribute("tid");
    ...
    (this.obj.mytype == "tree" || this.obj._h2) &&
        this.updatedRows.length && this.sendData();
    ...
    if (this._update_busy)return!1; else this._update_busy = !0;
